...
#define ORB_HEIGHT_YELLOW_UPSIDE -0x440
#define ORB_HEIGHT_YELLOW -0x590
#define ORB_HEIGHT_YELLOW_MINI -0x4D0
#define ORB_HEIGHT_PINK -0x450
#define PAD_HEIGHT_YELLOW -0x7A0
#define PAD_HEIGHT_YELLOW_MINI -0x5B0
#define PAD_HEIGHT_BALL_YELLOW -0x5B0
...
#define MINI_BALL_GRAVITY 0x60

#define SHIP_MAX_FALLSPEED 0x290
#define MINI_SHIP_MAX_FALLSPEED 0x2A0
