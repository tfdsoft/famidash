...
#define PAD_HEIGHT_YELLOW_MINI -0x590
#define ORB_HEIGHT_YELLOW -0x5B0
#define ORB_HEIGHT_YELLOW_MINI -0x420
...
#define MINI_CUBE_MAX_FALLSPEED 0x400
#define MINI_BALL_MAX_FALLSPEED 0x350
#define MINI_UFO_MAX_FALLSPEED 0x500

#define CUBE_GRAVITY 0x6B
#define MINI_CUBE_GRAVITY 0x64
