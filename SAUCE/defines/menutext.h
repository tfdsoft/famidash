...
const unsigned char level12text[]="GO BACK TO";
...
const unsigned char levelDtext2[]="DECODE";
const unsigned char levelEtext2[]="TEST";
const unsigned char levelFtext2[]="TEST2";
const unsigned char level10text2[]="TEST3";
const unsigned char level11text2[]="TEST4";
const unsigned char level12text2[]="THE SAFE LEVELS";