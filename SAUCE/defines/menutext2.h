...
const unsigned char leveltoe2text[]="THEORY OF";
...
const unsigned char leveltoe2text2[]="EVERYTHING";
const unsigned char leveltoe22[]="EVERYTHING 2";
...
const unsigned char levelrainbow[]="RAINBOW";
