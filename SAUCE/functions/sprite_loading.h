...
uint8_t sprite_heights[]={
	...
	0x0D,	0x0D,	0x0D,	0x0D,	0x20,	0x20,	0x20,	0x30,	// 10 - 17
...
uint8_t sprite_y_offset[]={
	...
	0x00,	0x04,	0x00,	0x04,	0x00,	0x00,	0x00,	0x00,	// 10 - 17
	...
	*/
	...
	switch(type) {
		...
		case TELEPORT_PORTAL_EXIT:
			teleport_output = activesprites_realy[index] + 0x08;
			return 0x2f;
...
//	cube    ship    ball     ufo    robot   spider  wave    swing
	...
	0x7C0,  0x4A0,  0x4F0,  0x330,  0x8B0,  0x500,  0x000,  0x450, // yellow pad
