...
//	cube    ship    ball     ufo    robot   spider  wave   swing
	0x590,  0x450,  0x410,  0x3B0,  0x590,  0x440,  0x000, 0x000, // yellow orb
	0x7C0,  0x4A0,  0x4F0,  0x360,  0x8B0,  0x500,  0x000, 0x000, // yellow pad
	0x3D0,  0x200,  0x330,  0x220,  0x450,  0x350,  0x000, 0x000, // pink orb
	0x510,  0x270,  0x360,  0x250,  0x550,  0x350,  0x000, 0x000, // pink pad
	0x750,  0x5D0,  0x550,  0x510,  0x750,  0x500,  0x000, 0x000, // red orb
	...
	0x9F0,  0x620,  0x630,  0x400,  0xA50,  0x650,  0x000, 0x000, // red pad		
};

const short mini_heights[] = {
//      cube    ship    ball     ufo    robot   spider  wave   swing
	0x4D0,  0x4A0,  0x550,  0x3D0,  0x470,  0x350,  0x000, 0x000, // yellow orb
	0x6C0,  0x470,  0x4F0,  0x3A0,  0x730,  0x400,  0x000, 0x310, // yellow pad
	0x350,  0x1E0,  0x350,  0x1B0,  0x370,  0x230,  0x000, 0x000, // pink orb
	0x3F0,  0x1E0,  0x390,  0x150,  0x350,  0x350,  0x000, 0x1F0, // pink pad
	0x650,  0x670,  0x500,  0x550,  0x650,  0x470,  0x000, 0x000, // red orb
