...
if __name__ == "__main__":
    ...
    if not args.test_export:
        ...
        for glob in [f"{exportStemPrefix}*.s", f"{exportStemPrefix}*.dmc", f"{exportStemPrefix}_songlist.inc", f"{exportStemPrefix}Defines.h", f"header.s", f"{exportStemPrefix}_soundTestTables.h", "nsf_metadata.s"]:
