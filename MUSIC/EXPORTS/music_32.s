...
@instruments:
	...
	.word @env21,@env6,@env29,@env0 ; 03 : rel hats
	.word @env49,@env25,@env29,@env0 ; 04 : blank instant decay
	...
	.word @env26,@env51,@env29,@env0 ; 0a : pluck1
	.word @env45,@env25,@env35,@env0 ; 0b : Instrument 4
	.word @env52,@env25,@env29,@env0 ; 0c : triangle pluck 2
	.word @env21,@env25,@env29,@env0 ; 0d : Instrument 2
	.word @env15,@env25,@env4,@env0 ; 0e : endgame lead
	.word @env36,@env48,@env31,@env0 ; 0f : octave arp
	.word @env13,@env14,@env7,@env0 ; 10 : Instrument 3
	.word @env50,@env25,@env29,@env0 ; 11 : blank slower string
	.word @env10,@env25,@env29,@env0 ; 12 : clutterfunk sax
	.word @env16,@env25,@env29,@env0 ; 13 : DMC: drums + bass
	.word @env36,@env25,@env29,@env0 ; 14 : quiet bass
	.word @env24,@env25,@env29,@env0 ; 15 : blank string
	.word @env37,@env25,@env29,@env38 ; 16 : jaezu lead
	.word @env47,@env25,@env29,@env0 ; 17 : menu acc
	.word @env16,@env25,@env20,@env0 ; 18 : hex guitar 2
	.word @env16,@env25,@env29,@env32 ; 19 : Extreme pitch up
	.word @env23,@env25,@env29,@env0 ; 1a : triangle pluck 3
	.word @env44,@env25,@env33,@env0 ; 1b : shift string
	.word @env3,@env25,@env29,@env18 ; 1c : triangle drums
	.word @env39,@env25,@env29,@env0 ; 1d : triangle pluck 4
...
@song0ref140:
	...
	.byte .hibyte(@env5), $4f, $02, $aa, $0f, $99, $45, $81, $44, $00
@song0ch1:
	.byte $7a, $49, .lobyte(@env8), .hibyte(@env8), $4f, $01, $b6
@song0ref249:
	.byte $0d, $97, $45, $83, $b6, $14, $97, $45, $83, $12, $97, $45, $83, $10, $8b, $45, $0f, $8b, $45, $49, .lobyte(@env8)
	...
	.byte $41, $12
	.word @song0ref249
	.byte $49, .lobyte(@env8), .hibyte(@env8), $4f, $01, $0d, $99, $45, $81, $b6, $14, $99, $45, $81, $10, $99, $45, $81, $49
	.byte .lobyte(@env17), .hibyte(@env17), $4f, $03, $aa, $0f, $99, $45, $81, $44, $00
@song0ch2:
	.byte $b4
@song0ref316:
...
@song7ref37:
	...
	.byte $06, $15, $15, $4b, .lobyte(@env40), .hibyte(@env40), $a2, $15, $81, $48, $06, $81, $79, $4d, $15, $83, $7f, $4b, .lobyte(@env25)
	.byte .hibyte(@env25), $4c, $9c, $09, $15, $48, $06, $15, $09, $00, $18, $4b, .lobyte(@env40), .hibyte(@env40), $a2, $15
...
@song7ref201:
	...
	.byte $41, $09
	.word @song7ref201
	.byte $97, $97, $8b, $a2, $21, $81, $48, $06, $81, $7a
@song7ref244:
...
@song7ref329:
	.byte $92, $1d, $47, $04, $86, $21, $81, $82, $17, $47, $03, $86, $21, $81, $92, $1d, $47, $04, $86, $21, $81
	.byte $41, $0c
	.word @song7ref322
	.byte $41, $0c
	.word @song7ref322
	...
	.byte $41, $0c
	.word @song7ref322
	.byte $82, $17, $47, $03, $86, $21, $81, $92, $1d, $47, $04, $86, $21, $81, $8c, $1a, $83, $72, $8e, $1d, $73, $1e, $81, $74
...
@song8ch3:
	.byte $8e, $50, $06, $20, $22, $50, $06, $22, $24, $50, $09, $24, $27, $50, $09, $27, $2a, $8c, $2b, $85, $92, $2c, $81, $86
	.byte $2e, $81, $82, $26, $81
@song8ref378:
	.byte $86, $2e, $81, $92, $2c, $81, $86, $2e, $81, $82, $26, $00, $86, $2e, $81, $92, $2c, $81, $86, $2e, $81, $82, $26, $00
	.byte $41, $10
	.word @song8ref378
	.byte $41, $10
	.word @song8ref378
	...
	.byte $41, $10
	.word @song8ref378
	.byte $86, $2e, $81, $92, $2c, $81, $86, $2e, $81, $8c, $2b, $9d, $44, $00
@song8ch4:
	.byte $87
@song8ref448:
