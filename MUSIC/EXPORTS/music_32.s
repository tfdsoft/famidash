...
@instruments:
	...
	.word @env8,@env33,@env23,@env0 ; 01 : kick
	.word @env17,@env5,@env23,@env0 ; 02 : rel hats
	.word @env18,@env22,@env2,@env0 ; 03 : snare
	.word @env37,@env19,@env23,@env0 ; 04 : blank instant decay
	...
	.word @env20,@env39,@env23,@env0 ; 09 : pluck1
	.word @env34,@env5,@env2,@env0 ; 0a : cymbal
	.word @env12,@env19,@env4,@env0 ; 0b : endgame lead
	.word @env10,@env11,@env6,@env0 ; 0c : Instrument 3
	.word @env27,@env36,@env25,@env0 ; 0d : octave arp
	.word @env38,@env19,@env23,@env0 ; 0e : blank slower string
	.word @env13,@env19,@env23,@env0 ; 0f : DMC: drums + bass
	.word @env27,@env19,@env23,@env0 ; 10 : quiet bass
	.word @env3,@env19,@env23,@env14 ; 11 : triangle drums
	.word @env13,@env19,@env23,@env26 ; 12 : Extreme pitch up
	.word @env13,@env19,@env16,@env0 ; 13 : hex guitar 2
	.word @env28,@env19,@env23,@env29 ; 14 : jaezu lead
	.word @env30,@env19,@env23,@env0 ; 15 : triangle pluck 4
...
@song1ref357:
	...
	.byte $41, $10
	.word @song1ref357
	.byte $94, $20, $81, $80, $2f, $81, $48, $0a, $94, $2d, $00, $83, $80, $2f, $81, $82, $28, $81, $48, $0a, $94, $2d, $00
@song1ref425:
	.byte $80, $2f, $81
@song1ref428:
	.byte $82, $28, $81, $80, $2f, $81, $48, $0a, $94, $2d, $00, $82, $28, $81, $80, $2f, $81, $82, $28, $81, $48, $0a, $94, $2d
	.byte $00, $83
	.byte $41, $0e
	.word @song1ref428
	.byte $41, $10
...
@song5ref37:
	...
	.byte $06, $15, $15, $4b, .lobyte(@env31), .hibyte(@env31), $9c, $15, $81, $48, $06, $81, $79, $4d, $15, $83, $7f, $4b, .lobyte(@env19)
	.byte .hibyte(@env19), $4c, $96, $09, $15, $48, $06, $15, $09, $00, $18, $4b, .lobyte(@env31), .hibyte(@env31), $9c, $15
...
@song7ref361:
	...
	.byte $41, $0e
	.word @song7ref361
	.byte $8c, $21, $9d, $23, $9d, $20, $9d, $21, $9b, $48, $03, $81, $74, $49, .lobyte(@env35), .hibyte(@env35), $25, $9d, $8c
