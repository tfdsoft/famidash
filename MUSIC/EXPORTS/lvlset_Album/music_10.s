...
@instruments:
	...
	.word @env42,@env22,@env27,@env0 ; 0e : blank quiet
	.word @env8,@env22,@env27,@env0 ; 0f : clutterfunk sax
	.word @env13,@env22,@env4,@env0 ; 10 : endgame lead
	.word @env30,@env11,@env27,@env0 ; 11 : lots of clap
	.word @env14,@env22,@env5,@env0 ; 12 : hex guitar 1
	.word @env31,@env22,@env27,@env32 ; 13 : jaezu lead
	.word @env14,@env22,@env27,@env0 ; 14 : DMC: drums + bass
	.word @env14,@env22,@env18,@env0 ; 15 : hex guitar 2
	.word @env17,@env22,@env3,@env0 ; 16 : electroman lead
	.word @env29,@env43,@env27,@env0 ; 17 : octave arp [ no duty ]
	.word @env45,@env22,@env27,@env0 ; 18 : blank slower string
	.word @env10,@env22,@env27,@env0 ; 19 : slower string loud
...
@song1ref679:
	...
	.byte $41, $28
	.word @song1ref679
	.byte $3f, $85, $00, $95, $4b, .lobyte(@env15), .hibyte(@env15), $b0
@song1ref756:
...
@song1ref1050:
	...
	.word @song1ref1050
@song1ref1084:
	.byte $30, $00, $30, $00, $30, $00, $92, $2e, $81, $84, $30, $9c, $2e, $84, $30, $00, $30, $30, $30, $00, $30, $00, $30, $00
	.byte $30, $00, $92, $2e, $81, $84, $30, $9c, $2e, $84, $30, $00, $30, $00, $30, $00
	.byte $41, $20
	.word @song1ref1084
	.byte $41, $20
	.word @song1ref1084
...
@song2ref1251:
	...
	.byte $41, $18
	.word @song2ref988
	.byte $76, $4e, $01, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $aa
@song2ref1382:
