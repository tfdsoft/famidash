...
@instruments:
	...
	.word @env7,@env6,@env33,@env0 ; 01 : hat
	.word @env17,@env6,@env25,@env0 ; 02 : rel hats
	.word @env8,@env34,@env25,@env0 ; 03 : kick
	...
	.word @env14,@env20,@env25,@env11 ; 09 : I don't know what to name this
	.word @env2,@env20,@env25,@env0 ; 0a : echo
	.word @env19,@env20,@env25,@env0 ; 0b : blank string
	.word @env30,@env20,@env25,@env0 ; 0c : quiet bass
	.word @env23,@env20,@env25,@env0 ; 0d : clap no app
	.word @env39,@env20,@env25,@env0 ; 0e : blank instant decay
	.word @env31,@env20,@env25,@env32 ; 0f : jaezu lead
	.word @env28,@env20,@env25,@env0 ; 10 : Instrument 1
	.word @env40,@env20,@env25,@env0 ; 11 : blank slower string
	.word @env37,@env20,@env25,@env0 ; 12 : menu acc
	.word @env30,@env38,@env25,@env0 ; 13 : octave arp [ no duty ]
	.word @env30,@env38,@env26,@env0 ; 14 : octave arp
	.word @env17,@env20,@env25,@env0 ; 15 : Instrument 2
	.word @env14,@env20,@env25,@env1 ; 16 : Extreme pitch down
	.word @env14,@env20,@env25,@env0 ; 17 : DMC: drums + bass
	.word @env36,@env20,@env27,@env0 ; 18 : shift string
	.word @env12,@env20,@env25,@env0 ; 19 : 02 but tri
	.word @env41,@env20,@env29,@env0 ; 1a : death moon lead
	.word @env22,@env20,@env25,@env0 ; 1b : triangle pluck
...
@song1ch1:
	...
	.byte $2c, $81, $2a, $49, .lobyte(@env10), .hibyte(@env10), $9d, $45, $8d, $00, $8d, $97, $8e
@song1ref409:
...
@song1ref967:
	...
	.byte $b5, $44, $00
@song2ch0:
	.byte $46, $08, $97, $4f, $01, $aa, $2a, $83, $a0
@song2ref10:
...
@song3ref501:
	.byte $0d, $85, $00, $81, $0d, $85, $00, $81, $0f, $85, $00, $81, $0f, $85, $00, $81, $9a, $0f, $85, $0f, $85, $8c, $14, $85
...
@song4ref154:
	...
	.byte $08, $83, $0a, $83, $0e, $83, $11, $81, $9c, $27, $27, $27, $8c, $27, $81, $1b, $81, $0f, $8e, $50, $b3, $16, $5b, $85
...
@song4ch1:
	...
	.byte $27, $27, $90, $27, $81, $1b, $81, $0f, $8e, $50, $b3, $16, $5b, $85, $00, $85, $7a, $92, $50, $0b, $29, $23, $85, $7f
...
@song5ref815:
	...
	.byte $00, $bd
@song5ref836:
	.byte $23, $81, $18, $81, $18, $81, $18, $81, $37, $81, $18, $81, $18, $81, $18, $81
	.byte $41, $10
	.word @song5ref836
	.byte $41, $10
	.word @song5ref836
@song5ref858:
	.byte $23, $81, $18, $81, $37, $81, $18, $81, $37, $81, $18
@song5ref869:
	.byte $81, $37, $81, $37
@song5ref873:
...
@song5ref911:
	.byte $81, $23, $81, $15, $81, $15, $81, $15, $81, $37, $81, $15, $81, $15, $81, $15
	.byte $41, $10
	.word @song5ref911
	.byte $41, $10
	.word @song5ref911
	.byte $81, $23, $81, $15, $81, $37, $81, $15, $81, $37, $81, $15
	.byte $41, $14
	.word @song5ref869
	.byte $41, $10
	.word @song5ref873
@song5ref951:
	.byte $81, $23, $81, $16, $81, $16, $81, $16, $81, $37, $81, $16, $81, $16, $81, $16, $81, $23, $81, $16, $81, $37, $81, $16
	.byte $81, $37, $81, $16, $81, $37, $81, $37, $81
	.byte $41, $10
	.word @song5ref836
	.byte $41, $10
	.word @song5ref836
...
@song6ref302:
	...
	.byte $41, $09
	.word @song6ref302
	.byte $ae, $50, $06, $3c, $30, $8d, $24, $8b, $50, $d4, $30, $3c, $30, $9d, $9f, $9f, $9f
	.byte $41, $0a
	.word @song6ref181
@song6ch3:
	.byte $9f, $9f, $82
...
@song6ref402:
	.byte $85
@song6ref403:
	.byte $80, $2e, $81, $00, $82, $2c, $47, $01, $2c, $00, $47, $02, $2c, $00, $80, $2e, $81, $00, $81, $86, $25, $81, $00, $81
	.byte $41, $10
	.word @song6ref403
	.byte $41, $0c
	.word @song6ref403
...
@song6ref554:
	.byte $20, $85, $20, $83, $20, $20, $47, $01, $20, $83, $20, $85, $12, $85, $12, $83, $12, $17, $17, $83, $17, $81, $47, $06
	.byte $1f, $81
	.byte $41, $16
	.word @song6ref554
	.byte $41, $16
