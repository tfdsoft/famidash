...
@instruments:
	...
	.word @env3,@env20,@env26,@env0 ; 02 : sample
	.word @env16,@env6,@env24,@env0 ; 03 : rel hats
	.word @env35,@env6,@env2,@env0 ; 04 : cymbal
	.word @env22,@env25,@env24,@env0 ; 05 : clap
	.word @env9,@env34,@env24,@env0 ; 06 : kick
	.word @env15,@env20,@env24,@env0 ; 07 : blank
	.word @env21,@env20,@env24,@env0 ; 08 : infernoplex_piano
	.word @env19,@env20,@env24,@env0 ; 09 : blank string
	.word @env13,@env20,@env24,@env10 ; 0a : I don't know what to name this
	.word @env1,@env20,@env24,@env0 ; 0b : echo
	.word @env22,@env20,@env24,@env0 ; 0c : clap no app
	.word @env39,@env20,@env24,@env0 ; 0d : blank instant decay
	.word @env31,@env20,@env24,@env32 ; 0e : jaezu lead
	.word @env28,@env20,@env24,@env0 ; 0f : Instrument 1
	.word @env12,@env20,@env4,@env0 ; 10 : endgame lead
	.word @env37,@env20,@env24,@env0 ; 11 : menu acc
	.word @env41,@env20,@env29,@env0 ; 12 : death moon lead
	.word @env40,@env20,@env24,@env0 ; 13 : blank slower string
	.word @env16,@env20,@env24,@env0 ; 14 : Instrument 2
	.word @env36,@env20,@env27,@env0 ; 15 : shift string
	.word @env30,@env38,@env26,@env0 ; 16 : octave arp
	.word @env13,@env20,@env24,@env0 ; 17 : DMC: drums + bass
	.word @env11,@env20,@env24,@env0 ; 18 : 02 but tri
	.word @env30,@env20,@env24,@env0 ; 19 : quiet bass
	.word @env21,@env20,@env4,@env0 ; 1a : infernogame_lead_piano
	.word @env18,@env20,@env24,@env0 ; 1b : triangle pluck 3
...
; The DPCM aligner used to be here
@song1ch0:
	.byte $46, $08, $97, $4f, $01, $a8, $2a, $83, $9e
@song1ref10:
...
@song2ch0:
	.byte $46, $01, $70, $a4, $05, $71, $81, $73, $81, $75, $81, $77, $81, $79, $81, $7b, $81, $7d, $81, $7f, $81, $4f, $02, $b4
...
@song3ch0:
	.byte $46, $03, $9c, $2b, $85, $2c, $85, $2e, $85, $45, $85, $27, $85, $45, $85, $2c, $85, $45, $85, $00, $ed, $96
@song3ref23:
	...
	.byte $85, $2e, $85, $2c, $85
@song3ref191:
	.byte $2e, $85, $30, $85, $33, $85, $30, $85, $2e, $85, $30, $85, $2c, $85, $45, $85, $00, $ed, $ff, $ff, $ff, $96, $38, $85
...
@song3ref236:
	...
	.byte $44, $00
@song3ch1:
	.byte $79, $9c, $1d, $85, $45, $85, $1b, $8d, $45, $8d, $20, $8d, $45, $8d, $00, $dd, $96
@song3ref318:
...
@song4ref84:
	...
	.byte $41, $20
	.word @song4ref84
	.byte $92, $22, $85, $7a, $94, $50, $0b, $29, $23, $85, $7f, $90, $0f, $81, $03, $81, $0f, $81, $92, $20, $81, $20, $81, $22
	.byte $81, $9a
@song4ref154:
	...
	.byte $08, $83, $0a, $83, $0e, $83, $11, $81, $9a, $27, $27, $27, $8e, $27, $81, $1b, $81, $0f, $a0, $50, $b3, $16, $5b, $85
	.byte $92, $22, $85, $7a, $94, $50, $0b, $29, $23, $85, $7f, $90, $0b, $81, $40, $0b, $81, $0b, $81, $92, $20, $81, $20, $81
	.byte $22, $81, $9a
@song4ref301:
...
@song5ref951:
	...
	.byte $81, $44, $00
@song6ch0:
	.byte $46, $06, $49, .lobyte(@env5), .hibyte(@env5), $4f, $02, $92, $0f, $9d, $72, $49, .lobyte(@env0), .hibyte(@env0), $4a
...
@song6ref34:
	...
	.byte $44, $00
@song6ch1:
	.byte $49, .lobyte(@env14), .hibyte(@env14), $4f, $03, $92, $0f, $9d, $49, .lobyte(@env7), .hibyte(@env7), $4f, $01, $aa
	.byte $10, $97, $45, $83, $49, .lobyte(@env7), .hibyte(@env7), $14, $97, $45, $83, $49, .lobyte(@env7), .hibyte(@env7), $0d
	.byte $97, $45, $83, $7a
@song6ref156:
	.byte $49, .lobyte(@env7), .hibyte(@env7), $4f, $01, $0f, $8b, $45, $aa, $10, $8b, $45, $49, .lobyte(@env7), .hibyte(@env7)
