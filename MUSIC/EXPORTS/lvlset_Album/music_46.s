...
@instruments:
	...
	.word @env9,@env39,@env25,@env0 ; 03 : kick
	.word @env23,@env26,@env25,@env0 ; 04 : clap
	.word @env16,@env21,@env25,@env0 ; 05 : blank
	...
	.word @env36,@env7,@env25,@env0 ; 09 : tight triangle snare
	...
	.word @env33,@env21,@env25,@env35 ; 0e : jaezu lead
	.word @env29,@env21,@env25,@env0 ; 0f : Instrument 1
	.word @env47,@env21,@env30,@env0 ; 10 : death moon lead
	.word @env14,@env21,@env25,@env0 ; 11 : DMC: drums + bass
	.word @env43,@env21,@env25,@env0 ; 12 : blank instant decay
	.word @env1,@env21,@env25,@env0 ; 13 : echo
	.word @env18,@env21,@env25,@env0 ; 14 : Instrument 2
	.word @env31,@env21,@env25,@env0 ; 15 : quiet bass
	.word @env31,@env42,@env27,@env0 ; 16 : octave arp
	.word @env12,@env21,@env25,@env0 ; 17 : 02 but tri
	.word @env41,@env21,@env28,@env0 ; 18 : shift string
	.word @env44,@env21,@env25,@env0 ; 19 : blank slower string
	.word @env22,@env21,@env5,@env0 ; 1a : infernogame_lead_piano
	.word @env22,@env21,@env25,@env0 ; 1b : infernoplex_piano
...
@song1ref176:
	.byte $28, $85
@song1ref178:
	.byte $4b, .lobyte(@env21), .hibyte(@env21), $4c, $90, $16, $81, $22, $81, $16, $81, $00, $16, $4b, .lobyte(@env37), .hibyte(@env37)
	.byte $94, $22, $85, $4b, .lobyte(@env21), .hibyte(@env21), $4c, $90, $16, $85, $4b, .lobyte(@env37), .hibyte(@env37), $94
	.byte $41, $0e
	.word @song1ref77
	.byte $41, $0b
	.word @song1ref178
@song1ref214:
	.byte $00, $16, $00, $4b, .lobyte(@env37), .hibyte(@env37), $94, $22, $81, $4b, .lobyte(@env21), .hibyte(@env21), $4c, $90
...
@song1ref419:
	.byte $77
@song1ref420:
	.byte $4b, .lobyte(@env11), .hibyte(@env11), $9a, $25, $85, $00, $81, $4b, .lobyte(@env46), .hibyte(@env46), $22, $85, $00
...
@song3ch0:
	.byte $46, $02, $70, $a0, $05, $71, $81, $73, $81, $75, $81, $77, $81, $79, $81, $7b, $81, $7d, $81, $7f, $81, $4f, $02, $b4
