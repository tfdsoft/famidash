...
@instruments:
	...
	.word @env31,@env40,@env26,@env0 ; 11 : octave arp
	...
	.word @env16,@env21,@env25,@env1 ; 15 : Extreme pitch down
	.word @env42,@env21,@env25,@env0 ; 16 : blank slower string
	.word @env31,@env40,@env25,@env0 ; 17 : octave arp [ no duty ]
	.word @env14,@env21,@env25,@env0 ; 18 : 02 but tri
	.word @env38,@env21,@env27,@env0 ; 19 : shift string
...
@song1ref967:
	...
	.byte $b5, $44, $00
@song2ch0:
	.byte $46, $08, $97, $4f, $01, $a8, $2a, $83, $a0
@song2ref10:
