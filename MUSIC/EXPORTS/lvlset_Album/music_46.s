...
@instruments:
	...
	.word @env46,@env24,@env28,@env0 ; 02 : blank instant decay
	.word @env2,@env24,@env28,@env0 ; 03 : echo
	.word @env13,@env40,@env28,@env0 ; 04 : kick
	.word @env12,@env9,@env39,@env0 ; 05 : hat
	.word @env41,@env9,@env3,@env0 ; 06 : cymbal
	.word @env4,@env24,@env30,@env0 ; 07 : sample
	.word @env19,@env24,@env28,@env0 ; 08 : blank
	.word @env34,@env24,@env28,@env44 ; 09 : Metal hit
	...
	.word @env17,@env24,@env28,@env15 ; 0d : I don't know what to name this
	.word @env26,@env24,@env28,@env0 ; 0e : clap no app
	.word @env16,@env24,@env6,@env0 ; 0f : endgame lead
	.word @env22,@env24,@env28,@env0 ; 10 : triangle pluck 3
	.word @env36,@env24,@env28,@env37 ; 11 : jaezu lead
	.word @env17,@env24,@env28,@env0 ; 12 : DMC: drums + bass
	.word @env29,@env24,@env28,@env0 ; 13 : Blank rel
	.word @env43,@env24,@env28,@env0 ; 14 : menu acc
	.word @env35,@env45,@env28,@env0 ; 15 : octave arp [ no duty ]
	.word @env47,@env24,@env28,@env0 ; 16 : blank slower string
	.word @env17,@env24,@env28,@env1 ; 17 : Extreme pitch down
	.word @env42,@env24,@env31,@env0 ; 18 : shift string
	.word @env48,@env24,@env33,@env0 ; 19 : death moon lead
...
@song0ch0:
	.byte $46, $06, $49, .lobyte(@env7), .hibyte(@env7), $4f, $02, $96, $0f, $9d, $72, $49, .lobyte(@env0), .hibyte(@env0), $4a
...
@song0ref34:
	...
	.byte $44, $00
@song0ch1:
	.byte $49, .lobyte(@env18), .hibyte(@env18), $4f, $03, $96, $0f, $9d, $49, .lobyte(@env11), .hibyte(@env11), $4f, $01, $b0
	.byte $10, $97, $45, $83, $49, .lobyte(@env11), .hibyte(@env11), $14, $97, $45, $83, $49, .lobyte(@env11), .hibyte(@env11)
	.byte $0d, $97, $45, $83, $7a
@song0ref156:
	.byte $49, .lobyte(@env11), .hibyte(@env11), $4f, $01, $0f, $8b, $45, $b0, $10, $8b, $45, $49, .lobyte(@env11), .hibyte(@env11)
...
@song4ref749:
	.byte $7b
@song4ref750:
	.byte $88, $09, $81, $78, $82, $12, $00, $7b, $80, $0e, $81, $76, $82, $12, $00, $7f, $92, $12, $83, $48, $09, $81, $7b, $80
	.byte $0e, $81, $82, $12, $81
	.byte $41, $0f
	.word @song4ref750
	.byte $41, $0f
...
@song4ref788:
	.byte $76
@song4ref789:
	.byte $88, $09, $81, $73, $82, $12, $00, $76, $80, $0e, $81, $72, $82, $12, $00, $78, $92, $12, $83, $48, $09, $81, $76, $80
	.byte $0e, $81, $82, $12, $81
	.byte $41, $0f
	.word @song4ref789
	.byte $41, $0f
...
@song5ref154:
	...
	.byte $08, $83, $0a, $83, $0e, $83, $11, $81, $84, $27, $27, $27, $90, $27, $81, $1b, $81, $0f, $9e, $50, $b3, $16, $5b, $85
...
@song5ch1:
	...
	.byte $27, $27, $94, $27, $81, $1b, $81, $0f, $9e, $50, $b3, $16, $5b, $85, $00, $85, $7a, $9a, $50, $0b, $29, $23, $85, $7f
...
@song5ref999:
	...
	.word @song5ref999
@song5ref1024:
	.byte $22, $81, $19, $81, $37, $81, $19, $81, $22, $81, $19, $81, $37, $81, $19, $81
	.byte $41, $10
	.word @song5ref1024
@song5ref1043:
