...
@instruments:
	...
	.word @env27,@env30,@env34,@env0 ; 0a : blank string
	.word @env8,@env30,@env35,@env0 ; 0b : loud sample
	.word @env26,@env30,@env34,@env0 ; 0c : triangle pluck 3
	.word @env43,@env30,@env36,@env0 ; 0d : shift string
	.word @env7,@env30,@env22,@env0 ; 0e : deep bass
	.word @env13,@env10,@env40,@env0 ; 0f : hat
	.word @env32,@env30,@env33,@env19 ; 10 : Kap lead piano
	.word @env16,@env10,@env2,@env0 ; 11 : crash
	.word @env45,@env30,@env34,@env0 ; 12 : menu acc
	.word @env24,@env10,@env34,@env0 ; 13 : rel hats
...
@song1ref268:
	...
	.byte $41, $60
	.word @song1ref268
	.byte $4b, .lobyte(@env42), .hibyte(@env42), $17, $81, $4b, .lobyte(@env30), .hibyte(@env30), $4c, $9c
	.byte $41, $0e
	.word @song1ref129
	.byte $41, $12
	.word @song1ref144
...
@song2ref140:
	...
	.byte .hibyte(@env6), $4f, $02, $94, $0f, $99, $45, $81, $44, $00
@song2ch1:
	.byte $7a, $49, .lobyte(@env12), .hibyte(@env12), $4f, $01, $9a
@song2ref249:
	.byte $0d, $97, $45, $83, $9a, $14, $97, $45, $83, $12, $97, $45, $83, $10, $8b, $45, $0f, $8b, $45, $49, .lobyte(@env12)
	...
	.byte $41, $12
	.word @song2ref249
	.byte $49, .lobyte(@env12), .hibyte(@env12), $4f, $01, $0d, $99, $45, $81, $9a, $14, $99, $45, $81, $10, $99, $45, $81, $49
