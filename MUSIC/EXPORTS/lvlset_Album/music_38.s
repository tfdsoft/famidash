...
@instruments:
	...
	.word @env30,@env22,@env27,@env0 ; 12 : triangle pluck 4
	.word @env10,@env6,@env33,@env0 ; 13 : hat
	.word @env37,@env22,@env27,@env0 ; 14 : menu acc
...
@song1ref249:
	...
	.byte .lobyte(@env15), .hibyte(@env15), $4f, $03, $9e, $0f, $99, $45, $81, $44, $00
@song1ch2:
	.byte $a0
@song1ref316:
