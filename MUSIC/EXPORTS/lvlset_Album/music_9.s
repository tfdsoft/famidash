...
@instruments:
	...
	.word @env20,@env21,@env26,@env0 ; 06 : triangle pluck 3
	.word @env34,@env6,@env1,@env0 ; 07 : cymbal
	.word @env35,@env21,@env26,@env0 ; 08 : tight noise kick layer
	.word @env2,@env21,@env26,@env15 ; 09 : triangle drums
	.word @env23,@env21,@env26,@env0 ; 0a : triangle pluck
	.word @env8,@env21,@env26,@env0 ; 0b : clutterfunk sax
	.word @env13,@env21,@env4,@env0 ; 0c : endgame lead
	.word @env29,@env21,@env26,@env30 ; 0d : jaezu lead
	.word @env14,@env21,@env5,@env0 ; 0e : hex guitar 1
	.word @env14,@env21,@env26,@env0 ; 0f : DMC: drums + bass
	.word @env16,@env21,@env3,@env0 ; 10 : electroman lead
	.word @env14,@env21,@env17,@env0 ; 11 : hex guitar 2
	.word @env28,@env38,@env26,@env0 ; 12 : octave arp [ no duty ]
	.word @env39,@env21,@env26,@env0 ; 13 : blank instant decay
...
@song1ref7:
	...
	.byte .hibyte(@env12), $19, $81, $00, $4d, $19, $81, $4b, .lobyte(@env11), .hibyte(@env11), $19, $81, $4b, .lobyte(@env41)
...
@song1ch1:
@song1ref196:
	.byte $75, $4b, .lobyte(@env37), .hibyte(@env37), $98
@song1ref201:
	...
	.byte .hibyte(@env12), $0d, $81, $00, $4d, $0d, $81, $4b, .lobyte(@env11), .hibyte(@env11), $0d, $81, $4b, .lobyte(@env41)
...
@song1ref274:
	.byte $4f, $00, $9a, $50, $f6, $33, $36, $2a, $49, .lobyte(@env36), .hibyte(@env36), $89, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $9a, $27, $81, $49, .lobyte(@env36), .hibyte(@env36), $81, $49, .lobyte(@env36), .hibyte(@env36), $8b, $49, .lobyte(@env0)
	.byte .hibyte(@env0), $4a, $9a, $25, $81, $49, .lobyte(@env36), .hibyte(@env36), $83, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $9a, $2a, $49, .lobyte(@env36), .hibyte(@env36), $83, $9a, $29, $8f, $49, .lobyte(@env0), .hibyte(@env0), $4a
	.byte $4f, $00, $50, $f6, $33, $36, $2a, $49, .lobyte(@env36), .hibyte(@env36), $89, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $9a, $27, $81, $49, .lobyte(@env36), .hibyte(@env36), $81, $49, .lobyte(@env36), .hibyte(@env36), $8b, $49, .lobyte(@env0)
	.byte .hibyte(@env0), $4a, $9a, $25, $49, .lobyte(@env36), .hibyte(@env36), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a
	.byte $9a, $1e, $49, .lobyte(@env36), .hibyte(@env36), $83, $49, .lobyte(@env0), .hibyte(@env0), $4a, $9a, $20, $81, $49
	.byte .lobyte(@env36), .hibyte(@env36), $8d, $49, .lobyte(@env0), .hibyte(@env0), $4a
	.byte $41, $17
	.word @song1ref274
@song1ref393:
	.byte $49, .lobyte(@env0), .hibyte(@env0), $4a, $9a, $2a, $49, .lobyte(@env36), .hibyte(@env36), $83, $49, .lobyte(@env0)
	.byte .hibyte(@env0), $4a, $9a, $2c, $81, $49, .lobyte(@env36), .hibyte(@env36), $8d, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $9a, $22, $81, $1b, $81, $22, $81, $1b, $22, $49, .lobyte(@env36), .hibyte(@env36), $1e, $81, $9a, $27, $81, $49
	.byte .lobyte(@env0), .hibyte(@env0), $4a, $25, $81, $23, $81, $25, $81, $22, $81, $1e, $81
@song1ref449:
	.byte $1d, $49, .lobyte(@env36), .hibyte(@env36), $81, $4f, $01, $83, $4f, $00, $9a, $19, $81, $1d, $81, $1e
@song1ref465:
	...
	.byte $20, $49, .lobyte(@env36), .hibyte(@env36), $4f, $01, $83, $4f, $00, $81, $9a, $2a, $85, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $29
	.byte $41, $17
	.word @song1ref465
	.byte $41, $25
...
@song1ref565:
	...
	.byte $41, $18
	.word @song1ref565
	.byte $49, .lobyte(@env0), .hibyte(@env0), $4a, $9a, $2e, $81, $27, $00, $2e, $00, $27, $2e, $49, .lobyte(@env36), .hibyte(@env36)
	.byte $2a, $00, $9a, $33, $81, $49, .lobyte(@env0), .hibyte(@env0), $4a, $31, $81, $2f, $81, $31, $00, $2e, $00, $2a, $00
@song1ref636:
	.byte $29, $49, .lobyte(@env36), .hibyte(@env36), $83, $00, $9a, $25, $00, $29, $00, $2a
@song1ref648:
	.byte $00, $49, .lobyte(@env0), .hibyte(@env0), $4a, $2e, $81, $27, $00, $2e, $00, $27, $2e, $49, .lobyte(@env36), .hibyte(@env36)
	.byte $2a, $00, $9a, $33, $81, $49, .lobyte(@env0), .hibyte(@env0), $4a, $31, $81, $2f, $81, $31, $00, $2e, $00, $2a, $00
	.byte $2c, $49, .lobyte(@env36), .hibyte(@env36), $00, $83, $9a, $36, $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $35
	.byte $41, $17
	.word @song1ref648
	.byte $41, $25
	.word @song1ref636
...
@song1ref776:
	...
	.byte $41, $18
	.word @song1ref776
	.byte $8a, $3a, $81, $80, $30, $81, $8e, $2e, $8d, $77, $8f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $2e, $8d, $8f, $9f, $9f, $9f
	...
	.byte $41, $18
	.word @song1ref776
	.byte $8a, $3a, $81, $80, $30, $81, $84, $25, $00, $80, $30, $81, $8a, $3a, $81, $80, $30, $81, $8e, $31, $85, $80, $31, $83
	.byte $31, $83, $31, $81, $31, $81, $31, $81, $8e, $2e, $9d, $44, $00
@song1ch4:
@song1ref999:
	.byte $1d, $00, $1a, $81, $31, $00, $1a, $15, $1d, $00, $15, $81, $31, $00, $15, $81, $1d, $00, $16, $81, $31, $00, $16, $13
	...
	.word @song1ref999
@song1ref1049:
	.byte $1a, $81, $00, $81, $1a, $81, $00, $15, $81, $00, $15, $81, $15, $81, $00, $81, $16, $81, $00, $81, $16, $81, $00, $13
	.byte $81, $00, $13, $81, $15, $81, $13, $81
	.byte $41, $20
	.word @song1ref1049
	.byte $41, $20
	.word @song1ref1049
	...
	.byte $41, $20
	.word @song1ref999
	.byte $1d, $00, $1a, $81, $31, $00, $1a, $15, $1d, $00, $15, $81, $31, $00, $15, $81, $31, $00, $16, $81, $31, $00, $16, $31
...
@song2ref679:
	...
	.byte $81, $9f, $44, $00
@song2ch1:
	.byte $85, $78, $4e, $01, $4b, .lobyte(@env22), .hibyte(@env22), $98, $0a, $83, $4f, $01, $81, $4d, $0a, $89, $4d, $11, $85
...
@song2ref1251:
	...
	.byte $41, $2c
	.word @song2ref1251
	.byte $00, $85, $9f, $78, $4e, $01, $4b, .lobyte(@env22), .hibyte(@env22), $98, $0a, $83, $4f, $01, $81, $4d, $0a, $8d, $4d
...
@song2ref4229:
	.byte $85, $31, $81, $31, $83, $31, $1d, $81, $31, $85, $1d, $85, $31, $81, $31, $83, $31, $1d, $81, $31, $85, $1d
	.byte $41, $16
	.word @song2ref4229
	.byte $41, $16
	.word @song2ref4229
...
@song2ref4302:
	.byte $00, $83, $31, $1d, $1d, $1d, $31, $1d, $1d, $1d, $00, $31, $83, $00, $31, $85, $1d, $1d, $1d, $31, $00, $31, $1d, $1d
	.byte $31, $85, $31, $85, $1d, $31, $81, $1d, $31, $81, $1d, $31, $1d, $1d, $31, $31, $31, $1d, $1d, $31, $1d, $31, $1d, $1d
	.byte $1d, $1d, $31, $1d, $31, $81, $00, $81, $31, $81, $00, $1d, $31, $31, $31, $00, $1d, $31, $1d, $1d, $31, $85, $00, $81
	.byte $1d, $1d, $00, $31, $31, $31, $81, $00, $1d, $1d, $31, $85, $00, $81, $1d, $1d, $00, $31, $31, $31, $81, $00, $1d, $1d
	.byte $31, $85, $31, $81, $00, $1d, $31, $31, $31, $00, $1d, $31, $1d, $1d, $31, $85
	.byte $41, $70
	.word @song2ref4302
@song2ref4417:
	...
	.byte $41, $12
	.word @song2ref4417
	.byte $1d, $85, $1d, $85, $1d, $85, $1d, $85, $1d, $85, $1d, $00, $1d, $00, $1d, $00, $1d, $00, $1d, $00, $1d, $00, $31, $31
	.byte $31, $31
	.byte $41, $28
	.word @song2ref4171
	.byte $0e, $85, $05, $95, $0a, $85, $97, $00, $85, $03, $95, $0b, $85, $97, $31
@song2ref4485:
	.byte $85, $31, $85, $1d, $85, $31, $85, $1d, $85, $31, $85, $1d, $85, $31, $85, $1d, $85, $31, $85, $1d
	.byte $41, $14
	.word @song2ref4485
	.byte $41, $14
	.word @song2ref4485
	...
	.byte $41, $14
	.word @song2ref4485
	.byte $85, $31, $85, $1d, $85, $31, $85, $1d, $85, $31, $85, $31, $81, $1d, $31
@song2ref4544:
