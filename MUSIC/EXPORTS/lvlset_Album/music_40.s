...
@instruments:
	...
	.word @env27,@env29,@env35,@env0 ; 03 : triangle pluck 3
	.word @env51,@env29,@env35,@env0 ; 04 : blank instant decay
	.word @env56,@env29,@env35,@env0 ; 05 : triangle pluck 2
	.word @env30,@env29,@env35,@env0 ; 06 : infernoplex_piano
	.word @env21,@env29,@env8,@env0 ; 07 : hex guitar 1
	.word @env40,@env29,@env35,@env0 ; 08 : quiet bass
	.word @env43,@env5,@env35,@env0 ; 09 : tight triangle kick
	.word @env46,@env9,@env3,@env0 ; 0a : cymbal
	.word @env31,@env36,@env35,@env0 ; 0b : clap
	.word @env20,@env29,@env7,@env0 ; 0c : endgame lead
	.word @env4,@env29,@env37,@env0 ; 0d : sample
	.word @env43,@env10,@env35,@env0 ; 0e : tight triangle snare
	.word @env41,@env29,@env35,@env42 ; 0f : jaezu lead
	.word @env24,@env29,@env35,@env0 ; 10 : blank
	.word @env12,@env29,@env35,@env0 ; 11 : clutterfunk sax
	.word @env47,@env29,@env35,@env0 ; 12 : piano
	...
	.word @env54,@env29,@env39,@env0 ; 16 : death moon lead
	.word @env21,@env29,@env35,@env0 ; 17 : DMC: drums + bass
	.word @env52,@env29,@env35,@env0 ; 18 : blank slower string
	.word @env21,@env29,@env35,@env0 ; 19 : Duty 0
	.word @env15,@env44,@env35,@env0 ; 1a : octave arp [ full volume]
	.word @env24,@env29,@env6,@env0 ; 1b : electroman lead
...
@song2ref421:
	...
	.byte $41, $15
	.word @song2ref421
	.byte $74, $51, $01, $b0, $4b, .lobyte(@env55), .hibyte(@env55), $b0, $18, $dd, $79, $49, .lobyte(@env0), .hibyte(@env0)
...
@song3ch2:
@song3ref597:
	.byte $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $92, $01, $85, $01, $85, $01, $85
	.byte $01, $85, $a0
@song3ref624:
...
@song4ref7:
	...
	.byte $41, $14
	.word @song4ref7
	.byte $4f, $03, $85, $4b, .lobyte(@env44), .hibyte(@env44), $8c
@song4ref46:
...
@song4ref984:
	.byte $92, $12, $81, $00, $81, $88, $40, $4e, $81, $40, $4c, $81, $3e, $85, $3b, $85, $92, $12, $81, $00, $89, $9c, $06, $81
	.byte $00, $89
	.byte $41, $14
	.word @song4ref984
	.byte $41, $14
