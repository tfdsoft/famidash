...
@instruments:
	.word @env32,@env9,@env2,@env0 ; 00 : cymbal
	.word @env12,@env22,@env2,@env0 ; 01 : snare 2
	.word @env19,@env23,@env27,@env0 ; 02 : blank
	.word @env14,@env23,@env27,@env0 ; 03 : blank instant more decay
	.word @env30,@env23,@env27,@env31 ; 04 : jaezu lead
	.word @env34,@env23,@env27,@env0 ; 05 : blank string loud
	.word @env15,@env23,@env27,@env0 ; 06 : DMC: drums + bass
	.word @env1,@env23,@env27,@env0 ; 07 : echo
	.word @env11,@env23,@env27,@env0 ; 08 : tiny piano
	.word @env24,@env23,@env5,@env0 ; 09 : infernogame_lead_piano
	.word @env7,@env23,@env28,@env0 ; 0a : loud sample
	.word @env13,@env9,@env2,@env0 ; 0b : crash
	.word @env25,@env23,@env26,@env16 ; 0c : Kap lead piano
	.word @env6,@env23,@env18,@env0 ; 0d : deep bass
...
@song0ref448:
	...
	.byte $20, $2c, $2a, $28, $27, $2a, $28, $27, $24, $25, $28, $2a, $2d, $2c, $27, $25, $24, $21, $20, $1e, $1c, $4b, .lobyte(@env10)
	.byte .hibyte(@env10), $84, $1b, $83, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $86, $2a, $2d, $2c, $2a, $2d, $31, $30
...
@song0ref1343:
	.byte $35, $85, $7f, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $86, $22, $00, $7a, $4b, .lobyte(@env4), .hibyte(@env4)
	.byte $84, $39, $85, $7f, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $86, $22, $00, $7a, $4b, .lobyte(@env4), .hibyte(@env4)
	.byte $84, $3b, $85, $7f, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $86, $22, $00, $7a, $4b, .lobyte(@env4), .hibyte(@env4)
	.byte $84, $3d, $85, $7f, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $86, $22, $00, $7a, $4b, .lobyte(@env4), .hibyte(@env4)
	.byte $84, $3f, $85, $4d, $40, $4d, $85, $4d, $4f, $03
	.byte $41, $14
	.word @song0ref1343
	.byte $7f
@song0ref1416:
	.byte $4d, $4f, $01, $35, $85, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $86, $2e, $00, $4b, .lobyte(@env4), .hibyte(@env4)
	.byte $84, $39, $85, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $86, $2e, $00, $4b, .lobyte(@env4), .hibyte(@env4), $84
	.byte $3b, $85, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $86, $2e, $00, $4b, .lobyte(@env4), .hibyte(@env4), $84, $3d
	.byte $85, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $86, $2e, $00, $4b, .lobyte(@env4), .hibyte(@env4), $84, $3f, $85
	.byte $4d, $40, $4d, $85
	.byte $41, $14
	.word @song0ref1416
	.byte $4b, .lobyte(@env23), .hibyte(@env23), $4c, $4f, $02, $86, $19, $00, $19, $81, $00, $81, $19, $00, $19, $81, $00, $81
...
@song0ref1907:
	...
	.byte $41, $1a
	.word @song0ref1873
	.byte $8c, $25, $9d, $9f, $9f, $9f, $80, $2e, $81, $2e, $85, $2e, $81, $2e, $85, $2e, $81, $2e, $81, $2e, $9d, $00, $9d, $96
...
@song1ref163:
	...
	.byte $81, $2f, $81, $27, $81, $4b, .lobyte(@env33), .hibyte(@env33), $92
@song1ref268:
	.byte $1c, $85, $4d, $1c, $89, $4b, .lobyte(@env3), .hibyte(@env3), $17, $81, $4b, .lobyte(@env33), .hibyte(@env33), $1c
	.byte $81, $4b, .lobyte(@env3), .hibyte(@env3), $17, $81, $4b, .lobyte(@env33), .hibyte(@env33), $1c, $85, $4d, $1c, $85
	.byte $4b, .lobyte(@env3), .hibyte(@env3), $17, $81, $4b, .lobyte(@env33), .hibyte(@env33), $1c, $81, $4b, .lobyte(@env3)
	.byte .hibyte(@env3), $17, $81, $4b, .lobyte(@env8), .hibyte(@env8), $14, $81, $4b, .lobyte(@env29), .hibyte(@env29), $1b
	.byte $85, $4d, $1b, $89, $4b, .lobyte(@env33), .hibyte(@env33), $17, $81, $4b, .lobyte(@env29), .hibyte(@env29), $1b, $81
	.byte $4b, .lobyte(@env33), .hibyte(@env33), $17, $81, $4b, .lobyte(@env29), .hibyte(@env29), $1b, $85, $4d, $1b, $81, $4d
	.byte $19, $81, $4b, .lobyte(@env33), .hibyte(@env33), $17, $81, $4b, .lobyte(@env29), .hibyte(@env29), $19, $81, $4d, $1b
	.byte $81, $4b, .lobyte(@env33), .hibyte(@env33), $17, $81, $4b, .lobyte(@env21), .hibyte(@env21), $19, $85, $4d, $19, $81
	.byte $4b, .lobyte(@env33), .hibyte(@env33), $17, $81, $4b, .lobyte(@env21), .hibyte(@env21), $19, $85, $4d, $19, $81, $4b
	.byte .lobyte(@env33), .hibyte(@env33), $17, $81, $4b, .lobyte(@env21), .hibyte(@env21), $19, $85, $4d, $19, $81, $4b, .lobyte(@env29)
	.byte .hibyte(@env29), $14, $81, $4b, .lobyte(@env21), .hibyte(@env21), $19, $81, $4b, .lobyte(@env33), .hibyte(@env33), $17
	.byte $81, $4b, .lobyte(@env21), .hibyte(@env21), $19, $81, $4b, .lobyte(@env29), .hibyte(@env29), $14, $81, $4b, .lobyte(@env21)
	.byte .hibyte(@env21), $19, $85, $4d, $19, $81, $4b, .lobyte(@env33), .hibyte(@env33), $17, $81, $4b, .lobyte(@env21), .hibyte(@env21)
	.byte $19, $85, $4d, $19, $81, $4b, .lobyte(@env33), .hibyte(@env33), $1c, $81, $4b, .lobyte(@env8), .hibyte(@env8), $1b
	.byte $85, $4d, $1b, $81, $4b, .lobyte(@env33), .hibyte(@env33), $1c, $81, $4b, .lobyte(@env3), .hibyte(@env3), $1e, $81
	.byte $4b, .lobyte(@env33), .hibyte(@env33), $1c, $81, $4b, .lobyte(@env8), .hibyte(@env8), $1b, $81, $4b, .lobyte(@env3)
	.byte .hibyte(@env3), $1e, $81, $4b, .lobyte(@env33), .hibyte(@env33)
	.byte $41, $60
	.word @song1ref268
	.byte $4b, .lobyte(@env33), .hibyte(@env33), $17, $81, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $9a
	.byte $41, $0e
	.word @song1ref129
	.byte $41, $12
	.word @song1ref144
	.byte $41, $5c
	.word @song1ref163
	.byte $27, $85, $2c, $85, $4b, .lobyte(@env33), .hibyte(@env33), $92
@song1ref519:
	.byte $21, $85, $4d, $21, $89, $4b, .lobyte(@env3), .hibyte(@env3), $1c, $81, $4b, .lobyte(@env33), .hibyte(@env33), $21
	.byte $81, $4b, .lobyte(@env3), .hibyte(@env3), $1c, $81, $4b, .lobyte(@env33), .hibyte(@env33), $21, $85, $4d, $21, $85
	.byte $4b, .lobyte(@env3), .hibyte(@env3), $1c, $81, $4b, .lobyte(@env33), .hibyte(@env33), $21, $81, $4b, .lobyte(@env3)
	.byte .hibyte(@env3), $1c, $81, $4b, .lobyte(@env8), .hibyte(@env8), $19, $81, $4b, .lobyte(@env29), .hibyte(@env29), $20
	.byte $85, $4d, $20, $89, $4b, .lobyte(@env33), .hibyte(@env33), $1c, $81, $4b, .lobyte(@env29), .hibyte(@env29), $20, $81
	.byte $4b, .lobyte(@env33), .hibyte(@env33), $1c, $81, $4b, .lobyte(@env29), .hibyte(@env29), $20, $85, $4d, $20, $81, $4d
	.byte $1e, $81, $4b, .lobyte(@env33), .hibyte(@env33), $1c, $81, $4b, .lobyte(@env29), .hibyte(@env29), $1e, $81, $4d, $20
	.byte $81, $4b, .lobyte(@env33), .hibyte(@env33), $1c, $81, $4b, .lobyte(@env21), .hibyte(@env21), $1e, $85, $4d, $1e, $81
	.byte $4b, .lobyte(@env33), .hibyte(@env33), $1c, $81, $4b, .lobyte(@env21), .hibyte(@env21), $1e, $85, $4d, $1e, $81, $4b
	.byte .lobyte(@env33), .hibyte(@env33), $1c, $81, $4b, .lobyte(@env21), .hibyte(@env21), $1e, $85, $4d, $1e, $81, $4b, .lobyte(@env29)
	.byte .hibyte(@env29), $19, $81, $4b, .lobyte(@env21), .hibyte(@env21), $1e, $81, $4b, .lobyte(@env33), .hibyte(@env33), $1c
	.byte $81, $4b, .lobyte(@env21), .hibyte(@env21), $1e, $81, $4b, .lobyte(@env29), .hibyte(@env29), $19, $81, $4b, .lobyte(@env21)
	.byte .hibyte(@env21), $1e, $85, $4d, $1e, $81, $4b, .lobyte(@env33), .hibyte(@env33), $1c, $81, $4b, .lobyte(@env21), .hibyte(@env21)
	.byte $1e, $85, $4d, $1e, $81, $4b, .lobyte(@env33), .hibyte(@env33), $21, $81, $4b, .lobyte(@env8), .hibyte(@env8), $20
	.byte $85, $4d, $20, $81, $4b, .lobyte(@env33), .hibyte(@env33), $21, $81, $4b, .lobyte(@env3), .hibyte(@env3), $23, $81
	.byte $4b, .lobyte(@env33), .hibyte(@env33), $21, $81, $4b, .lobyte(@env8), .hibyte(@env8), $20, $81, $4b, .lobyte(@env3)
	.byte .hibyte(@env3), $23, $81, $4b, .lobyte(@env33), .hibyte(@env33)
	.byte $41, $5c
	.word @song1ref519
	.byte $4b, .lobyte(@env33), .hibyte(@env33), $28, $81, $4b, .lobyte(@env8), .hibyte(@env8), $2c, $81, $4b, .lobyte(@env3)
	.byte .hibyte(@env3), $2f, $81, $4b, .lobyte(@env33), .hibyte(@env33), $2d, $8d, $4b, .lobyte(@env23), .hibyte(@env23), $4c
...
@song1ref1607:
	...
	.byte $39, $85, $3d, $85, $3b, $85, $88, $3b, $85, $49, .lobyte(@env17), .hibyte(@env17), $87, $49, .lobyte(@env20), .hibyte(@env20)
