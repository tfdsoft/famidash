...
@instruments:
	...
	.word @env10,@env48,@env32,@env0 ; 03 : kick
	.word @env29,@env33,@env32,@env0 ; 04 : clap
	.word @env21,@env26,@env32,@env0 ; 05 : blank
	.word @env3,@env26,@env32,@env20 ; 06 : triangle drums
	.word @env13,@env16,@env8,@env0 ; 07 : Instrument 3
	.word @env50,@env7,@env2,@env0 ; 08 : cymbal
	.word @env3,@env26,@env34,@env0 ; 09 : sample
	.word @env51,@env26,@env32,@env0 ; 0a : tight noise kick layer
	.word @env39,@env26,@env32,@env40 ; 0b : jaezu lead
	.word @env54,@env26,@env35,@env0 ; 0c : shift string
	.word @env25,@env26,@env32,@env0 ; 0d : blank string
	.word @env1,@env26,@env32,@env0 ; 0e : echo
	.word @env18,@env26,@env32,@env0 ; 0f : DMC: drums + bass
	.word @env57,@env26,@env32,@env0 ; 10 : blank instant decay
	.word @env38,@env56,@env34,@env0 ; 11 : octave arp
	.word @env28,@env26,@env32,@env0 ; 12 : infernoplex_piano
	.word @env38,@env26,@env32,@env0 ; 13 : quiet bass
	.word @env36,@env26,@env32,@env0 ; 14 : Every End Square
	.word @env22,@env26,@env31,@env19 ; 15 : Kap lead
	.word @env17,@env26,@env6,@env0 ; 16 : endgame lead
	.word @env21,@env26,@env5,@env0 ; 17 : electroman lead
	.word @env4,@env26,@env27,@env61 ; 18 : every end pluck lead
	.word @env15,@env26,@env32,@env0 ; 19 : blank instant more decay
	.word @env58,@env26,@env32,@env0 ; 1a : blank slower string
...
@song0ref508:
	...
	.byte $8a, $05, $72, $81, $76, $81, $75, $81, $74, $81, $78, $ae, $05, $83, $77, $81, $79, $4f, $02, $92
@song0ref582:
	.byte $29, $76, $81, $79
@song0ref586:
...
@song0ref1509:
	...
	.byte $41, $10
	.word @song0ref1509
	.byte $00, $9d, $90, $22, $85, $73, $a0, $23, $81, $72, $23, $81, $73, $23, $81, $72, $23, $83, $71, $8a, $23, $72, $81, $73
...
@song0ref1707:
	...
	.word @song0ref1707
@song0ref1740:
	.byte $2a, $12, $83, $30, $81, $12, $12, $2a, $12, $81, $12, $83, $12, $81
	.byte $41, $0f
	.word @song0ref1707
	.byte $41, $0f
	.word @song0ref1707
...
@song0ref1799:
	...
	.word @song0ref1799
@song0ref1814:
	.byte $2a, $12, $83, $30, $85, $2a, $12, $12, $81, $30, $12, $83
	.byte $41, $0c
	.word @song0ref1814
@song0ref1829:
...
@song2ref270:
	...
	.byte $81, $96, $38, $85, $36, $85, $33, $85, $9a, $2a, $81, $31, $81, $33, $81, $34, $85, $33, $85, $76, $4f, $02, $aa, $25
	.byte $89, $7a
@song2ref416:
...
@song2ref456:
	...
	.byte $27, $4b, .lobyte(@env52), .hibyte(@env52), $27, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $21, $1c, $4b, .lobyte(@env41)
	...
	.byte .hibyte(@env26), $4c, $21, $20, $4b, .lobyte(@env49), .hibyte(@env49), $27, $4b, .lobyte(@env26), .hibyte(@env26), $4c
	.byte $28, $23, $4b, .lobyte(@env41), .hibyte(@env41), $2f, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $23, $1e, $4b, .lobyte(@env49)
	.byte .hibyte(@env49), $31, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $23, $1e, $4b, .lobyte(@env49), .hibyte(@env49), $33
...
@song2ref769:
	...
	.byte $2c, $81, $96, $2d, $85, $9a, $27, $81, $2c, $81, $2e, $81, $2f, $85, $2e, $85, $74, $4b, .lobyte(@env55), .hibyte(@env55)
	.byte $8a, $25, $bd, $4b, .lobyte(@env11), .hibyte(@env11), $21, $9d, $4b, .lobyte(@env59), .hibyte(@env59), $1e, $9d, $4b
	.byte .lobyte(@env12), .hibyte(@env12), $1c, $bd, $4b, .lobyte(@env53), .hibyte(@env53), $19, $9d, $4d, $1b, $9d, $7f, $4e
...
@song2ref872:
	...
	.byte $00
@song2ch2:
	.byte $bf, $bf, $a2, $0d, $9d, $12, $9d, $11, $9d, $09, $9d, $00, $b5, $8a, $20, $25, $27, $2a
@song2ref938:
...
@song2ref1170:
	.byte $21, $00, $86, $16, $00, $90, $21, $00, $86, $16, $00, $90, $21, $00, $79, $82, $21, $81, $7f, $90, $21, $00, $79, $82
	.byte $21, $81, $7f, $90, $21, $00, $86, $16, $00, $90, $21, $81, $86, $16, $00, $90, $21, $00, $79, $82, $21, $81, $7f, $90
	.byte $21, $00, $83
	.byte $41, $0a
	.word @song2ref1170
...
@song2ref1417:
	...
	.byte $41, $19
	.word @song2ref1417
	.byte $90, $1f, $85, $20, $85, $84, $14, $00, $94, $1f, $00
@song2ref1478:
...
@song2ref1571:
	.byte $2a, $81
@song2ref1573:
	.byte $15, $81, $30, $81, $15, $81, $2a, $81, $15, $81, $30, $81, $15
@song2ref1586:
	.byte $81, $2a, $81, $1f, $81, $30, $81, $1f, $81, $2a, $81, $1f, $81, $30, $81, $1f, $81, $2a, $81, $16, $81, $30, $81, $16
	.byte $81, $2a, $81, $16, $81, $30, $81, $16, $81, $2a, $81, $1c, $81, $30, $81, $1c, $81, $2a, $81, $1c, $81, $30, $81, $1c
	.byte $81, $30, $81, $0f, $30, $00, $81, $0f, $81, $00, $30, $0f, $81, $30, $00, $0f, $30, $2a, $2a, $17, $2a, $2a, $2a, $17
	.byte $81, $17, $81, $00, $89
	.byte $41, $22
	.word @song2ref1571
	.byte $41, $10
...
@song2ref1672:
	...
	.byte $41, $11
	.word @song2ref1586
	.byte $30, $81, $0f, $81, $30, $81, $0f, $81, $30, $81, $0f, $81, $30, $81, $0f, $81, $30, $17, $30, $17, $30, $17, $30, $17
	.byte $30, $30, $30, $30, $30, $30, $30, $30, $00, $95, $12, $89, $22, $89, $19, $8d, $00, $89, $12, $81, $1a, $81, $14, $81
	.byte $1c, $85, $19, $81, $00, $81, $19, $85, $22, $85, $1d, $85, $1a, $89, $22, $89, $19, $89, $1a, $89, $22, $85, $19, $85
	.byte $00, $8d, $19, $81, $12, $81, $14, $81, $1c, $89, $15, $81, $26, $81, $0f, $85, $26, $85
@song2ref1799:
	.byte $2a
@song2ref1800:
	.byte $81, $18, $81, $00, $81, $18, $81, $30, $81, $18, $81, $00, $81, $18, $81, $00
	.byte $41, $0f
	.word @song2ref1800
@song2ref1819:
	...
	.word @song2ref1819
@song2ref1860:
	.byte $2a, $81, $18, $81, $30, $81, $18, $81, $2a, $81, $18, $81, $30, $81, $18, $81
	.byte $41, $10
	.word @song2ref1860
	.byte $2a, $81
	.byte $41, $0d
...
@song4ref921:
	...
	.byte $4e, $00, $4f, $01, $b4
@song4ref1011:
	.byte $1f, $95, $4b, .lobyte(@env45), .hibyte(@env45), $1f, $95, $4b, .lobyte(@env14), .hibyte(@env14), $1f, $8d, $4b, .lobyte(@env42)
	.byte .hibyte(@env42), $1b, $ad, $4b, .lobyte(@env43), .hibyte(@env43), $1b, $8d, $4b, .lobyte(@env46), .hibyte(@env46), $22
	.byte $95, $4b, .lobyte(@env52), .hibyte(@env52), $22, $95, $4b, .lobyte(@env44), .hibyte(@env44), $22, $8d, $4b, .lobyte(@env43)
	.byte .hibyte(@env43), $1d, $9d, $4b, .lobyte(@env42), .hibyte(@env42), $1d, $9d, $4e, $00, $4b, .lobyte(@env26), .hibyte(@env26)
	.byte $4c, $4f, $01
	.byte $41, $14
	.word @song4ref1011
...
@song4ch4:
	.byte $ff, $ff, $2a, $8d, $2a, $8d, $2a, $8d, $2a, $8d, $2a, $8d, $2a, $8d, $2a, $8d, $2a, $8d, $2a, $8d, $2a, $8d, $2a, $8d
	.byte $2a, $8d, $2a, $8d, $2a, $8d, $2a, $8d, $2a, $8d, $2a, $8d, $30, $8d, $2a, $8d, $30, $8d, $2a, $8d, $30, $8d, $2a, $8d
	.byte $30, $8d, $2a, $8d, $30, $8d, $2a, $8d, $30, $8d, $2a, $8d, $30, $8d, $2a, $8d, $30, $8d
@song4ref1897:
	.byte $2a, $85, $26, $85, $30, $85, $26, $85, $2a, $85, $26, $85, $30, $85, $26, $85, $2a, $85, $24, $85, $30, $85, $24, $85
	.byte $2a, $85, $24, $85, $30, $85, $24, $85, $2a, $85, $25, $85, $30, $85, $25, $85, $2a, $85, $25, $85, $30, $85, $25, $85
	.byte $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30, $30
	.byte $30, $30, $30, $30, $30, $30, $30, $30, $00, $bd
	.byte $41, $30
	.word @song4ref1897
	.byte $2a, $85, $14, $85, $30, $85, $14, $85, $2a, $85, $14, $85, $30, $85, $14, $85
	.byte $41, $50
	.word @song4ref1897
	.byte $41, $30
	.word @song4ref1897
	...
	.byte $41, $30
	.word @song4ref1897
	.byte $2a, $85, $14, $85, $30, $85, $14, $85, $2a, $85, $14, $85, $30
@song4ref2061:
	.byte $85, $14, $85, $26, $85, $26, $85, $26, $85, $26, $85, $26, $85, $26, $85, $26, $85, $26, $85, $14, $85, $14, $85, $14
	.byte $85, $14, $85, $14, $85, $14, $85, $14
	.byte $41, $13
	.word @song4ref2061
	.byte $24, $85, $24, $85, $24, $85, $24, $85, $24, $85, $24, $85, $24, $85, $24, $85
@song4ref2112:
	.byte $25, $95, $11, $95, $25, $8d, $14, $9d, $00, $8d, $14, $8d, $26, $95, $22, $95, $26, $8d, $24, $9d, $00, $8d, $24, $8d
	.byte $41, $18
	.word @song4ref2112
	.byte $25, $bd, $00, $fd, $44, $00
