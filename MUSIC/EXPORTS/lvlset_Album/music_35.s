...
@instruments:
	...
	.word @env9,@env29,@env22,@env0 ; 01 : kick
	.word @env16,@env21,@env2,@env0 ; 02 : snare
	.word @env8,@env5,@env28,@env0 ; 03 : hat
	.word @env30,@env5,@env2,@env0 ; 04 : cymbal
	.word @env14,@env17,@env22,@env0 ; 05 : blank
	.word @env19,@env23,@env22,@env0 ; 06 : clap
	...
	.word @env18,@env32,@env22,@env0 ; 0a : pluck1
	.word @env12,@env17,@env22,@env0 ; 0b : DMC: drums + bass
	.word @env11,@env17,@env4,@env0 ; 0c : endgame lead
	.word @env18,@env17,@env22,@env0 ; 0d : infernoplex_piano
	.word @env24,@env17,@env22,@env0 ; 0e : quiet bass
	.word @env6,@env17,@env10,@env0 ; 0f : endorphin lead
	.word @env12,@env17,@env22,@env13 ; 10 : tom
	.word @env25,@env17,@env22,@env0 ; 11 : triangle pluck 4
...
@song0ref361:
	...
	.byte $41, $10
	.word @song0ref109
	.byte $81, $77, $4b, .lobyte(@env17), .hibyte(@env17), $4c, $9a
	.byte $41, $1f
	.word @song0ref4
	.byte $41, $1b
	.word @song0ref5
...
@song0ref1620:
	.byte $81, $23, $81, $18, $81, $37, $81, $18, $81, $18, $81, $23, $81, $37, $81, $18
	.byte $41, $10
	.word @song0ref1620
	.byte $41, $10
	.word @song0ref1620
...
@song3ref1302:
	...
	.byte $8a, $20, $81, $76, $51, $fc, $30, $96, $1e, $81, $80, $1f, $81, $75, $8c, $1d, $81, $73, $80, $1f, $81, $75, $8c, $1d
...
@song3ref1489:
	...
	.byte $41, $10
	.word @song3ref1489
	.byte $37, $00, $1a, $81, $37, $00, $1a, $81, $37, $00, $1a, $81, $37, $00, $1a, $81, $37, $00, $1b, $81, $37, $00, $1b, $81
	.byte $37, $00, $1b, $81, $37, $00, $1b, $81
	.byte $41, $10
	.word @song3ref1489
	.byte $41, $0e
	.word @song3ref1489
...
@song3ref1640:
	...
	.word @song3ref1640
@song3ref1662:
	.byte $23, $81, $1b, $1b, $37, $81, $1b, $1b, $23, $81, $14, $14, $37, $81, $14, $14
	.byte $41, $10
	.word @song3ref1640
	.byte $41, $10
	.word @song3ref1640
@song3ref1684:
	.byte $23, $81, $1b, $1b, $37, $81, $1b, $1b, $23, $81, $1b, $1b, $37, $81, $1b, $1b, $23, $81, $1c, $1c, $37, $81, $1c, $1c
