...
.export _music_data_famidash_music62:=music_data_famidash_music62

music_data_famidash_music62:
	.byte 6
	.word @instruments
	.word @samples-5
; 00 : Menu Theme
...
.export music_data_famidash_music62
...
@instruments:
	...
	.word @env39,@env22,@env27,@env0 ; 08 : piano
	.word @env1,@env22,@env27,@env0 ; 09 : echo
	.word @env46,@env22,@env47,@env0 ; 0a : piano duty
	.word @env32,@env22,@env27,@env0 ; 0b : quiet bass
	.word @env20,@env22,@env27,@env0 ; 0c : loud blank string
	.word @env23,@env22,@env27,@env0 ; 0d : infernoplex_piano
	.word @env45,@env22,@env31,@env0 ; 0e : Instrument 4
	.word @env48,@env22,@env27,@env0 ; 0f : menu acc
	.word @env12,@env34,@env27,@env0 ; 10 : octave arp [ full volume]
	.word @env13,@env22,@env27,@env0 ; 11 : DMC: drums + bass
	.word @env17,@env6,@env27,@env0 ; 12 : rel hats
	.word @env19,@env22,@env27,@env0 ; 13 : triangle pluck 3
	.word @env42,@env22,@env30,@env0 ; 14 : shift string
	.word @env9,@env22,@env27,@env0 ; 15 : clutterfunk sax
	.word @env33,@env4,@env27,@env0 ; 16 : tight triangle kick
...
@song0ref140:
	...
	.byte .hibyte(@env5), $4f, $02, $8a, $0f, $99, $45, $81, $44, $00
@song0ch1:
...
@song0ref249:
	...
	.byte .lobyte(@env14), .hibyte(@env14), $4f, $03, $8a, $0f, $99, $45, $81, $44, $00
@song0ch2:
	.byte $a6
@song0ref316:
...
@song1ch4:
	.byte $ff, $ff
@song1ref635:
	.byte $20, $81, $17, $81, $35, $81, $17, $81, $20, $81, $17, $81, $35, $81, $18, $81, $20, $81, $1e, $81, $35, $81, $1e, $81
	.byte $20, $81, $1e, $81, $35, $81, $1e, $81, $20, $81, $16, $81, $35, $81, $16, $81, $20, $81, $16, $81, $35, $81, $16, $81
...
@song2ref234:
	...
	.word @song2ref97
@song2ref287:
	.byte $7a, $4b, .lobyte(@env44), .hibyte(@env44), $4f, $01, $8c, $1e, $78, $81, $76, $81, $74, $81, $7a, $4d, $1e, $78, $81
...
@song2ref904:
	...
	.byte $1d, $85, $15, $89, $00, $91
@song2ref946:
	.byte $16, $89, $00, $89, $15, $85, $16, $89, $00, $89, $15, $85, $1b, $85, $20, $00, $83, $35, $85, $18, $85, $16, $85, $20
