...
@instruments:
	...
	.word @env4,@env18,@env23,@env0 ; 03 : sample
	...
	.word @env2,@env18,@env22,@env0 ; 08 : echo
	.word @env13,@env18,@env22,@env10 ; 09 : I don't know what to name this
	.word @env25,@env18,@env22,@env0 ; 0a : Instrument 1
	.word @env20,@env18,@env22,@env0 ; 0b : clap no app
	.word @env17,@env18,@env22,@env0 ; 0c : blank string
	.word @env36,@env18,@env22,@env0 ; 0d : blank instant decay
	.word @env28,@env18,@env22,@env29 ; 0e : jaezu lead
	.word @env15,@env18,@env22,@env0 ; 0f : Instrument 2
	.word @env12,@env18,@env5,@env0 ; 10 : endgame lead
	.word @env27,@env35,@env23,@env0 ; 11 : octave arp
	.word @env27,@env35,@env22,@env0 ; 12 : octave arp [ no duty ]
	.word @env11,@env18,@env22,@env0 ; 13 : 02 but tri
	.word @env13,@env18,@env22,@env0 ; 14 : DMC: drums + bass
	.word @env33,@env18,@env24,@env0 ; 15 : shift string
	.word @env13,@env18,@env22,@env1 ; 16 : Extreme pitch down
	.word @env37,@env18,@env22,@env0 ; 17 : blank slower string
	.word @env34,@env18,@env22,@env0 ; 18 : menu acc
	.word @env38,@env18,@env26,@env0 ; 19 : death moon lead
...
@song4ch1:
	...
	.byte $27, $27, $8e, $27, $81, $1b, $81, $0f, $a0, $50, $b3, $16, $5b, $85, $00, $85, $7a, $92, $50, $0b, $29, $23, $85, $7f
...
@song5ref88:
	...
	.byte $41, $27
	.word @song5ref88
	.byte $90, $32, $94, $36, $34, $81, $32, $34, $81, $32, $36, $81, $37, $36, $81, $32, $2d, $83, $2b, $81, $2a, $2b, $81, $2a
	.byte $26, $81
@song5ref166:
	.byte $2a, $26
@song5ref168:
...
@song5ch1:
	.byte $7a, $4f, $02, $aa, $26, $81, $45, $89, $25, $81, $45, $2a, $81, $45, $2b, $81, $45, $2d, $81, $45, $28, $81, $45, $2a
