...
@instruments:
	...
	.word @env10,@env22,@env25,@env0 ; 0e : clutterfunk sax
	.word @env15,@env22,@env25,@env0 ; 0f : DMC: drums + bass
	.word @env29,@env22,@env25,@env0 ; 10 : Instrument 1
	.word @env14,@env22,@env5,@env0 ; 11 : endgame lead
	.word @env32,@env45,@env26,@env0 ; 12 : octave arp
	.word @env32,@env22,@env25,@env0 ; 13 : quiet bass
...
@song0ref153:
	.byte $49, .lobyte(@env44), .hibyte(@env44), $1d, $81, $9c, $29, $81, $00, $81, $22, $81, $22, $81, $25, $81, $29, $81, $00
	.byte $81, $20
	.byte $41, $0f
	.word @song0ref36
	.byte $41, $10
