...
@instruments:
	...
	.word @env21,@env25,@env28,@env0 ; 06 : blank
	.word @env26,@env25,@env28,@env0 ; 07 : infernoplex_piano
	.word @env42,@env25,@env28,@env0 ; 08 : blank instant decay
	.word @env17,@env25,@env28,@env13 ; 09 : I don't know what to name this
	.word @env24,@env25,@env28,@env0 ; 0a : blank string
	.word @env16,@env25,@env5,@env0 ; 0b : endgame lead
	.word @env2,@env25,@env28,@env0 ; 0c : echo
	.word @env31,@env25,@env28,@env0 ; 0d : Instrument 1
	.word @env46,@env25,@env32,@env0 ; 0e : death moon lead
	.word @env4,@env25,@env28,@env20 ; 0f : triangle drums
	.word @env22,@env25,@env28,@env0 ; 10 : Instrument 2
	.word @env33,@env41,@env28,@env0 ; 11 : octave arp [ no duty ]
	.word @env40,@env25,@env28,@env0 ; 12 : menu acc
	.word @env33,@env41,@env29,@env0 ; 13 : octave arp
	.word @env17,@env25,@env28,@env1 ; 14 : Extreme pitch down
	.word @env17,@env25,@env28,@env0 ; 15 : DMC: drums + bass
	.word @env39,@env25,@env30,@env0 ; 16 : shift string
	.word @env15,@env25,@env28,@env0 ; 17 : 02 but tri
...
@song4ref84:
	...
	.byte $41, $20
	.word @song4ref84
	.byte $94, $22, $85, $7a, $92, $50, $0b, $29, $23, $85, $7f, $8e, $0f, $81, $03, $81, $0f, $81, $94, $20, $81, $20, $81, $22
	.byte $81, $90
@song4ref154:
	.byte $1b, $81, $1b, $81, $1b, $81, $1b, $81, $1b, $81, $1b, $81, $94, $22, $85, $00, $8c, $40, $0a, $01, $03, $00, $06, $08
	.byte $0a, $06, $03, $94, $20, $81, $20, $81, $22, $81, $8e, $1b, $19, $14, $20, $81, $22, $25, $27, $21, $20, $1e, $20, $83
	...
	.byte $08, $83, $0a, $83, $0e, $83, $11, $81, $90, $27, $27, $27, $8c, $27, $81, $1b, $81, $0f, $96, $50, $b3, $16, $5b, $85
	.byte $94, $22, $85, $7a, $92, $50, $0b, $29, $23, $85, $7f, $8e, $0b, $81, $40, $0b, $81, $0b, $81, $94, $20, $81, $20, $81
	.byte $22, $81, $90
@song4ref301:
...
@song4ch1:
	...
	.byte $27, $27, $8e, $27, $81, $1b, $81, $0f, $96, $50, $b3, $16, $5b, $85, $00, $85, $7a, $92, $50, $0b, $29, $23, $85, $7f
...
@song5ch1:
	.byte $ff, $ff, $bf, $4b, .lobyte(@env10), .hibyte(@env10), $8e, $1c, $83, $00, $83, $4d, $1c, $83, $00, $8b, $4b, .lobyte(@env44)
