...
@instruments:
	...
	.word @env12,@env19,@env5,@env0 ; 0a : endgame lead
	.word @env13,@env19,@env22,@env0 ; 0b : DMC: drums + bass
	.word @env17,@env19,@env22,@env0 ; 0c : loud blank string
...
@song2ch1:
@song2ch1loop:
	.byte $4c, $76, $4f, $03, $87, $4b, .lobyte(@env11), .hibyte(@env11), $98
@song2ref404:
