...
@instruments:
	.word @env1,@env23,@env29,@env0 ; 00 : echo
	.word @env39,@env5,@env2,@env0 ; 01 : cymbal
	.word @env9,@env38,@env29,@env0 ; 02 : kick
	.word @env17,@env23,@env29,@env0 ; 03 : blank
	.word @env27,@env30,@env29,@env0 ; 04 : clap
	.word @env3,@env23,@env29,@env16 ; 05 : triangle drums
	.word @env14,@env23,@env29,@env0 ; 06 : DMC: drums + bass
	.word @env45,@env23,@env29,@env0 ; 07 : blank instant decay
	.word @env19,@env5,@env29,@env0 ; 08 : rel hats
	.word @env7,@env5,@env37,@env0 ; 09 : hat
	.word @env21,@env28,@env2,@env0 ; 0a : snare
	.word @env35,@env6,@env29,@env0 ; 0b : tight triangle snare
	.word @env3,@env23,@env32,@env0 ; 0c : sample
	.word @env35,@env4,@env29,@env0 ; 0d : tight triangle kick
	.word @env50,@env10,@env2,@env0 ; 0e : funny drums
	.word @env33,@env23,@env29,@env34 ; 0f : jaezu lead
	.word @env14,@env23,@env18,@env0 ; 10 : hex guitar 2
	.word @env40,@env23,@env20,@env24 ; 11 : TClead 1
	.word @env8,@env23,@env26,@env0 ; 12 : TClead
	.word @env46,@env23,@env29,@env0 ; 13 : blank slower string
...
@song0ref462:
	...
	.byte $27, $81, $72, $4b, .lobyte(@env11), .hibyte(@env11), $1e, $81, $74, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $23
	.byte $81, $72, $4b, .lobyte(@env11), .hibyte(@env11), $1e, $85, $74, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $28, $81
	.byte $27, $81, $72, $4b, .lobyte(@env11), .hibyte(@env11), $1e, $81, $74, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $25
	...
	.byte $41, $0e
	.word @song0ref194
	.byte $71, $4b, .lobyte(@env11), .hibyte(@env11), $1e, $81, $73, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $23, $74, $85
	.byte $71, $4b, .lobyte(@env11), .hibyte(@env11), $1e, $81, $74, $4b, .lobyte(@env23), .hibyte(@env23), $4c
	.byte $41, $14
	.word @song0ref232
@song0ref687:
	...
	.byte $41, $0e
	.word @song0ref194
	.byte $72, $4b, .lobyte(@env11), .hibyte(@env11), $1e, $81, $73, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $23, $74, $85
	.byte $72, $4b, .lobyte(@env11), .hibyte(@env11), $1e, $81, $74, $4b, .lobyte(@env23), .hibyte(@env23), $4c
	.byte $41, $14
	.word @song0ref232
	.byte $41, $10
	.word @song0ref687
...
@song0ref865:
	...
	.byte .lobyte(@env23), .hibyte(@env23), $4c, $27, $74, $85, $73, $23, $74, $85, $73, $25, $74, $81, $23, $72, $4b, .lobyte(@env11)
	.byte .hibyte(@env11), $1e, $73, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $27, $74, $81, $2a, $72, $4b, .lobyte(@env11)
	.byte .hibyte(@env11), $1e, $73, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $25, $74, $85, $73, $23, $74, $81, $27, $81
	...
	.byte $00, $9d, $44, $00
@song0ch2:
	.byte $8a, $2c, $85, $00, $f5, $ff, $8c, $50, $7f, $38, $1c, $14, $9b, $10, $9d, $12, $9d, $17, $9d, $14, $9d, $10, $9d, $12
	.byte $9d, $17, $9d
@song0ref1046:
	.byte $8a, $20, $8c, $14, $83, $8a, $20, $8c, $14, $83, $8a, $20, $8c, $14, $83, $8a, $20, $8c, $14, $83, $8a
@song0ref1067:
	.byte $20, $8c, $10, $83, $8a, $20, $8c, $10, $83, $8a, $20, $8c, $10, $83, $8a, $20, $8c, $10, $83, $8a, $20, $8c, $12, $83
	.byte $8a, $20, $8c, $12, $83, $8a, $20, $8c, $12, $83, $8a, $20, $8c, $12, $83, $8a, $20, $8c, $17, $83, $8a, $20, $8c, $17
	.byte $83, $17, $85, $17, $85
	.byte $41, $26
	.word @song0ref1046
	.byte $8a, $20, $8c, $17, $8a, $20, $8c, $17, $8a, $20, $8c, $17, $8a, $20, $8c, $17, $8a, $20, $8c, $17, $8a, $20, $20, $20
	.byte $20, $1b, $00, $83, $1b, $00, $83, $1b, $00, $1b, $1b, $1b, $00, $1b, $1b
	.byte $41, $1e
	.word @song0ref1067
	.byte $8a, $20, $8c, $17, $83, $8a, $20, $8c, $17, $83
	.byte $41, $2a
	.word @song0ref1046
...
@song0ref1285:
	.byte $20
@song0ref1286:
	.byte $79, $81, $78, $81, $77, $81, $7f, $94, $14, $73, $8c, $1e, $7f, $90, $21, $72, $8c, $1e, $7f, $90, $21, $71, $8c, $1d
	.byte $7f, $90
@song0ref1312:
	.byte $21, $81, $94
@song0ref1315:
	.byte $14, $81, $90, $21, $81, $21, $81, $21, $81, $94, $14, $81, $90, $21, $81, $21, $81
	.byte $41, $10
	.word @song0ref1312
	.byte $41, $10
	.word @song0ref1312
	...
	.byte $41, $10
	.word @song0ref1312
	.byte $21, $81, $94, $14, $81, $90, $21, $81, $7a, $8c, $1f
	.byte $41, $19
	.word @song0ref1286
	.byte $41, $10
	.word @song0ref1312
	.byte $41, $0e
	.word @song0ref1312
	.byte $20, $74, $8c, $20, $75, $83, $7f, $94, $15, $77, $8c, $20, $78, $81, $79, $81, $78, $1f, $77, $81, $76, $81, $75, $81
	.byte $7f, $94, $14, $74, $8c, $1e, $73, $83, $7f, $94, $14, $81, $14, $14, $14, $81, $14, $14, $7a, $8c
@song0ref1427:
	.byte $1f, $79, $81, $78, $81, $77, $81, $7f, $84, $14, $73, $8c, $1e, $7f, $90, $21, $72, $8c, $1e, $7f, $84, $14, $71, $8c
	.byte $1d, $7f
@song0ref1453:
...
@song1ch1:
	...
	.byte $27, $81, $27, $27, $44, $00
@song1ch2:
	.byte $8a, $25, $81, $00, $81, $96, $01, $81
@song1ref299:
	.byte $88, $1d
@song1ref301:
	.byte $81, $8a, $25, $81, $00, $81, $96, $01, $81, $00, $81, $8a, $25, $81, $00, $81, $96, $01, $81, $88, $18
	.byte $41, $0f
	.word @song1ref301
	.byte $88, $1b
	.byte $41, $10
...
@song1ch3:
	.byte $7d
@song1ref393:
	.byte $84, $28, $81, $79, $90, $2f, $81, $7d, $9c, $2f, $81, $92, $2f, $81, $79, $90, $2f, $81, $7d, $92, $2f, $81, $9c, $2f
	.byte $81, $92, $2f, $81
	.byte $41, $10
	.word @song1ref393
	.byte $41, $10
	...
	.byte $41, $10
	.word @song1ref393
	.byte $82, $20, $81, $92, $2f, $81, $48, $0a, $82, $2d, $00, $83, $92, $2f, $81, $84, $28, $81
@song1ref460:
	.byte $48, $0a, $82, $2d, $00, $92, $2f, $81
@song1ref468:
	.byte $84, $28, $81, $92, $2f, $81, $48, $0a, $82, $2d, $00, $84, $28, $81, $92, $2f, $81, $84, $28, $81, $7b, $48, $0a, $82
	.byte $2d, $00, $83
	.byte $41, $0c
	.word @song1ref468
	.byte $41, $10
	...
	.byte $41, $10
	.word @song1ref460
	.byte $48, $0a, $82, $2d, $00, $92, $2f, $81, $44, $00
@song1ch4:
@song1ref548:
...
@song1ref576:
	.byte $15, $85, $37, $81, $15
@song1ref581:
	.byte $81, $23, $85, $37, $85, $20, $85, $37, $81, $20, $81, $23, $85, $37, $00, $83, $21, $85, $37, $81, $21
	.byte $41, $10
	.word @song1ref581
	.byte $41, $1a
	.word @song1ref576
...
@song3ref104:
	...
	.byte $4d, $28, $74, $81, $7c, $4d, $28, $81, $74, $83, $7c, $4d, $26, $74, $81, $7c, $4b, .lobyte(@env49), .hibyte(@env49)
...
@song4ref120:
	...
	.word @song4ref77
@song4ref190:
	.byte $80, $24, $81, $8e, $25, $81, $80, $25, $81, $49, .lobyte(@env31), .hibyte(@env31), $8e, $0f, $81, $80, $0f, $81, $8e
...
@song4ref314:
	...
	.byte $41, $14
	.word @song4ref314
	.byte $76, $49, .lobyte(@env13), .hibyte(@env13), $4b, .lobyte(@env36), .hibyte(@env36), $4f, $01, $a6, $3c, $85, $4d, $a6
...
@song4ch1:
	...
	.byte .hibyte(@env13), $4b, .lobyte(@env23), .hibyte(@env23), $4c, $4f, $01, $a0
@song4ref722:
...
@song4ref765:
	...
	.byte .hibyte(@env23), $4c, $4f, $01, $a0, $28, $85, $29, $85, $2b, $85, $4b, .lobyte(@env36), .hibyte(@env36), $4f, $00
	.byte $86, $2b, $77, $81, $75, $81, $73, $81, $78, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $4f, $01, $a0
	.byte $41, $0a
	.word @song4ref765
	.byte $4b, .lobyte(@env12), .hibyte(@env12), $80
	.byte $41, $14
	.word @song4ref314
	.byte $4d
	.byte $41, $14
	.word @song4ref314
	.byte $76, $49, .lobyte(@env13), .hibyte(@env13), $4b, .lobyte(@env36), .hibyte(@env36), $4f, $01, $a0, $30, $85, $4d, $a0
...
@song4ref965:
	...
	.byte $44, $00
@song4ch2:
	.byte $bf, $bf, $bf, $bf, $9e, $16, $bd, $18, $bd, $19, $bd, $1b, $9d, $1c, $9d, $8a
@song4ref1131:
...
@song4ref1521:
	.byte $2e, $85, $82, $2f
@song4ref1525:
	.byte $85, $84, $26, $85, $92, $2e, $85, $94, $2c, $85, $92, $2e, $85, $84, $26, $85, $92, $2e, $85, $94, $2c, $85, $92, $2e
	.byte $41, $10
	.word @song4ref1525
	.byte $85
	.byte $41, $13
