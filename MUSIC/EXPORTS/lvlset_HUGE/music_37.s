...
@instruments:
	...
	.word @env66,@env9,@env3,@env0 ; 04 : cymbal
	...
	.word @env72,@env42,@env49,@env0 ; 0a : blank instant decay
	.word @env56,@env42,@env49,@env58 ; 0b : jaezu lead
	.word @env59,@env10,@env49,@env0 ; 0c : tight triangle snare
	.word @env27,@env42,@env6,@env0 ; 0d : endgame lead
	.word @env4,@env42,@env51,@env0 ; 0e : sample
	.word @env76,@env42,@env54,@env0 ; 0f : death moon lead
	.word @env43,@env42,@env49,@env0 ; 10 : infernoplex_piano
	.word @env35,@env42,@env49,@env0 ; 11 : blank
	.word @env4,@env42,@env49,@env34 ; 12 : triangle drums
	.word @env28,@env42,@env8,@env0 ; 13 : hex guitar 1
	.word @env69,@env32,@env49,@env0 ; 14 : loud octave jumping echo
	.word @env40,@env42,@env49,@env0 ; 15 : loud blank string
	.word @env28,@env42,@env49,@env1 ; 16 : Extreme pitch down
	.word @env28,@env42,@env49,@env0 ; 17 : Duty 0
	.word @env73,@env42,@env49,@env0 ; 18 : blank slower string
	.word @env19,@env42,@env24,@env0 ; 19 : shift string lite
	.word @env2,@env42,@env49,@env0 ; 1a : echo
	.word @env28,@env42,@env49,@env0 ; 1b : DMC: drums + bass
...
@song1ref118:
	...
	.byte $41, $18
	.word @song1ref117
	.byte $49, .lobyte(@env70), .hibyte(@env70), $9a, $2c, $95, $49, .lobyte(@env0), .hibyte(@env0), $4a
	.byte $41, $20
	.word @song1ref116
@song1ref165:
	...
	.byte $41, $14
	.word @song1ref117
	.byte $29, $85, $00, $81, $49, .lobyte(@env70), .hibyte(@env70), $9a, $2c, $95, $49, .lobyte(@env0), .hibyte(@env0), $4a
	.byte $41, $18
	.word @song1ref116
	.byte $22, $85, $00, $81, $20, $85, $00, $81
	.byte $41, $0b
	...
	.byte $41, $14
	.word @song1ref117
	.byte $29, $85, $00, $81, $49, .lobyte(@env70), .hibyte(@env70), $9a, $2c, $95, $7f, $49, .lobyte(@env0), .hibyte(@env0)
...
@song1ref394:
	...
	.byte $78
@song1ref421:
	.byte $49, .lobyte(@env21), .hibyte(@env21), $83, $a2, $50, $f2, $2a, $2c, $81, $20, $00, $8f, $50, $f2, $2a, $2c, $81, $20
...
@song1ch2:
	.byte $ae, $50, $fb, $11, $2e, $dd, $df, $df, $df, $ac, $50, $01, $2e, $2c, $dd, $df, $df, $00, $dd
@song1ref817:
	.byte $00, $89
@song1ref819:
	.byte $8c
...
@song2ch1:
	.byte $ff, $ff, $bf, $4b, .lobyte(@env17), .hibyte(@env17), $a0, $1c, $83, $00, $83, $4d, $1c, $83, $00, $8b, $4b, .lobyte(@env74)
...
@song2ref228:
	...
	.byte .lobyte(@env64), .hibyte(@env64), $1b, $81, $4b, .lobyte(@env68), .hibyte(@env68), $1b, $85, $00, $81, $df, $4b, .lobyte(@env33)
	.byte .hibyte(@env33), $19, $85, $4d, $19, $85, $4b, .lobyte(@env29), .hibyte(@env29), $19, $85, $00, $85
	.byte $41, $0c
	.word @song2ref228
	.byte $41, $14
	.word @song2ref218
	.byte $4b, .lobyte(@env68), .hibyte(@env68), $19, $83, $00, $8b, $ef, $4b, .lobyte(@env29), .hibyte(@env29), $20, $83, $45
	.byte $87, $44, $00
@song2ch2:
	.byte $ff, $ff, $a2
@song2ref329:
	...
	.byte $4a, $a2, $38, $81, $33, $81, $31, $81, $2c, $81, $33, $81, $31, $81, $2c, $81, $27, $81
	.byte $41, $0c
	.word @song2ref329
...
@song3ref66:
	...
	.byte $74, $49, .lobyte(@env78), .hibyte(@env78), $16, $7f, $49, .lobyte(@env0), .hibyte(@env0), $4a, $9e, $12, $81, $00
...
@song3ref444:
	...
	.byte .hibyte(@env63), $1e, $8d, $4b, .lobyte(@env71), .hibyte(@env71), $1f, $8d, $51, $01, $c0
@song3ref469:
...
@song3ref472:
	...
	.byte .hibyte(@env71), $1f, $8d, $4b, .lobyte(@env65), .hibyte(@env65), $1c, $9d, $4b, .lobyte(@env63), .hibyte(@env63), $1e
	...
	.byte $1c, $9d, $4b, .lobyte(@env63), .hibyte(@env63), $1e, $9d, $4b, .lobyte(@env71), .hibyte(@env71), $1f, $9d, $4b, .lobyte(@env33)
...
@song3ref649:
	...
	.byte $8e, $40, $5c, $8a, $40, $50, $00, $40, $5c, $00, $89, $96, $38, $89, $39, $3a, $3b, $85, $3a, $85, $36, $85, $00, $85
	...
	.byte $85, $3b, $85, $3d, $8d, $3f, $85, $40, $4e, $83, $00, $92, $40, $4e, $96, $40, $50, $83, $49, .lobyte(@env18), .hibyte(@env18)
	...
	.byte $8e, $33, $00, $81, $8a, $33, $00, $81, $8e, $33, $00, $81, $8a, $33, $8e, $33, $00, $31, $8a, $33, $00, $31, $a4, $31
...
@song4ref122:
	...
	.byte $41, $0d
	.word @song4ref122
	.byte $49, .lobyte(@env46), .hibyte(@env46), $97, $49, .lobyte(@env0), .hibyte(@env0), $4a, $4f, $02, $96, $09, $85, $49
...
@song4ref194:
	...
	.byte $41, $0d
	.word @song4ref194
	.byte $49, .lobyte(@env46), .hibyte(@env46), $97, $49, .lobyte(@env0), .hibyte(@env0), $4a, $4f, $02, $96, $15, $85, $49
