...
@instruments:
	...
	.word @env9,@env50,@env40,@env0 ; 03 : kick
	.word @env28,@env38,@env3,@env0 ; 04 : snare
	.word @env8,@env7,@env49,@env0 ; 05 : hat
	.word @env36,@env41,@env40,@env0 ; 06 : clap
	.word @env22,@env33,@env40,@env0 ; 07 : blank
	.word @env51,@env56,@env40,@env0 ; 08 : (G2) aggressive noise kick + crash
	.word @env45,@env30,@env40,@env0 ; 09 : (G2) aggressive noise kick
	.word @env58,@env33,@env40,@env0 ; 0a : blank instant decay
	.word @env16,@env33,@env40,@env14 ; 0b : I don't know what to name this
	.word @env55,@env33,@env40,@env0 ; 0c : menu acc
	.word @env16,@env33,@env5,@env0 ; 0d : hex guitar 1
	.word @env16,@env33,@env26,@env0 ; 0e : hex guitar 2
	.word @env1,@env33,@env40,@env0 ; 0f : echo
	.word @env47,@env33,@env40,@env0 ; 10 : triangle pluck 4
	.word @env35,@env33,@env40,@env0 ; 11 : infernoplex_piano
	.word @env59,@env33,@env40,@env0 ; 12 : blank slower string
	.word @env29,@env33,@env40,@env0 ; 13 : triangle pluck 3
	.word @env36,@env33,@env40,@env0 ; 14 : clap no app
	.word @env4,@env33,@env40,@env21 ; 15 : triangle drums
	.word @env23,@env33,@env39,@env17 ; 16 : Kap lead
	.word @env54,@env33,@env43,@env0 ; 17 : shift string
	.word @env32,@env33,@env40,@env0 ; 18 : blank string
	.word @env31,@env33,@env40,@env0 ; 19 : loud blank string
	.word @env48,@env33,@env40,@env20 ; 1a : death moon lead 2
	.word @env16,@env33,@env40,@env13 ; 1b : blank vib
	.word @env4,@env33,@env42,@env0 ; 1c : sample
...
@song0ref38:
	.byte $49, .lobyte(@env11), .hibyte(@env11), $4b, .lobyte(@env53), .hibyte(@env53), $4f, $00, $24, $4d, $84, $24, $4f, $01
	...
	.byte $a2, $1f, $a2, $22, $1f, $24, $27, $45, $49, .lobyte(@env34), .hibyte(@env34), $26, $81, $49, .lobyte(@env11), .hibyte(@env11)
...
@song0ref127:
	...
	.word @song0ref38
@song0ref146:
	.byte $49, .lobyte(@env34), .hibyte(@env34), $29, $81, $49, .lobyte(@env11), .hibyte(@env11), $22, $45, $a2, $1f, $26, $22
...
@song0ref351:
	...
	.byte .hibyte(@env53), $4f, $00, $9a, $18, $4d, $4f, $02, $9a, $18, $00, $4d, $18, $4f, $01, $00, $4b, .lobyte(@env12), .hibyte(@env12)
	...
	.word @song0ref351
@song0ref482:
	.byte $11, $16, $13, $00, $50, $f2, $22, $24, $84, $18, $49, .lobyte(@env57), .hibyte(@env57), $89, $00, $81, $78, $49, .lobyte(@env11)
	.byte .hibyte(@env11), $4b, .lobyte(@env53), .hibyte(@env53), $4f, $02, $18, $4d, $84, $18, $4f, $03, $00, $4d, $18, $00
	...
	.byte $13, $16, $49, .lobyte(@env34), .hibyte(@env34), $18, $81, $49, .lobyte(@env11), .hibyte(@env11), $9c, $13, $9c, $16
...
@song2ref63:
	...
	.byte $4f, $02
@song2ref92:
	.byte $a4, $23, $81, $50, $ee, $2f, $3b, $81, $2f, $81, $49, .lobyte(@env24), .hibyte(@env24), $8b, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $a4, $2c, $85, $2a, $81, $28, $81, $2a, $49, .lobyte(@env60), .hibyte(@env60), $85, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $a4, $2c, $81, $2a, $49, .lobyte(@env60), .hibyte(@env60), $89, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a4
	.byte $28, $81, $27
@song2ref142:
	.byte $81, $25, $81, $23, $81, $25, $81, $27, $81, $49, .lobyte(@env10), .hibyte(@env10), $28, $81, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $a4, $27, $81, $25, $81, $23, $81, $25, $81, $23, $81, $25, $81, $2c, $81, $2a, $49, .lobyte(@env60), .hibyte(@env60)
	...
	.byte $4a, $a4, $2f, $81, $2c, $49, .lobyte(@env37), .hibyte(@env37), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a4
	.byte $2a, $81, $28
	.byte $41, $09
	.word @song2ref142
	.byte $28, $81, $23, $81, $2c, $49, .lobyte(@env6), .hibyte(@env6), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a4, $2a
	.byte $83, $49, .lobyte(@env46), .hibyte(@env46), $89, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a4, $27, $81, $49, .lobyte(@env46)
	.byte .hibyte(@env46), $83, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a4, $23, $81, $49, .lobyte(@env46), .hibyte(@env46)
	.byte $83, $51, $fd, $70, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a4, $28, $81, $49, .lobyte(@env46), .hibyte(@env46)
...
@song2ref543:
	...
	.byte $41, $12
	.word @song2ref543
	.byte $73, $51, $03, $80, $4e, $01, $4f, $02, $a4, $28, $81, $49, .lobyte(@env46), .hibyte(@env46), $83, $4e, $02, $a4, $50
...
@song2ref705:
	...
	.byte $41, $09
	.word @song2ref705
	.byte $1e, $81, $20, $81, $1b, $81, $7f, $4f, $00, $98, $28, $85, $72, $4e, $ff, $4f, $02, $9e
	.byte $41, $36
	.word @song2ref399
	.byte $28, $81, $4e, $ff
	.byte $41, $34
...
@song2ref928:
	...
	.byte $9d, $44, $00
@song2ch3:
	.byte $9f, $9f, $9f, $9f, $9f, $9f, $9f, $70, $51, $03, $f0, $b8, $1f, $9b, $81, $7b, $82
@song2ref987:
	.byte $1e
@song2ref988:
	...
	.byte $81, $00
@song2ref1075:
	.byte $81, $78, $90, $14, $81, $7a, $82, $21, $81, $7f, $88, $22, $81, $7a, $82, $21, $81, $78, $90, $14, $81, $7a, $82, $21
...
@song3ref1063:
	.byte $8c, $1b, $85, $80, $20, $85, $86, $15, $85, $80, $20, $85, $8c, $1b, $85, $80, $20, $85, $86, $15, $85, $80, $20, $85
	.byte $8c, $1b, $85, $80, $20, $85, $86, $15, $85, $80, $20, $85
	.byte $41, $18
	.word @song3ref1063
	.byte $41, $18
	.word @song3ref1063
...
@song3ref1156:
	.byte $15, $85, $80, $20, $85, $8c, $1b, $85, $80, $20, $85, $86, $15, $85, $00, $85, $15, $85, $00, $85, $15, $85, $80, $20
	.byte $85, $8c, $1a, $85, $80, $20, $85, $86, $15, $85, $00, $85, $15, $85, $00, $85
	.byte $41, $1a
	.word @song3ref1156
	.byte $80, $20, $85, $82, $1d, $85, $74, $8e, $1d, $77, $81, $7a, $81, $7d
	.byte $41, $1f
	.word @song3ref1050
	.byte $41, $18
	.word @song3ref1063
	...
	.byte $41, $1a
	.word @song3ref1156
	.byte $80, $20, $85, $82, $1d, $85, $74, $8e, $1d, $77, $81, $7a, $81, $7d, $81
@song3ref1246:
	.byte $86, $15, $85, $80, $20, $85, $8c, $1b, $85, $80, $20, $85, $86, $15, $85, $80, $20, $85, $86, $15, $85, $80, $20, $85
	.byte $86, $15, $85, $80, $20, $85, $8c, $1a, $85, $80, $20, $85, $86, $15, $85, $80, $20, $85, $86, $15, $85, $80, $20, $85
	.byte $41, $1c
	.word @song3ref1246
	.byte $82, $1d, $8d, $97, $00, $e5, $44, $00
@song3ch4:
	.byte $ff, $ff
@song3ref1308:
	.byte $25, $85, $00, $81, $25, $85, $00, $81, $25, $85, $25, $85, $00, $81, $25, $85, $00, $81, $25, $85, $25, $85, $00, $81
	.byte $25, $85, $00, $81, $25, $85, $25, $85, $00, $81, $25, $85, $00, $89
	.byte $41, $26
	.word @song3ref1308
@song3ref1349:
	.byte $25, $8d, $3a, $8d, $25, $8d, $3a, $8d, $25, $8d, $3a, $8d, $25, $8d, $3a, $8d, $25, $8d, $3a, $8d
	.byte $41, $14
	.word @song3ref1349
	.byte $41, $13
	.word @song3ref1349
@song3ref1375:
	.byte $00, $87, $25, $00, $3a, $00, $83, $3a, $00, $93
@song3ref1385:
...
@song4ref348:
	...
	.byte $41, $14
	.word @song4ref348
	.byte $7d, $49, .lobyte(@env19), .hibyte(@env19), $4f, $00, $b2
@song4ref378:
...
@song4ref512:
	...
	.byte $41, $14
	.word @song4ref347
	.byte $49, .lobyte(@env25), .hibyte(@env25), $4f, $01, $b4
@song4ref574:
	.byte $2b, $bd, $b4, $29, $bd, $28, $9d, $2b, $9d, $29, $95, $24, $81, $27, $81, $26, $43, $27, $43, $26, $99, $49, .lobyte(@env25)
...
@song4ref901:
	.byte $00, $83, $72, $8e, $1e, $00, $1d, $00, $1d, $00, $71, $94, $1d, $00, $1d, $00, $83, $72, $8e, $1d, $00, $1b, $00, $1e
	.byte $00, $1d, $00, $1c, $00, $1b, $00, $71, $1d, $00, $1e, $00, $94, $1d, $00, $72, $93, $8e, $20, $00, $1f, $00, $1e, $00
...
@song4ref1073:
	.byte $7b, $86, $1d, $00, $7d, $8a, $21
@song4ref1080:
	.byte $00, $7b, $86, $1e, $00, $7d, $8a, $21, $00, $7b, $86, $1d, $00, $7d, $8a, $21, $00, $7b, $86, $1e, $79, $8a, $1c, $7d
	.byte $21, $00
	.byte $41, $0d
	.word @song4ref1073
	.byte $00, $7d, $8a, $21, $00
