...
@instruments:
	.word @env14,@env10,@env56,@env0 ; 00 : hat
	.word @env38,@env43,@env42,@env0 ; 01 : clap
	.word @env29,@env40,@env3,@env0 ; 02 : snare
	.word @env54,@env34,@env42,@env0 ; 03 : triangle pluck 4
	.word @env38,@env34,@env42,@env0 ; 04 : clap no app
	.word @env59,@env10,@env3,@env0 ; 05 : cymbal
	.word @env15,@env57,@env42,@env0 ; 06 : kick
	.word @env69,@env34,@env42,@env0 ; 07 : blank instant decay
	.word @env58,@env68,@env42,@env0 ; 08 : (G2) aggressive noise kick + crash
	.word @env49,@env31,@env42,@env0 ; 09 : (G2) aggressive noise kick
	.word @env24,@env34,@env42,@env0 ; 0a : blank
	.word @env60,@env34,@env42,@env0 ; 0b : piano
	.word @env28,@env10,@env42,@env0 ; 0c : rel hats
	.word @env37,@env34,@env65,@env0 ; 0d : subtle oddities arp lead
	.word @env67,@env34,@env42,@env0 ; 0e : menu acc
	.word @env1,@env34,@env42,@env0 ; 0f : echo
	.word @env30,@env34,@env42,@env0 ; 10 : triangle pluck 3
	.word @env70,@env34,@env42,@env0 ; 11 : blank slower string
	.word @env71,@env34,@env48,@env0 ; 12 : death moon lead
	.word @env36,@env34,@env42,@env0 ; 13 : infernoplex_piano
	.word @env51,@env34,@env42,@env53 ; 14 : jaezu lead
	.word @env11,@env34,@env17,@env0 ; 15 : endorphin lead
	.word @env62,@env34,@env46,@env0 ; 16 : shift string
	.word @env63,@env34,@env48,@env0 ; 17 : Instrument 4
	.word @env33,@env34,@env42,@env0 ; 18 : blank string
	.word @env32,@env34,@env42,@env0 ; 19 : loud blank string
	.word @env55,@env34,@env42,@env23 ; 1a : death moon lead 2
	.word @env20,@env34,@env42,@env19 ; 1b : blank vib
	.word @env25,@env34,@env41,@env21 ; 1c : Kap lead
	.word @env6,@env34,@env35,@env72 ; 1d : every end pluck lead
	.word @env5,@env34,@env45,@env0 ; 1e : sample
...
@song2ref63:
	...
	.byte $4f, $02
@song2ref92:
	.byte $a2, $23, $81, $50, $ee, $2f, $3b, $81, $2f, $81, $49, .lobyte(@env26), .hibyte(@env26), $8b, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $a2, $2c, $85, $2a, $81, $28, $81, $2a, $49, .lobyte(@env73), .hibyte(@env73), $85, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $a2, $2c, $81, $2a, $49, .lobyte(@env73), .hibyte(@env73), $89, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a2
	.byte $28, $81, $27
@song2ref142:
	.byte $81, $25, $81, $23, $81, $25, $81, $27, $81, $49, .lobyte(@env16), .hibyte(@env16), $28, $81, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $a2, $27, $81, $25, $81, $23, $81, $25, $81, $23, $81, $25, $81, $2c, $81, $2a, $49, .lobyte(@env73), .hibyte(@env73)
	...
	.byte $4a, $a2, $2f, $81, $2c, $49, .lobyte(@env39), .hibyte(@env39), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a2
	.byte $2a, $81, $28
	.byte $41, $09
	.word @song2ref142
	.byte $28, $81, $23, $81, $2c, $49, .lobyte(@env9), .hibyte(@env9), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a2, $2a
	.byte $83, $49, .lobyte(@env50), .hibyte(@env50), $89, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a2, $27, $81, $49, .lobyte(@env50)
	.byte .hibyte(@env50), $83, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a2, $23, $81, $49, .lobyte(@env50), .hibyte(@env50)
	.byte $83, $51, $fd, $70, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a2, $28, $81, $49, .lobyte(@env50), .hibyte(@env50)
	.byte $83, $a2, $50, $10, $34, $2c, $81, $7f, $49, .lobyte(@env0), .hibyte(@env0), $4a, $9e
	.byte $41, $34
	.word @song2ref8
	.byte $41, $26
	.word @song2ref4
...
@song2ref543:
	...
	.byte $41, $12
	.word @song2ref543
	.byte $73, $51, $03, $80, $4e, $01, $4f, $02, $a2, $28, $81, $49, .lobyte(@env50), .hibyte(@env50), $83, $4e, $02, $a2, $50
...
@song2ref928:
	...
	.byte $9d, $44, $00
@song2ch3:
	.byte $9f, $9f, $9f, $9f, $9f, $9f, $9f, $70, $51, $03, $f0, $bc, $1f, $9b, $81, $7b, $8a
@song2ref987:
	.byte $1e
@song2ref988:
	.byte $81, $7a, $98, $20, $81, $7f, $84, $22, $81, $79, $51, $fc, $40, $90, $14, $83, $7a, $00, $92, $14, $81, $7f, $84, $22
	.byte $85, $7b, $92, $14
	.byte $41, $0b
	.word @song2ref988
	...
	.byte $81, $00
@song2ref1075:
	.byte $81, $78, $90, $14, $81, $7a, $8a, $21, $81, $7f, $84, $22, $81, $7a, $8a, $21, $81, $78, $90, $14, $81, $7a, $8a, $21
	.byte $81, $7f, $84, $22, $81, $7a, $8a, $21
	.byte $41, $10
	.word @song2ref1075
	.byte $41, $10
	.word @song2ref1075
	...
	.word @song2ref988
@song2ref1190:
	.byte $81, $00, $81, $7a, $8a, $21, $85, $7f, $84, $22, $81, $7a, $8a, $21, $89, $7f, $84, $22
	.byte $41, $0a
	.word @song2ref1190
	.byte $41, $0a
	.word @song2ref1190
...
@song3ref348:
	...
	.byte $41, $14
	.word @song3ref348
	.byte $7d, $49, .lobyte(@env22), .hibyte(@env22), $4f, $00, $b2
@song3ref378:
...
@song4ref3:
	.byte $7a
@song4ref4:
	.byte $4f, $01, $00, $85, $4b, .lobyte(@env61), .hibyte(@env61), $8e
@song4ref12:
	...
	.byte $96, $1c, $85, $00, $85, $4b, .lobyte(@env61), .hibyte(@env61), $8e, $1c, $85, $00, $85, $4d, $1c, $85, $00, $85, $4d
	...
	.byte $4b, .lobyte(@env64), .hibyte(@env64), $96, $1c, $85, $00, $85, $4b, .lobyte(@env66), .hibyte(@env66), $8e, $1c, $85
	...
	.word @song4ref12
@song4ref143:
	.byte $4b, .lobyte(@env4), .hibyte(@env4), $4f, $01, $96, $28, $8d, $4d, $28, $8d, $4d, $9a, $23, $85, $4d, $23, $8d, $4b
	.byte .lobyte(@env12), .hibyte(@env12), $23, $a5, $4b, .lobyte(@env4), .hibyte(@env4), $96, $28, $8d, $4d, $28, $8d, $4d
	.byte $9a, $23, $85, $4d, $23, $8d, $4b, .lobyte(@env12), .hibyte(@env12), $23, $8d, $4b, .lobyte(@env7), .hibyte(@env7)
	.byte $25, $85, $4b, .lobyte(@env12), .hibyte(@env12), $23, $8d, $4b, .lobyte(@env4), .hibyte(@env4), $96, $28, $8d, $4d
	.byte $28, $8d, $4d, $9a, $23, $87, $47, $01, $4d, $23, $87, $47, $03, $4d, $23, $89, $4b, .lobyte(@env52), .hibyte(@env52)
	.byte $27, $87, $47, $01, $4d, $27, $87, $47, $03, $4d, $27, $89
	.byte $41, $50
	.word @song4ref4
	.byte $41, $28
	.word @song4ref143
	.byte $7e, $4b, .lobyte(@env34), .hibyte(@env34), $4c, $a4, $20, $8d, $20, $85, $1e, $85, $1c, $85, $1e, $8d, $20, $8d, $1e
	...
	.byte $96, $23, $9d, $4b, .lobyte(@env52), .hibyte(@env52), $25, $9d, $4b, .lobyte(@env4), .hibyte(@env4), $21, $9d, $4b
...
@song4ref377:
	...
	.byte $2a, $8d, $4b, .lobyte(@env34), .hibyte(@env34), $4c, $23, $85, $4b, .lobyte(@env4), .hibyte(@env4), $2a, $85, $4b
	.byte .lobyte(@env34), .hibyte(@env34), $4c, $23, $85, $4b, .lobyte(@env12), .hibyte(@env12), $28, $85, $4b, .lobyte(@env34)
	...
	.byte $4d, $2a, $8d, $4b, .lobyte(@env4), .hibyte(@env4), $2a, $8d, $4b, .lobyte(@env34), .hibyte(@env34), $4c, $23, $85
	.byte $4b, .lobyte(@env4), .hibyte(@env4), $2a, $8d, $4b, .lobyte(@env34), .hibyte(@env34), $4c, $24, $85, $4b, .lobyte(@env12)
...
@song4ref499:
	...
	.byte $41, $5a
	.word @song4ref499
	.byte $a5, $aa, $2a, $85, $2c, $85, $25, $85, $27, $85, $28, $8d, $49, .lobyte(@env47), .hibyte(@env47), $b7, $df, $cf
@song4ref627:
	.byte $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa, $28, $85, $2a, $85, $2c, $8d, $49, .lobyte(@env44), .hibyte(@env44)
	.byte $87, $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa, $2a, $85, $28, $8d, $49, .lobyte(@env44), .hibyte(@env44), $87
	.byte $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa, $23, $85, $28, $85, $28, $8d, $26, $8d, $49, .lobyte(@env2), .hibyte(@env2)
	.byte $8f, $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa, $23, $85, $26, $85, $27, $8d, $28, $85, $8f, $49, .lobyte(@env44)
	.byte .hibyte(@env44), $87, $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa, $23, $85, $28, $85, $28, $8d, $26, $85, $8f, $49
	.byte .lobyte(@env44), .hibyte(@env44), $87, $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa, $23, $85, $26, $85, $25, $8d
...
@song4ref756:
	...
	.byte $1c, $8d, $00, $9d, $df, $df, $df, $df, $49, .lobyte(@env13), .hibyte(@env13), $94, $1c, $dd, $cf, $00, $8d, $bf, $df
...
@song4ref991:
	...
	.byte $41, $16
	.word @song4ref991
	.byte $7f, $80, $20, $85, $20, $85, $84, $22, $85, $8c, $20
@song4ref1044:
	.byte $85, $80, $20, $85, $20, $85, $84, $22, $85, $8c, $20, $85, $80, $20, $85, $20, $85, $84, $22, $85, $8c, $20, $85, $80
	.byte $20, $85, $20, $85, $84, $22, $85, $8c, $20, $85, $20, $85, $84, $22, $85, $8c, $20, $85, $84, $22
	.byte $41, $19
	.word @song4ref1044
	.byte $80, $20, $85, $20, $85, $84, $22, $85, $8c, $20, $85, $20, $85, $84, $22, $85, $8c, $20, $85, $84, $22
	.byte $41, $19
	.word @song4ref1044
	.byte $80, $20, $85, $20, $85, $84, $22, $85, $8c, $20, $85, $20, $85, $84, $22, $85, $22, $85, $22, $85, $8c
@song4ref1136:
	.byte $20, $85, $80, $1f, $85, $8c, $20, $85, $80, $1f, $85, $84, $22, $85, $80, $1f, $85, $00, $85, $1f, $85, $00, $85, $1f
...
@song4ref1313:
	...
	.byte $26, $15, $8b, $26, $15, $83, $26, $24, $83, $26, $10, $83, $26, $24, $83, $26, $15, $83, $26, $14, $8b, $26, $14, $83
	.byte $26, $1c, $8b, $26, $15, $8b, $26, $15, $83, $26, $1c, $83, $26, $15, $83, $26, $24, $8b, $26, $1c, $8b, $26, $1c, $83
	.byte $26, $15, $8b
@song4ref1456:
	.byte $26, $10, $93, $26, $10, $83, $26, $1b, $93, $26, $15, $83, $26, $1d, $93, $26, $1d, $83, $26, $1a, $8b, $26, $1a, $8b
	.byte $26, $1a, $83, $26, $1c, $83, $26, $1d, $83, $26, $24, $83
	.byte $41, $24
	.word @song4ref1456
	.byte $41, $24
	.word @song4ref1456
@song4ref1498:
	.byte $26, $1b, $83, $26, $15, $83, $26, $10, $83, $26, $1d, $8b, $26, $1d, $8b, $26, $1c, $8b, $26, $1c, $83, $26, $24, $83
