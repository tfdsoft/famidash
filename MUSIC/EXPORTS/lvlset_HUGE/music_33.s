...
@instruments:
	...
	.word @env22,@env26,@env25,@env0 ; 02 : clap
	.word @env32,@env5,@env2,@env0 ; 03 : cymbal
	.word @env18,@env24,@env2,@env0 ; 04 : snare
	.word @env9,@env5,@env30,@env0 ; 05 : hat
	.word @env16,@env20,@env25,@env0 ; 06 : blank
	.word @env1,@env20,@env25,@env0 ; 07 : echo
	.word @env21,@env38,@env25,@env0 ; 08 : pluck1
	.word @env23,@env20,@env3,@env0 ; 09 : endorphin lead 2
	.word @env37,@env20,@env25,@env0 ; 0a : blank instant decay
	.word @env4,@env20,@env25,@env15 ; 0b : triangle drums
	.word @env13,@env20,@env25,@env0 ; 0c : DMC: drums + bass
	.word @env13,@env20,@env25,@env14 ; 0d : tom
	.word @env6,@env20,@env11,@env0 ; 0e : endorphin lead
	.word @env34,@env20,@env27,@env0 ; 0f : shift string
	.word @env19,@env20,@env25,@env0 ; 10 : triangle pluck 3
	.word @env28,@env20,@env25,@env0 ; 11 : triangle pluck 4
	.word @env36,@env20,@env25,@env0 ; 12 : menu acc
...
@song2ref917:
	.byte $2a, $85, $90, $1e, $1e, $00, $1e, $1e, $00, $1e, $00, $1e, $8c, $2a, $81, $94, $2a, $8c, $2a, $85, $90, $1e, $1e, $00
	.byte $1e, $1e, $00, $1e, $00, $8c, $2a, $85, $2a, $85, $90, $1e, $1e, $00, $1e, $1e, $00, $1e, $00, $1c, $00, $83, $8c, $1a
	.byte $8d, $19, $8d
	.byte $41, $1a
	.word @song2ref917
	.byte $17, $9d
@song2ref973:
	.byte $1a, $8d, $19, $8d, $2a, $85, $90, $2a, $2a, $00, $2a, $2a, $00, $2a, $00, $2a, $8c, $2a, $81, $94, $2a, $8c, $2a, $85
	.byte $90, $2a, $2a, $00, $2a, $2a, $00, $2a, $00, $8c, $2a, $85, $2a, $85, $90, $2a, $2a, $00, $2a, $2a, $00, $2a, $00, $28
	.byte $00, $83, $8c
	.byte $41, $1e
	.word @song2ref973
...
@song4ch0:
	.byte $46, $03, $97, $77, $4b, .lobyte(@env29), .hibyte(@env29), $4f, $01, $8c, $08, $8d, $00, $ad, $8f, $71, $51, $01, $40
