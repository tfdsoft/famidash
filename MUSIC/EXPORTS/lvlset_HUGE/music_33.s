...
@instruments:
	.word @env34,@env19,@env23,@env0 ; 00 : blank instant decay
	.word @env1,@env19,@env23,@env0 ; 01 : echo
	...
	.word @env16,@env8,@env23,@env0 ; 06 : rel hats
	.word @env12,@env19,@env4,@env0 ; 07 : endgame lead
	.word @env20,@env19,@env4,@env0 ; 08 : infernogame_lead_piano
	.word @env32,@env8,@env2,@env0 ; 09 : cymbal
	.word @env15,@env19,@env23,@env0 ; 0a : blank
	.word @env13,@env19,@env23,@env0 ; 0b : DMC: drums + bass
	.word @env6,@env19,@env25,@env0 ; 0c : loud sample
	.word @env35,@env19,@env26,@env0 ; 0d : death moon lead
	.word @env28,@env19,@env23,@env0 ; 0e : loud_infernoplex_piano
	.word @env13,@env33,@env5,@env0 ; 0f : nc wub1
	.word @env10,@env19,@env23,@env0 ; 10 : clutterfunk sax
	.word @env20,@env19,@env23,@env0 ; 11 : infernoplex_piano
	.word @env18,@env19,@env23,@env0 ; 12 : blank string
	.word @env3,@env19,@env25,@env0 ; 13 : sample
	.word @env16,@env19,@env23,@env0 ; 14 : Instrument 2
	.word @env27,@env19,@env23,@env0 ; 15 : quiet bass
...
@song2ref9:
	...
	.byte $41, $11
	.word @song2ref9
	.byte $87, $4b, .lobyte(@env31), .hibyte(@env31), $4f, $00, $94
@song2ref47:
...
@song2ch4:
	...
	.word @song2ref484
@song2ref1400:
	.byte $15, $81, $1c, $00, $1c, $00, $1c, $00, $83, $15, $00, $1a, $00, $17, $00, $17
	.byte $41, $0a
	.word @song2ref821
@song2ref1419:
	.byte $1b, $87, $17, $85, $1a, $85, $00, $85, $1c, $81, $00, $85, $1c, $81, $00, $81, $1c, $00, $1c, $85, $15, $85, $1c, $8d
	.byte $1c, $83, $00, $15, $00, $1c, $00, $1c, $00, $15, $00, $1c, $85, $17, $85, $19, $85, $15, $8d
	.byte $41, $10
	.word @song2ref1400
	.byte $41, $0a
	.word @song2ref821
...
@song4ref759:
	...
	.word @song4ref740
@song4ref796:
	.byte $1e, $16, $1e, $16, $1e, $16, $1e, $1e, $1e, $16, $1e, $16, $1e, $16, $1e, $1e
	.byte $41, $10
	.word @song4ref796
@song4ref815:
	...
	.byte $00, $bd
@song4ref836:
	.byte $1e, $81, $16, $81, $16, $81, $16, $81, $33, $81, $16, $81, $16, $81, $16, $81
	.byte $41, $10
	.word @song4ref836
	.byte $41, $10
	.word @song4ref836
@song4ref858:
	.byte $1e, $81, $16, $81, $33, $81, $16, $81, $33, $81, $16
@song4ref869:
	.byte $81, $33, $81, $33
@song4ref873:
	.byte $81, $1e, $81, $19, $81, $19, $81, $19, $81, $33, $81, $19, $81, $19, $81, $19
	.byte $41, $10
	.word @song4ref873
	.byte $41, $10
	.word @song4ref873
@song4ref895:
	.byte $81, $1e, $81, $19, $81, $33, $81, $19, $81, $33, $81, $19, $81, $33, $81, $33
@song4ref911:
	.byte $81, $1e, $81, $13, $81, $13, $81, $13, $81, $33, $81, $13, $81, $13, $81, $13
	.byte $41, $10
	.word @song4ref911
	.byte $41, $10
	.word @song4ref911
	.byte $81, $1e, $81, $13, $81, $33, $81, $13, $81, $33, $81, $13
	.byte $41, $14
	.word @song4ref869
	.byte $41, $10
	.word @song4ref873
@song4ref951:
	.byte $81, $1e, $81, $14, $81, $14, $81, $14, $81, $33, $81, $14, $81, $14, $81, $14, $81, $1e, $81, $14, $81, $33, $81, $14
	.byte $81, $33, $81, $14, $81, $33, $81, $33, $81
	.byte $41, $10
	.word @song4ref836
	.byte $41, $10
	.word @song4ref836
