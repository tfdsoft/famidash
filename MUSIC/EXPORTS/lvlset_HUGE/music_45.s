...
@instruments:
	...
	.word @env43,@env23,@env27,@env0 ; 03 : blank instant decay
	.word @env2,@env23,@env27,@env0 ; 04 : echo
	.word @env12,@env38,@env27,@env0 ; 05 : kick
	.word @env4,@env23,@env28,@env0 ; 06 : sample
	.word @env39,@env8,@env3,@env0 ; 07 : cymbal
	.word @env18,@env23,@env27,@env0 ; 08 : blank
	.word @env24,@env23,@env27,@env0 ; 09 : infernoplex_piano
	.word @env18,@env23,@env5,@env0 ; 0a : electroman lead
	.word @env17,@env23,@env27,@env14 ; 0b : I don't know what to name this
	.word @env22,@env23,@env27,@env0 ; 0c : blank string
	.word @env25,@env23,@env27,@env0 ; 0d : clap no app
	.word @env16,@env23,@env6,@env0 ; 0e : endgame lead
	.word @env34,@env23,@env27,@env35 ; 0f : jaezu lead
	.word @env41,@env23,@env27,@env0 ; 10 : menu acc
	.word @env31,@env23,@env27,@env0 ; 11 : Instrument 1
	.word @env40,@env23,@env29,@env0 ; 12 : shift string
	.word @env44,@env23,@env27,@env0 ; 13 : blank slower string
	.word @env17,@env23,@env27,@env0 ; 14 : DMC: drums + bass
	.word @env19,@env23,@env27,@env0 ; 15 : Instrument 2
	.word @env17,@env23,@env27,@env1 ; 16 : Extreme pitch down
	.word @env33,@env42,@env27,@env0 ; 17 : octave arp [ no duty ]
	.word @env33,@env42,@env28,@env0 ; 18 : octave arp
	.word @env45,@env23,@env32,@env0 ; 19 : death moon lead
	.word @env15,@env23,@env27,@env0 ; 1a : 02 but tri
	.word @env21,@env23,@env27,@env0 ; 1b : triangle pluck 3
...
@song6ref94:
	...
	.byte $4d, $0d, $83, $00, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $94, $14, $79, $19, $00, $1c, $00, $14, $18, $14, $4b
...
@song6ch1:
@song6ref174:
	.byte $4b, .lobyte(@env36), .hibyte(@env36), $86, $20, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $88, $20, $00
	.byte $7f, $4b, .lobyte(@env36), .hibyte(@env36), $86, $20, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $88, $20
	.byte $00, $7f, $4b, .lobyte(@env36), .hibyte(@env36), $86, $25, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $88
	.byte $25, $00, $7f, $4b, .lobyte(@env36), .hibyte(@env36), $86, $24, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23), $4c
	.byte $88, $24, $00, $7f, $4b, .lobyte(@env36), .hibyte(@env36), $86, $20, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23)
	.byte $4c, $88, $20, $00, $7f, $4b, .lobyte(@env36), .hibyte(@env36), $86, $20, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23)
	.byte $4c, $88, $20, $00, $7f, $4b, .lobyte(@env36), .hibyte(@env36), $86, $24, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23)
	.byte $4c, $88, $24, $00, $7f, $4b, .lobyte(@env36), .hibyte(@env36), $86, $21, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23)
	.byte $4c, $88, $21, $00, $7f
	.byte $41, $10
	.word @song6ref174
@song6ref297:
	.byte $7f, $4b, .lobyte(@env36), .hibyte(@env36), $86, $27, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $88, $27
	.byte $00, $7f, $4b, .lobyte(@env36), .hibyte(@env36), $86, $25, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $88
	.byte $25, $00, $7f, $4b, .lobyte(@env36), .hibyte(@env36), $86, $24, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23), $4c
	.byte $88, $24, $00, $7f, $4b, .lobyte(@env36), .hibyte(@env36), $86, $21, $81, $7c, $4b, .lobyte(@env23), .hibyte(@env23)
	.byte $4c, $88, $21, $00, $7f
	.byte $41, $20
	.word @song6ref174
	.byte $7f
