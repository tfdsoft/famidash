...
@instruments:
	.word @env51,@env29,@env35,@env0 ; 00 : blank instant decay
	...
	.word @env4,@env29,@env37,@env0 ; 08 : sample
	.word @env20,@env29,@env6,@env0 ; 09 : endgame lead
	.word @env31,@env36,@env35,@env0 ; 0a : clap
	.word @env42,@env10,@env35,@env0 ; 0b : tight triangle snare
	.word @env40,@env29,@env35,@env41 ; 0c : jaezu lead
	.word @env24,@env29,@env35,@env0 ; 0d : blank
	.word @env47,@env29,@env35,@env0 ; 0e : piano
	.word @env21,@env29,@env35,@env0 ; 0f : DMC: drums + bass
	.word @env54,@env29,@env39,@env0 ; 10 : death moon lead
	...
	.word @env48,@env29,@env49,@env0 ; 14 : piano duty
	.word @env30,@env29,@env35,@env0 ; 15 : infernoplex_piano
	.word @env52,@env29,@env35,@env0 ; 16 : blank slower string
	.word @env21,@env29,@env35,@env0 ; 17 : Duty 0
	.word @env28,@env29,@env35,@env0 ; 18 : blank string
	.word @env15,@env43,@env35,@env0 ; 19 : octave arp [ full volume]
	.word @env25,@env29,@env35,@env0 ; 1a : Instrument 2
...
@song2ch0:
	.byte $46, $02
@song2ref3:
	.byte $4b, .lobyte(@env43), .hibyte(@env43), $a0
@song2ref7:
...
@song3ch2:
@song3ref597:
	.byte $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $8c, $01, $85, $01, $85, $01, $85
	.byte $01, $85, $9a
@song3ref624:
...
@song4ref7:
	...
	.byte $41, $14
	.word @song4ref7
	.byte $4f, $03, $85, $4b, .lobyte(@env43), .hibyte(@env43), $aa
@song4ref46:
...
@song4ref875:
	.byte $4b, .lobyte(@env55), .hibyte(@env55), $12, $9d, $4d, $0e, $9d, $4b, .lobyte(@env34), .hibyte(@env34), $0b, $9d, $4b
	.byte .lobyte(@env17), .hibyte(@env17), $07, $8d, $4b, .lobyte(@env38), .hibyte(@env38), $09, $8d, $4b, .lobyte(@env55), .hibyte(@env55)
	.byte $12, $9d, $4b, .lobyte(@env34), .hibyte(@env34), $0e, $9d, $4b, .lobyte(@env13), .hibyte(@env13), $0b, $9d, $4b, .lobyte(@env55)
	.byte .hibyte(@env55), $0e, $8d, $4b, .lobyte(@env43), .hibyte(@env43), $09, $8d
	.byte $41, $14
	.word @song4ref875
	.byte $44, $00
@song4ch2:
