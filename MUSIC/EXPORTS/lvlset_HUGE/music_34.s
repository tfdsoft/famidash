...
@instruments:
	.word @env54,@env31,@env38,@env0 ; 00 : blank instant decay
	.word @env2,@env31,@env38,@env0 ; 01 : echo
	.word @env51,@env31,@env38,@env0 ; 02 : blank quiet
	.word @env28,@env36,@env3,@env0 ; 03 : snare
	.word @env12,@env10,@env47,@env0 ; 04 : hat
	.word @env27,@env10,@env38,@env0 ; 05 : rel hats
	.word @env15,@env48,@env38,@env0 ; 06 : kick
	.word @env20,@env31,@env38,@env0 ; 07 : blank instant more decay
	.word @env7,@env53,@env38,@env0 ; 08 : (G2) aggressive noise snare
	.word @env45,@env5,@env38,@env0 ; 09 : tight triangle kick
	.word @env49,@env10,@env3,@env0 ; 0a : cymbal
	.word @env4,@env31,@env40,@env0 ; 0b : sample
	.word @env45,@env11,@env38,@env0 ; 0c : tight triangle snare
	.word @env21,@env31,@env6,@env0 ; 0d : endgame lead
	.word @env33,@env39,@env38,@env0 ; 0e : clap
	.word @env43,@env31,@env38,@env44 ; 0f : jaezu lead
	.word @env22,@env31,@env38,@env0 ; 10 : DMC: drums + bass
	.word @env22,@env31,@env38,@env1 ; 11 : Extreme pitch down
	.word @env57,@env31,@env42,@env0 ; 12 : death moon lead
	.word @env32,@env31,@env38,@env0 ; 13 : infernoplex_piano
	.word @env34,@env31,@env50,@env0 ; 14 : endorphin lead 2 but looped duty
	.word @env29,@env31,@env38,@env0 ; 15 : loud blank string
	.word @env22,@env31,@env8,@env0 ; 16 : hex guitar 1
	.word @env26,@env31,@env38,@env0 ; 17 : blank
	.word @env22,@env31,@env38,@env0 ; 18 : Duty 0
	.word @env55,@env31,@env38,@env0 ; 19 : blank slower string
	.word @env30,@env31,@env38,@env0 ; 1a : blank string
	.word @env21,@env31,@env25,@env0 ; 1b : polargeist bass
	.word @env27,@env31,@env38,@env0 ; 1c : Instrument 2
...
@song1ref1046:
	...
	.byte $00, $9d, $44, $00
@song1ch3:
	.byte $8f, $00, $bd, $bf, $bf, $bf, $bf, $bf, $bf, $9f, $8a, $20, $83, $1e, $83, $20, $85, $8c, $14, $81, $86, $15, $15, $15
	.byte $15
@song1ref1149:
	.byte $94, $1d, $85
@song1ref1152:
...
@song1ref1254:
	...
	.byte $41, $0d
	.word @song1ref1152
	.byte $00, $81, $14, $00, $81, $14, $00, $83, $14, $88, $23, $86, $14, $00, $83, $7c, $94, $1d, $85, $7b, $87, $79, $87, $77
	.byte $87, $76, $87, $75, $85, $74, $85, $73, $83, $72, $81, $71, $81, $70, $83, $00, $bd, $bf, $bf, $9f, $44, $00
@song1ch4:
	.byte $8f, $00, $bd, $bf, $bf, $bb, $26, $81, $26, $b9, $26, $81, $26, $b9, $26, $81, $26, $b9, $26, $81, $26, $9d, $3b, $83
	.byte $3b, $83, $3b, $85, $26, $81, $3b, $3b, $3b, $3b
@song1ref1462:
	.byte $26, $85, $3b, $89
@song1ref1466:
	.byte $26, $81, $3b
@song1ref1469:
	.byte $85, $26, $85, $3b, $89, $26, $81, $3b, $85
	.byte $41, $0b
	.word @song1ref1462
	.byte $81, $26, $85
	.byte $41, $0c
	...
	.byte $41, $10
	.word @song1ref1462
	.byte $26, $83, $26, $83, $26, $85, $26, $81, $3b, $85, $3b, $8d, $00, $ad
	.byte $41, $0b
	.word @song1ref1462
	.byte $81, $26, $85
	.byte $41, $0c
	...
	.byte $41, $10
	.word @song1ref1462
	.byte $26, $85, $26, $85, $26, $85, $26, $85, $3b, $8d, $00, $ad, $bf, $bf, $bf, $9f, $44, $00
@song2ch0:
	.byte $46, $02
@song2ref3:
...
@song2ref394:
	...
	.byte $78
@song2ref421:
	.byte $49, .lobyte(@env18), .hibyte(@env18), $83, $ae, $50, $f2, $2a, $2c, $81, $20, $00, $8f, $50, $f2, $2a, $2c, $81, $20
	...
	.byte $41, $15
	.word @song2ref421
	.byte $74, $51, $01, $b0, $4b, .lobyte(@env58), .hibyte(@env58), $b2, $18, $dd, $79, $49, .lobyte(@env0), .hibyte(@env0)
...
@song2ch2:
	.byte $b0, $50, $fb, $11, $2e, $dd, $df, $df, $df, $a2, $50, $01, $2e, $2c, $dd, $df, $df, $00, $dd
@song2ref817:
	.byte $00, $89
@song2ref819:
	.byte $9c
...
@song2ref1032:
	.byte $94, $1e, $89
@song2ref1035:
	.byte $8a, $20, $85, $00, $81, $86, $22, $81, $00, $85, $8a, $20, $85, $8c, $15, $81, $15, $81, $00, $81, $15, $81, $8a, $20
	.byte $85, $00, $81, $86, $22, $81, $00, $85, $8a, $20, $85, $00, $81, $8c, $15, $81, $00, $85
	.byte $41, $22
	.word @song2ref1035
	.byte $41, $22
	.word @song2ref1035
@song2ref1083:
	.byte $15, $81, $00, $81, $8a, $20, $81, $86, $22, $85, $8c, $15, $81, $15, $81, $00, $85, $86, $22, $85, $00, $81, $8a, $20
	...
	.word @song2ref1083
@song2ref1155:
	.byte $8c, $15, $85, $00, $8d, $86, $22, $85, $00, $89, $8c, $15, $81, $15, $81, $00, $85, $15, $81, $00, $85, $86, $22, $85
...
@song3ref765:
	.byte $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $90, $14, $85, $88, $20, $00, $20, $00
...
@song3ch4:
	.byte $ff, $ff
@song3ref851:
	.byte $26, $1b, $87, $26, $1b, $87, $26, $1b, $8b, $26, $1b, $83, $0f, $81, $1b, $81, $26, $1b, $83, $26, $1b, $87, $26, $1b
	.byte $87, $26, $1b, $8b, $26, $13, $83, $1e, $81, $1c, $81, $26, $1c, $83, $26, $19, $87, $26, $19, $87, $26, $19, $8b, $26
	.byte $19, $83, $23, $81, $19, $81, $26, $19, $83, $26, $1a, $87, $26, $1a, $87, $26, $1a, $8b, $26, $1a, $83, $1d, $81, $1a
	.byte $81, $26, $1d, $83
	.byte $41, $46
	.word @song3ref851
	.byte $8d
@song3ref931:
	.byte $26, $1b, $87, $26, $1b, $87, $26, $1b, $83, $3b, $1b, $83, $26, $1b, $83, $0f, $81, $1b, $81, $26, $1b, $83, $26, $1b
	.byte $87, $26, $1b, $87, $26, $1b, $83, $3b, $1b, $83, $26, $13, $83, $1e, $81, $1c, $81, $26, $1c, $83, $26, $19, $87, $26
	.byte $19, $87, $26, $19, $83, $3b, $19, $83, $26, $19, $83, $23, $81, $19, $81, $26, $19, $83, $26, $1a, $87, $26, $1a, $87
	.byte $26, $1a, $83, $3b, $1a, $83, $26, $1a, $83, $1d, $81, $1a, $81, $26, $1d, $83
	.byte $41, $58
	.word @song3ref931
	.byte $41, $58
	.word @song3ref931
...
@song4ref7:
	...
	.byte $41, $14
	.word @song4ref7
	.byte $4f, $03, $85, $4b, .lobyte(@env46), .hibyte(@env46), $a6
@song4ref46:
...
@song4ref875:
	.byte $4b, .lobyte(@env58), .hibyte(@env58), $12, $9d, $4d, $0e, $9d, $4b, .lobyte(@env37), .hibyte(@env37), $0b, $9d, $4b
	.byte .lobyte(@env17), .hibyte(@env17), $07, $8d, $4b, .lobyte(@env41), .hibyte(@env41), $09, $8d, $4b, .lobyte(@env58), .hibyte(@env58)
	.byte $12, $9d, $4b, .lobyte(@env37), .hibyte(@env37), $0e, $9d, $4b, .lobyte(@env14), .hibyte(@env14), $0b, $9d, $4b, .lobyte(@env58)
	.byte .hibyte(@env58), $0e, $8d, $4b, .lobyte(@env46), .hibyte(@env46), $09, $8d
	.byte $41, $14
	.word @song4ref875
	.byte $44, $00
@song4ch2:
...
@song4ref984:
	.byte $92, $12, $81, $00, $81, $80, $40, $4e, $81, $40, $4c, $81, $3e, $85, $3b, $85, $92, $12, $81, $00, $89, $98, $06, $81
	.byte $00, $89
	.byte $41, $14
	.word @song4ref984
	.byte $41, $14
...
@song4ref1215:
	...
	.byte $8d, $9c, $0d, $0d, $0c, $81, $0a, $81, $8c, $0e, $81, $8a, $10, $81, $10, $81, $10, $81, $86, $0e, $81, $8a, $10
@song4ref1279:
	.byte $81
@song4ref1280:
	.byte $10, $81, $10, $81, $8c, $0e, $81, $8a, $10, $81, $10, $81, $10, $81, $86, $0e, $81, $8a, $10, $0f
	.byte $41, $0f
	.word @song4ref1280
	.byte $41, $11
	.word @song4ref1279
...
@song4ref1498:
	...
	.byte $3b, $3b, $3b, $81, $3b
@song4ref1544:
	.byte $81, $26, $81, $1b, $81, $1b, $81, $1b, $81, $3b, $81, $1b, $81, $1b, $81, $1b, $81, $26, $81, $19, $81, $19, $81, $19
	.byte $81, $3b, $81, $19, $81, $19, $81, $19, $81, $26, $81, $18, $81, $18, $81, $18, $81, $3b, $81, $18, $81, $18, $81, $18
	.byte $81, $26, $81, $17, $81, $17, $81, $17, $81, $3b, $81, $11, $81, $11, $81, $11
	.byte $41, $40
	.word @song4ref1544
	.byte $41, $40
	.word @song4ref1544
