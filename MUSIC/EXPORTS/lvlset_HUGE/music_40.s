...
@instruments:
	...
	.word @env33,@env6,@env3,@env0 ; 06 : cymbal
	.word @env37,@env18,@env22,@env0 ; 07 : blank instant decay
	.word @env14,@env18,@env22,@env0 ; 08 : blank
	.word @env30,@env18,@env22,@env0 ; 09 : triangle pluck 4
	...
	.word @env35,@env18,@env22,@env0 ; 0e : menu acc
	...
	.word @env27,@env36,@env23,@env0 ; 12 : octave arp
	.word @env13,@env18,@env22,@env1 ; 13 : Extreme pitch down
	.word @env27,@env36,@env22,@env0 ; 14 : octave arp [ no duty ]
	.word @env13,@env18,@env22,@env0 ; 15 : DMC: drums + bass
	.word @env15,@env18,@env22,@env0 ; 16 : Instrument 2
	.word @env38,@env18,@env22,@env0 ; 17 : blank slower string
	.word @env39,@env18,@env26,@env0 ; 18 : death moon lead
	.word @env27,@env18,@env22,@env0 ; 19 : quiet bass
	.word @env11,@env18,@env22,@env0 ; 1a : 02 but tri
	.word @env34,@env18,@env24,@env0 ; 1b : shift string
...
@song4ref154:
	...
	.byte $08, $83, $0a, $83, $0e, $83, $11, $81, $8e, $27, $27, $27, $90, $27, $81, $1b, $81, $0f, $a0, $50, $b3, $16, $5b, $85
...
@song6ref88:
	...
	.byte $00, $1e, $00, $81, $1e, $1a, $00, $81, $1a, $00, $1a, $00, $83, $1a, $00, $94, $0e, $a4, $21, $00, $81, $21, $00, $25
	.byte $26
	.byte $41, $27
	.word @song6ref88
	.byte $94, $32, $a2, $36, $34, $81, $32, $34, $81, $32, $36, $81, $37, $36, $81, $32, $2d, $83, $2b, $81, $2a, $2b, $81, $2a
	.byte $26, $81
@song6ref166:
	.byte $2a, $26
@song6ref168:
...
@song6ref864:
	...
	.byte $81, $44, $00
@song6ch4:
	.byte $20, $8d, $34, $83, $34, $ad
@song6ref928:
	.byte $20, $20, $83, $34, $81, $20, $83, $34, $83, $20, $20, $83, $34, $81, $20, $83, $34, $83
	.byte $41, $12
	.word @song6ref928
	.byte $41, $12
	.word @song6ref928
