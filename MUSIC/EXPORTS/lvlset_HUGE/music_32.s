...
@instruments:
	.word @env29,@env5,@env2,@env0 ; 00 : cymbal
	.word @env14,@env18,@env22,@env0 ; 01 : blank
	.word @env6,@env28,@env22,@env0 ; 02 : kick
	.word @env15,@env5,@env22,@env0 ; 03 : rel hats
	.word @env1,@env18,@env22,@env0 ; 04 : echo
	.word @env3,@env18,@env22,@env13 ; 05 : triangle drums
	.word @env20,@env23,@env22,@env0 ; 06 : clap
	.word @env11,@env18,@env22,@env0 ; 07 : DMC: drums + bass
	.word @env16,@env21,@env2,@env0 ; 08 : snare
	.word @env3,@env18,@env24,@env0 ; 09 : sample
	.word @env26,@env4,@env22,@env0 ; 0a : tight triangle kick
	.word @env17,@env18,@env22,@env0 ; 0b : blank string
	.word @env25,@env9,@env22,@env0 ; 0c : lots of clap
	.word @env8,@env18,@env10,@env0 ; 0d : shift string lite
...
@song0ref462:
	.byte $27, $81, $72, $4b, .lobyte(@env31), .hibyte(@env31), $20, $81, $74, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $23
	.byte $81, $72, $4b, .lobyte(@env31), .hibyte(@env31), $20, $85, $74, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $27, $81
	.byte $2c, $81, $72, $4b, .lobyte(@env31), .hibyte(@env31), $20, $81, $74, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $2a
	.byte $81, $72, $4b, .lobyte(@env30), .hibyte(@env30), $20, $81, $74, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $28, $81
	.byte $72, $4b, .lobyte(@env30), .hibyte(@env30), $20, $81, $74, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $23, $81, $72
	.byte $4b, .lobyte(@env30), .hibyte(@env30), $20, $81, $74, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $25, $81, $27, $00
	...
	.byte $81, $72, $4b, .lobyte(@env32), .hibyte(@env32), $1e, $81, $74, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $23, $81
	.byte $25, $81, $2a, $81, $72, $4b, .lobyte(@env32), .hibyte(@env32), $1e, $81, $74, $4b, .lobyte(@env18), .hibyte(@env18)
	...
	.byte $41, $0e
	.word @song0ref165
	.byte $71, $4b, .lobyte(@env30), .hibyte(@env30), $20, $74, $4b, .lobyte(@env18), .hibyte(@env18), $4c
	.byte $41, $0e
	.word @song0ref194
	...
	.word @song0ref232
@song0ref687:
	.byte $27, $81, $72, $4b, .lobyte(@env31), .hibyte(@env31), $20, $81, $73, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $23
	.byte $74, $85, $72, $4b, .lobyte(@env31), .hibyte(@env31), $20, $81, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $27, $48
	.byte $03, $27, $73, $2c, $74, $81, $2a, $81, $73, $81, $72, $4b, .lobyte(@env30), .hibyte(@env30), $20, $74, $4b, .lobyte(@env18)
...
@song0ref865:
	...
	.byte .lobyte(@env18), .hibyte(@env18), $4c, $25, $74, $81, $2a, $72, $4b, .lobyte(@env30), .hibyte(@env30), $20, $73, $4b
	...
	.byte .hibyte(@env32), $1e, $73, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $27, $74, $85, $73, $23, $74, $85, $73, $25
	.byte $74, $81, $27, $72, $4b, .lobyte(@env31), .hibyte(@env31), $20, $73, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $23
	.byte $74, $81, $27, $72, $4b, .lobyte(@env31), .hibyte(@env31), $20, $73, $4b, .lobyte(@env18), .hibyte(@env18), $4c
	.byte $41, $26
	.word @song0ref865
	.byte $00, $9d, $44, $00
@song0ch2:
