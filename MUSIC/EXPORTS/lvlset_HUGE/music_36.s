...
@instruments:
	...
	.word @env42,@env22,@env26,@env0 ; 01 : blank instant decay
	.word @env11,@env10,@env35,@env0 ; 02 : hat
	.word @env12,@env36,@env26,@env0 ; 03 : kick
	.word @env24,@env27,@env26,@env0 ; 04 : clap
	.word @env20,@env25,@env3,@env0 ; 05 : snare
	.word @env19,@env10,@env26,@env0 ; 06 : rel hats
	.word @env15,@env22,@env6,@env0 ; 07 : endgame lead
	.word @env23,@env22,@env6,@env0 ; 08 : infernogame_lead_piano
	.word @env37,@env10,@env3,@env0 ; 09 : cymbal
	.word @env4,@env22,@env28,@env0 ; 0a : sample
	.word @env18,@env22,@env26,@env0 ; 0b : blank
	.word @env16,@env22,@env26,@env0 ; 0c : DMC: drums + bass
	.word @env8,@env22,@env28,@env0 ; 0d : loud sample
	.word @env44,@env22,@env29,@env0 ; 0e : death moon lead
	.word @env31,@env22,@env26,@env32 ; 0f : jaezu lead
	.word @env30,@env22,@env26,@env0 ; 10 : loud_infernoplex_piano
	.word @env38,@env22,@env26,@env0 ; 11 : piano
	.word @env16,@env22,@env7,@env0 ; 12 : hex guitar 1
	.word @env16,@env22,@env26,@env1 ; 13 : Extreme pitch down
	.word @env39,@env22,@env40,@env0 ; 14 : piano duty
	.word @env13,@env34,@env26,@env0 ; 15 : octave arp [ full volume]
	...
	.word @env16,@env22,@env26,@env0 ; 1a : Duty 0
	.word @env33,@env5,@env26,@env0 ; 1b : tight triangle kick
...
@song3ref118:
	...
	.byte $41, $18
	.word @song3ref117
	.byte $49, .lobyte(@env41), .hibyte(@env41), $8e, $2c, $95, $49, .lobyte(@env0), .hibyte(@env0), $4a
	.byte $41, $20
	.word @song3ref116
@song3ref165:
	...
	.byte $41, $14
	.word @song3ref117
	.byte $29, $85, $00, $81, $49, .lobyte(@env41), .hibyte(@env41), $8e, $2c, $95, $49, .lobyte(@env0), .hibyte(@env0), $4a
	.byte $41, $18
	.word @song3ref116
	.byte $22, $85, $00, $81, $20, $85, $00, $81
	.byte $41, $0b
	...
	.byte $41, $14
	.word @song3ref117
	.byte $29, $85, $00, $81, $49, .lobyte(@env41), .hibyte(@env41), $8e, $2c, $95, $7f, $49, .lobyte(@env0), .hibyte(@env0)
...
@song3ref421:
	...
	.byte $41, $15
	.word @song3ref421
	.byte $74, $51, $01, $b0, $4b, .lobyte(@env45), .hibyte(@env45), $b2, $18, $dd, $79, $49, .lobyte(@env0), .hibyte(@env0)
