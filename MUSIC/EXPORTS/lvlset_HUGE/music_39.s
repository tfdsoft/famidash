...
@instruments:
	...
	.word @env22,@env25,@env30,@env0 ; 04 : blank
	.word @env27,@env31,@env30,@env0 ; 05 : clap
	.word @env1,@env25,@env30,@env0 ; 06 : echo
	.word @env41,@env25,@env30,@env0 ; 07 : blank instant decay
	.word @env28,@env25,@env3,@env0 ; 08 : endorphin lead 2
	.word @env26,@env46,@env30,@env0 ; 09 : pluck1
	...
	.word @env7,@env25,@env13,@env0 ; 0d : endorphin lead
	.word @env17,@env25,@env30,@env19 ; 0e : tom
	.word @env4,@env25,@env30,@env21 ; 0f : triangle drums
	.word @env33,@env25,@env30,@env0 ; 10 : triangle pluck 4
	.word @env44,@env25,@env32,@env0 ; 11 : death moon lead
	.word @env9,@env6,@env36,@env0 ; 12 : hat
...
@song0ref5:
	...
	.byte $41, $1b
	.word @song0ref5
	.byte $20, $81, $1e, $81, $1e, $81, $4b, .lobyte(@env35), .hibyte(@env35)
@song0ref63:
...
@song0ref361:
	...
	.byte $4b, .lobyte(@env35), .hibyte(@env35), $8e
	.byte $41, $2f
	.word @song0ref63
	.byte $41, $10
	.word @song0ref109
	...
	.byte $41, $10
	.word @song0ref109
	.byte $81, $77, $4b, .lobyte(@env25), .hibyte(@env25), $4c, $96
	.byte $41, $1f
	.word @song0ref4
	.byte $41, $1b
	.word @song0ref5
...
@song3ch0:
	.byte $46, $03, $97, $77, $4b, .lobyte(@env34), .hibyte(@env34), $4f, $01, $88, $08, $8d, $00, $ad, $8f, $71, $51, $01, $40
	.byte $4b, .lobyte(@env25), .hibyte(@env25), $4c, $0b, $ab, $81, $77, $4b, .lobyte(@env34), .hibyte(@env34), $4f, $01, $08
...
@song4ch1:
	.byte $ff, $ff, $bf, $4b, .lobyte(@env12), .hibyte(@env12), $96, $1c, $83, $00, $83, $4d, $1c, $83, $00, $8b, $4b, .lobyte(@env42)
...
@song4ref224:
	.byte $19, $83, $00, $8b
@song4ref228:
	.byte $bf, $4b, .lobyte(@env12), .hibyte(@env12), $1c, $83, $00, $83, $4d, $1c, $83, $00, $8b, $4b, .lobyte(@env42), .hibyte(@env42)
	.byte $19, $83, $00, $4b, .lobyte(@env45), .hibyte(@env45), $19, $81, $4b, .lobyte(@env40), .hibyte(@env40)
	.byte $41, $10
	.word @song4ref224
	.byte $41, $14
	.word @song4ref218
	.byte $4b, .lobyte(@env40), .hibyte(@env40), $19, $83, $00, $8b, $e7, $4b, .lobyte(@env40), .hibyte(@env40), $1b, $85, $4b
	.byte .lobyte(@env38), .hibyte(@env38), $1b, $81, $4b, .lobyte(@env40), .hibyte(@env40), $1b, $85, $00, $81, $df, $4b, .lobyte(@env20)
	.byte .hibyte(@env20), $19, $85, $4d, $19, $85, $4b, .lobyte(@env18), .hibyte(@env18), $19, $85, $00, $85
	.byte $41, $0c
	.word @song4ref228
	.byte $41, $14
	.word @song4ref218
	.byte $4b, .lobyte(@env40), .hibyte(@env40), $19, $83, $00, $8b, $ef, $4b, .lobyte(@env18), .hibyte(@env18), $20, $83, $45
	.byte $87, $44, $00
@song4ch2:
	.byte $ff, $ff, $88
@song4ref329:
	...
	.byte .lobyte(@env14), .hibyte(@env14), $87, $49, .lobyte(@env11), .hibyte(@env11), $8d, $00, $49, .lobyte(@env0), .hibyte(@env0)
...
@song4ref581:
	...
	.byte $41, $0c
	.word @song4ref581
	.byte $86, $1e, $9b, $00, $20, $9b, $00, $9f, $a4, $16, $00, $16, $16, $16, $00, $16, $00, $86, $1d, $8d, $44, $00
@song4ch4:
	.byte $ff
@song4ref687:
	...
	.word @song4ref687
@song4ref705:
	.byte $35, $85, $00, $81, $21, $85, $00, $81, $21, $85, $35, $85, $00, $85, $21, $85, $00, $85
	.byte $41, $12
	.word @song4ref705
	.byte $41, $12
	.word @song4ref705
@song4ref729:
	.byte $35, $85, $21, $81, $21, $21, $21, $85, $35, $85, $35, $81, $21, $81, $21, $81, $21, $81, $21, $85, $00, $85
	.byte $41, $12
	.word @song4ref705
	.byte $41, $12
	.word @song4ref705
	...
	.byte $41, $12
	.word @song4ref729
	.byte $35, $85, $21, $85, $35, $85, $21, $81, $21, $21, $21, $85, $35, $81, $21, $81, $35, $81, $21, $81, $21, $81, $21, $81
	.byte $21, $89, $21, $85, $21, $81, $21, $85, $21, $85, $00, $85, $35, $85, $00, $85, $44, $00
