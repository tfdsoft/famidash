...
@instruments:
	...
	.word @env46,@env25,@env31,@env0 ; 03 : tight noise kick layer
	.word @env28,@env32,@env31,@env0 ; 04 : clap
	.word @env9,@env44,@env31,@env0 ; 05 : kick
	.word @env18,@env25,@env31,@env0 ; 06 : blank
	.word @env50,@env25,@env31,@env0 ; 07 : blank instant decay
	.word @env27,@env25,@env31,@env0 ; 08 : triangle pluck
	.word @env45,@env6,@env2,@env0 ; 09 : cymbal
	.word @env39,@env25,@env31,@env40 ; 0a : jaezu lead
	.word @env24,@env25,@env31,@env0 ; 0b : blank string
	.word @env41,@env5,@env31,@env0 ; 0c : tight triangle kick
	.word @env36,@env49,@env33,@env0 ; 0d : octave arp
	.word @env41,@env7,@env31,@env0 ; 0e : tight triangle snare
	.word @env47,@env25,@env34,@env0 ; 0f : shift string
	.word @env15,@env25,@env31,@env0 ; 10 : DMC: drums + bass
	.word @env15,@env25,@env21,@env0 ; 11 : hex guitar 2
	.word @env26,@env25,@env31,@env0 ; 12 : long piano
	.word @env11,@env25,@env14,@env0 ; 13 : shift string lite
	.word @env35,@env25,@env31,@env0 ; 14 : Instrument 1
	.word @env3,@env25,@env31,@env17 ; 15 : triangle drums
	.word @env4,@env25,@env38,@env0 ; 16 : xstep wub
	.word @env19,@env25,@env30,@env16 ; 17 : Kap lead
	.word @env22,@env6,@env31,@env0 ; 18 : rel hats
	.word @env51,@env25,@env31,@env0 ; 19 : blank slower string
...
@song0ch1:
	...
	.byte $1e, $72, $8c, $25, $76, $84, $25, $72, $8c, $1e, $7a, $4b, .lobyte(@env10), .hibyte(@env10), $9e, $19, $9d, $4d, $14
	...
	.byte $9d, $7c, $4b, .lobyte(@env25), .hibyte(@env25), $4c, $4f, $03, $8e
@song0ref717:
...
@song0ref1088:
	...
	.byte $41, $20
	.word @song0ref1070
	.byte $82, $14, $81, $80, $21, $23, $8a, $14, $80, $23, $21, $81, $82, $14, $81, $80, $21, $23, $92, $1f, $8d, $45, $ed, $ff
	.byte $89, $44, $00
@song0ch4:
	.byte $ff, $ff
@song0ref1223:
...
@song1ref991:
	...
	.byte $41, $0f
	.word @song1ref961
	.byte $81, $88, $20, $81, $80, $1f, $1f, $83, $1f, $85, $1f, $1f, $92, $20, $8d, $44, $00
@song1ch4:
	.byte $52, $80, $00, $fd
@song1ref1119:
...
@song2ch0loop:
	...
	.byte $19, $89, $17, $91, $16, $95, $00, $a5, $b9, $47, $02, $8e, $19, $47, $01, $19, $47, $00, $19, $4f, $01, $a4, $19, $89
...
@song2ref397:
	.byte $85, $90, $14, $00, $80, $23, $81, $00, $81, $23, $23, $23, $23, $23, $81, $00, $85, $23, $81, $88, $20, $85, $00, $81
	.byte $90, $14, $00, $80, $23, $81, $00, $81, $88, $1a, $81, $90, $14, $00, $80, $23, $81, $00, $81, $23, $23, $23, $23
	.byte $41, $22
	.word @song2ref379
	.byte $1a
	.byte $41, $20
...
@song4ref423:
	...
	.byte $2c, $81, $94, $2d, $91, $00, $8d, $74, $4b, .lobyte(@env53), .hibyte(@env53), $8c, $22, $bd, $4b, .lobyte(@env10)
...
@song4ref483:
	...
	.byte $4b, .lobyte(@env42), .hibyte(@env42), $96, $16, $81, $4d, $1d, $81, $4d, $1f, $81, $7a, $4b, .lobyte(@env25), .hibyte(@env25)
	.byte $4c, $94, $20, $85, $1f, $85, $78, $4b, .lobyte(@env37), .hibyte(@env37), $a0, $1d, $9b, $77, $51, $fe, $00, $95, $83
	.byte $00, $85, $44, $00
@song4ch2:
	.byte $94, $3d, $95, $49, .lobyte(@env0), .hibyte(@env0), $4a, $00, $a5, $bf, $96
	.byte $41, $0c
	.word @song4ref423
	.byte $28, $81, $1c, $81, $25, $81, $94, $2c, $85, $2a, $85, $27, $85, $00, $99, $b0
@song4ref680:
...
@song5ch0:
	.byte $46, $06
@song5ref3:
	.byte $8e, $18, $81, $84, $18, $81, $8e, $24, $81, $84, $24, $81, $8e, $1c, $81, $84, $1c, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a
@song5ref24:
	.byte $81, $4f, $03
@song5ref27:
	.byte $8e, $11, $81, $84, $11
@song5ref32:
	.byte $81, $8e, $1d, $81, $84, $1d, $81, $8e, $24, $81, $84, $24, $81, $8e, $1d, $81, $84, $1d, $81
	.byte $41, $0c
	.word @song5ref27
	.byte $8e, $25, $81, $84, $25, $81
	.byte $41, $10
	.word @song5ref27
	.byte $41, $0a
	.word @song5ref27
	...
	.byte $41, $0c
	.word @song5ref27
	.byte $8e, $25, $81, $84, $25, $81, $8e, $10, $81, $84, $10, $81, $8e, $1c, $81, $84, $1c
@song5ref95:
	.byte $81, $8e, $24, $81, $84, $24, $81, $8e, $1d, $81, $84, $1d, $81, $8e, $0d, $81, $84, $0d, $81, $8e, $1d, $81, $84, $1d
	.byte $81, $8e, $24, $81, $25, $81, $1d, $81, $84, $1d, $81, $8e, $0a, $81, $84, $0a
	.byte $41, $0d
	.word @song5ref32
	.byte $8e, $0a, $81, $84, $0a, $81, $8e, $1d, $81, $84, $1d, $81, $8e, $22, $81, $84, $22, $81, $8e, $25, $81, $84, $25, $81
	.byte $8e, $0c, $81, $84, $0c, $81, $8e, $1d, $81, $84, $1d, $81, $8e, $24, $81, $84, $24, $81, $8e, $1c, $81, $84, $1c, $81
	.byte $8e, $0c, $81, $84, $0c, $81, $8e, $18, $81, $84, $18
	.byte $41, $0d
	.word @song5ref95
	.byte $8e, $19, $81, $84, $19
	.byte $41, $13
	.word @song5ref95
	.byte $84, $24, $81, $8e, $25, $81, $84, $25, $81
	.byte $41, $0c
	.word @song5ref3
	.byte $8e, $1d, $81, $84, $1d, $81, $8e, $10, $81, $84, $10, $81
	.byte $41, $0c
	.word @song5ref3
@song5ref235:
...
@song5ref241:
	...
	.byte $41, $14
	.word @song5ref241
	.byte $76, $49, .lobyte(@env13), .hibyte(@env13), $4b, .lobyte(@env42), .hibyte(@env42), $4f, $01, $b2, $3c, $85, $4d, $b2
...
@song5ref388:
	...
	.byte $44, $00
@song5ch1:
	.byte $78, $4b, .lobyte(@env42), .hibyte(@env42), $8c, $2b, $85, $83, $77, $83, $76, $83, $75, $83, $76, $49, .lobyte(@env13)
	.byte .hibyte(@env13), $4b, .lobyte(@env25), .hibyte(@env25), $4c, $4f, $01, $a2
@song5ref507:
...
@song5ref550:
	...
	.byte $41, $0b
	.word @song5ref527
	.byte $2b, $85, $78, $4b, .lobyte(@env42), .hibyte(@env42), $4f, $00, $8c, $2c, $76, $81, $75, $81, $73, $81, $78, $4b, .lobyte(@env25)
	.byte .hibyte(@env25), $4c, $4f, $01, $a2, $28, $85, $29, $85, $2b, $85, $4b, .lobyte(@env42), .hibyte(@env42), $4f, $00
	.byte $8c, $2b, $77, $81, $75, $81, $73, $81, $78, $4b, .lobyte(@env25), .hibyte(@env25), $4c, $4f, $01, $a2
	.byte $41, $0a
	.word @song5ref550
	...
	.byte $41, $14
	.word @song5ref241
	.byte $76, $49, .lobyte(@env13), .hibyte(@env13), $4b, .lobyte(@env42), .hibyte(@env42), $4f, $01, $a2, $30, $85, $4d, $a2
