...
@instruments:
	.word @env14,@env48,@env37,@env0 ; 00 : kick
	.word @env23,@env29,@env37,@env0 ; 01 : blank
	.word @env49,@env11,@env2,@env0 ; 02 : cymbal
	.word @env26,@env35,@env2,@env0 ; 03 : snare
	.word @env34,@env38,@env37,@env0 ; 04 : clap
	.word @env18,@env29,@env37,@env0 ; 05 : 02 but tri
	.word @env3,@env29,@env37,@env22 ; 06 : triangle drums
	.word @env32,@env29,@env37,@env0 ; 07 : triangle pluck
	.word @env13,@env11,@env47,@env0 ; 08 : hat
	.word @env28,@env29,@env37,@env0 ; 09 : blank string
	.word @env56,@env29,@env37,@env0 ; 0a : blank slower string loud
	.word @env58,@env29,@env37,@env0 ; 0b : blank instant decay
	.word @env20,@env29,@env9,@env0 ; 0c : hex guitar 1
	.word @env55,@env29,@env37,@env0 ; 0d : blank string loud
	.word @env43,@env29,@env37,@env44 ; 0e : jaezu lead
	.word @env30,@env29,@env37,@env0 ; 0f : infernoplex_piano
	.word @env1,@env29,@env37,@env0 ; 10 : echo
	.word @env5,@env29,@env36,@env33 ; 11 : death moon bell
	.word @env3,@env29,@env39,@env0 ; 12 : sample
	.word @env10,@env29,@env39,@env0 ; 13 : loud sample
	.word @env20,@env29,@env39,@env0 ; 14 : blank width 2
	.word @env30,@env61,@env37,@env0 ; 15 : pluck1
	.word @env50,@env29,@env37,@env0 ; 16 : piano
	.word @env20,@env29,@env24,@env0 ; 17 : hex guitar 2
	.word @env45,@env29,@env37,@env0 ; 18 : triangle pluck 4
	.word @env4,@env29,@env41,@env0 ; 19 : xstep wub
	.word @env19,@env29,@env6,@env0 ; 1a : endgame lead
	.word @env25,@env11,@env37,@env0 ; 1b : rel hats
	.word @env15,@env29,@env37,@env0 ; 1c : slower string loud
	.word @env42,@env16,@env37,@env0 ; 1d : lots of clap
	.word @env59,@env29,@env37,@env0 ; 1e : blank slower string
	.word @env31,@env29,@env6,@env0 ; 1f : endgame lead string
	.word @env27,@env29,@env37,@env0 ; 20 : triangle pluck 3
	.word @env54,@env29,@env40,@env0 ; 21 : shift string
	.word @env57,@env29,@env37,@env0 ; 22 : menu acc
...
@song0ref140:
	...
	.byte .hibyte(@env8), $4f, $02, $92, $0f, $99, $45, $81, $44, $00
@song0ch1:
	.byte $7a, $49, .lobyte(@env12), .hibyte(@env12), $4f, $01, $c2
@song0ref249:
	.byte $0d, $97, $45, $83, $c2, $14, $97, $45, $83, $12, $97, $45, $83, $10, $8b, $45, $0f, $8b, $45, $49, .lobyte(@env12)
	...
	.byte $41, $12
	.word @song0ref249
	.byte $49, .lobyte(@env12), .hibyte(@env12), $4f, $01, $0d, $99, $45, $81, $c2, $14, $99, $45, $81, $10, $99, $45, $81, $49
	.byte .lobyte(@env21), .hibyte(@env21), $4f, $03, $92, $0f, $99, $45, $81, $44, $00
@song0ch2:
	.byte $c0
@song0ref316:
...
@song2ref363:
	...
	.byte $41, $47
	.word @song2ref230
	.byte $9c, $21, $9d, $9f, $9f, $7d, $4e, $00, $4b, .lobyte(@env46), .hibyte(@env46)
	.byte $41, $18
	.word @song2ref316
	.byte $4e, $00, $4d
	.byte $41, $18
...
@song2ref582:
	...
	.byte $41, $18
	.word @song2ref582
	.byte $25, $8d, $28, $8d, $7d, $4e, $00, $49, .lobyte(@env17), .hibyte(@env17), $bc, $1a, $9d, $bc, $1c, $9d, $1d, $8d, $1f
	.byte $8d, $7b, $21, $9d, $7d, $4e, $00, $49, .lobyte(@env17), .hibyte(@env17), $1a, $9d, $bc, $1c, $9d, $1d, $8d, $1f, $8d
...
@song2ref803:
	...
	.byte $41, $23
	.word @song2ref263
	.byte $91, $9c, $39, $9d, $9f, $9f, $76, $4e, $01, $4b, .lobyte(@env46), .hibyte(@env46)
	.byte $41, $18
	.word @song2ref316
	.byte $4e, $01, $4d
	.byte $41, $18
...
@song2ref1159:
	...
	.byte $41, $40
	.word @song2ref1159
	.byte $82, $50, $f0, $18, $2c, $9d, $4e, $00, $b2
	.byte $41, $40
	.word @song2ref672
	.byte $4e, $00
	.byte $41, $40
...
@song3ref704:
	...
	.byte $41, $12
	.word @song3ref188
	.byte $4b, .lobyte(@env46), .hibyte(@env46), $94, $16, $9d, $4b, .lobyte(@env52), .hibyte(@env52), $13, $8d, $4b, .lobyte(@env51)
	.byte .hibyte(@env51), $15, $8d, $4b, .lobyte(@env29), .hibyte(@env29), $4c, $4f, $01, $92, $26, $83, $45, $87, $4f, $00
	.byte $98
	.byte $41, $12
	.word @song3ref188
	.byte $4b, .lobyte(@env46), .hibyte(@env46), $94, $16, $95, $4d, $15, $85, $4b, .lobyte(@env53), .hibyte(@env53), $14, $8d
	.byte $4b, .lobyte(@env51), .hibyte(@env51), $15, $8d, $4b, .lobyte(@env29), .hibyte(@env29), $4c, $4f, $01, $92, $26, $83
	.byte $45, $87, $4f, $00, $98
	.byte $41, $12
	.word @song3ref188
	.byte $4b, .lobyte(@env46), .hibyte(@env46), $94, $16, $9d, $4b, .lobyte(@env52), .hibyte(@env52), $13, $8d, $4b, .lobyte(@env51)
	...
	.byte $41, $18
	.word @song3ref314
	.byte $09, $81, $0d, $81, $10, $81, $11, $81, $7a, $be, $02, $9d, $04, $9d, $7c, $4f, $01, $94
@song3ref901:
...
@song3ref1782:
	...
	.byte $41, $27
	.word @song3ref1755
	.byte $79, $90, $1b, $00, $83, $7f, $84, $17, $85, $79, $ba, $1c, $83, $43, $50, $f8, $28, $21, $83, $75, $51, $09, $b0, $82
	.byte $1f, $81
@song3ref1838:
	.byte $7f, $84, $1d, $85
@song3ref1842:
