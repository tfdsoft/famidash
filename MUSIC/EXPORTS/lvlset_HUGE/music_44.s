...
@instruments:
	.word @env43,@env22,@env26,@env0 ; 00 : blank instant decay
	.word @env39,@env22,@env26,@env0 ; 01 : blank quiet
	.word @env11,@env9,@env35,@env0 ; 02 : hat
	.word @env21,@env25,@env3,@env0 ; 03 : snare
	.word @env20,@env9,@env26,@env0 ; 04 : rel hats
	.word @env2,@env22,@env26,@env0 ; 05 : echo
	.word @env12,@env36,@env26,@env0 ; 06 : kick
	.word @env37,@env9,@env3,@env0 ; 07 : cymbal
	.word @env19,@env22,@env26,@env0 ; 08 : blank
	.word @env15,@env22,@env26,@env0 ; 09 : blank instant more decay
	.word @env7,@env41,@env26,@env0 ; 0a : (G2) aggressive noise snare
	.word @env19,@env22,@env5,@env0 ; 0b : electroman lead
	.word @env4,@env22,@env27,@env0 ; 0c : sample
	.word @env23,@env22,@env26,@env0 ; 0d : clap no app
	.word @env32,@env22,@env26,@env33 ; 0e : jaezu lead
	.word @env30,@env22,@env26,@env0 ; 0f : Instrument 1
	.word @env16,@env22,@env6,@env0 ; 10 : endgame lead
	.word @env24,@env22,@env38,@env0 ; 11 : endorphin lead 2 but looped duty
	.word @env31,@env42,@env26,@env0 ; 12 : octave arp [ no duty ]
	.word @env17,@env22,@env26,@env0 ; 13 : DMC: drums + bass
	.word @env31,@env42,@env27,@env0 ; 14 : octave arp
	.word @env17,@env22,@env26,@env1 ; 15 : Extreme pitch down
	.word @env20,@env22,@env26,@env0 ; 16 : Instrument 2
	.word @env44,@env22,@env26,@env0 ; 17 : blank slower string
	.word @env40,@env22,@env28,@env0 ; 18 : shift string
	.word @env14,@env22,@env26,@env0 ; 19 : 02 but tri
	.word @env16,@env22,@env18,@env0 ; 1a : polargeist bass
...
@song5ch1:
@song5ref174:
	.byte $4b, .lobyte(@env34), .hibyte(@env34), $80, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $8a, $20, $00
	.byte $7f, $4b, .lobyte(@env34), .hibyte(@env34), $80, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $8a, $20
	.byte $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $80, $25, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $8a
	.byte $25, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $80, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c
	.byte $8a, $24, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $80, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $8a, $20, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $80, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $8a, $20, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $80, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $8a, $24, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $80, $21, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $8a, $21, $00, $7f
	.byte $41, $10
	.word @song5ref174
@song5ref297:
	.byte $7f, $4b, .lobyte(@env34), .hibyte(@env34), $80, $27, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $8a, $27
	.byte $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $80, $25, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $8a
	.byte $25, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $80, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c
	.byte $8a, $24, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $80, $21, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $8a, $21, $00, $7f
	.byte $41, $20
	.word @song5ref174
	.byte $7f
