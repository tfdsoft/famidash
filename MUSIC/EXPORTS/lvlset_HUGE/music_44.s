...
@instruments:
	.word @env50,@env27,@env32,@env0 ; 00 : blank instant decay
	.word @env45,@env27,@env32,@env0 ; 01 : blank quiet
	.word @env13,@env10,@env41,@env0 ; 02 : hat
	.word @env24,@env31,@env2,@env0 ; 03 : snare
	.word @env23,@env10,@env32,@env0 ; 04 : rel hats
	.word @env1,@env27,@env32,@env0 ; 05 : echo
	.word @env15,@env42,@env32,@env0 ; 06 : kick
	.word @env22,@env27,@env32,@env0 ; 07 : blank
	.word @env25,@env27,@env32,@env0 ; 08 : triangle pluck 3
	.word @env17,@env27,@env32,@env0 ; 09 : blank instant more decay
	.word @env43,@env10,@env2,@env0 ; 0a : cymbal
	.word @env52,@env27,@env32,@env0 ; 0b : triangle pluck 2
	.word @env7,@env48,@env32,@env0 ; 0c : (G2) aggressive noise snare
	.word @env37,@env27,@env32,@env0 ; 0d : quiet bass
	.word @env19,@env27,@env8,@env0 ; 0e : hex guitar 1
	.word @env28,@env27,@env32,@env0 ; 0f : infernoplex_piano
	.word @env22,@env27,@env4,@env0 ; 10 : electroman lead
	.word @env3,@env27,@env33,@env0 ; 11 : sample
	.word @env29,@env27,@env32,@env0 ; 12 : clap no app
	.word @env38,@env27,@env32,@env39 ; 13 : jaezu lead
	.word @env36,@env27,@env32,@env0 ; 14 : Instrument 1
	.word @env19,@env27,@env32,@env0 ; 15 : DMC: drums + bass
	.word @env23,@env27,@env32,@env0 ; 16 : Instrument 2
	.word @env37,@env49,@env33,@env0 ; 17 : octave arp
	.word @env26,@env27,@env32,@env0 ; 18 : blank string
	.word @env30,@env27,@env44,@env0 ; 19 : endorphin lead 2 but looped duty
	.word @env46,@env27,@env34,@env0 ; 1a : shift string
	.word @env18,@env27,@env20,@env0 ; 1b : polargeist bass
	.word @env47,@env27,@env32,@env0 ; 1c : menu acc
	.word @env16,@env27,@env32,@env0 ; 1d : 02 but tri
	.word @env14,@env27,@env32,@env0 ; 1e : clutterfunk sax
	.word @env51,@env27,@env32,@env0 ; 1f : blank slower string
	.word @env18,@env27,@env5,@env0 ; 20 : endgame lead
...
@song0ch0:
	.byte $46, $06, $79, $49, .lobyte(@env0), .hibyte(@env0), $4a, $4f, $02, $b8
@song0ref11:
...
@song0ref143:
	...
	.byte .lobyte(@env21), .hibyte(@env21), $4f, $03, $b0, $09, $8b, $43, $0b, $8b, $45, $81, $44, $00
@song0ch2:
	.byte $90
@song0ref213:
...
@song1ref87:
	...
	.word @song1ref87
@song1ref166:
	.byte $83, $7b, $4f, $02, $80, $12, $12, $1e, $1e, $1c, $1c, $19, $19, $73, $00, $83, $9c, $06, $81, $50, $80, $12, $1e, $43
	.byte $12, $00, $7b, $80, $12, $12, $00, $1c, $1c, $00, $19, $19, $73, $00, $83, $9c, $04, $81, $50, $80, $10, $1c, $43, $10
	.byte $00, $7b, $80, $12, $12, $1c, $1c, $1e, $1e, $19, $19, $73, $00, $83, $9c, $01, $81, $50, $80, $0d, $19, $43, $0d, $00
	.byte $7b, $80, $1c, $1c, $00, $1e, $1e, $00, $19, $19, $73, $00, $83, $9c, $09, $81, $00
	.byte $41, $3b
	.word @song1ref166
	.byte $83, $76, $4f, $00, $80
@song1ref263:
	...
	.byte $7b, $4f, $02
@song1ref311:
	.byte $12, $12, $1e, $1e, $1c, $1c, $19, $19, $74, $9e, $1e, $81, $28, $81, $21, $81, $20, $81, $7b, $80, $12, $12, $00, $1c
	.byte $1c, $00, $19, $19, $74, $9e, $25, $85, $19, $81, $1c, $81, $7b, $80, $12, $12, $1c, $1c, $1e, $1e, $19, $19, $74, $9e
	.byte $19, $81, $1c, $81, $20, $81, $21, $81, $7b, $80, $1c, $1c, $00, $1e, $1e, $00, $19, $19, $74, $9e, $25, $81, $2a, $85
...
@song1ch3:
	...
	.byte $bf, $71, $51, $01, $d0, $50, $02, $14, $1f, $bb, $7f, $81, $94, $1d, $85, $8c
@song1ref799:
...
@song1ref863:
	.byte $1d, $85, $00, $81
@song1ref867:
	.byte $88, $20, $81, $86, $14, $81, $00, $85, $88, $20, $20, $8c, $14, $00, $88, $20, $8c, $14, $00, $88, $20, $86, $14, $81
	...
	.byte $8f, $44, $00
@song1ch4:
	.byte $ff, $ff, $20, $00, $1a, $81, $20, $00, $1a, $81, $20, $00, $1a, $81, $20, $00, $1a
@song1ref968:
	.byte $81, $20, $00, $10, $81, $20, $00, $10, $81, $20, $00, $10, $81, $20, $00, $10, $81, $20, $00, $13, $81, $20, $00, $13
	.byte $81, $20, $00, $13, $81, $20, $00, $13
	.byte $41, $12
	.word @song1ref968
	.byte $1a, $20, $1a, $20, $1a, $20, $1a, $20, $1a, $20, $1a, $20, $1a, $20, $1a, $20, $10, $20, $10, $20, $10, $20, $10, $20
...
@song1ref1071:
	.byte $20, $81, $1a, $81, $1a, $81, $1a, $81, $35, $85, $00, $85, $20, $81, $10, $20, $10, $81, $35, $10, $00, $85, $20, $85
...
@song2ref777:
	...
	.byte $81, $22, $86, $14, $83, $7c, $a2, $1f, $7a, $83, $74, $81, $71, $81, $70, $85, $44, $00
@song2ch4:
...
; The DPCM aligner used to be here
@song4ch0:
	.byte $46, $03, $a6, $2b, $85, $2c, $85, $2e, $85, $45, $85, $27, $85, $45, $85, $2c, $85, $45, $85, $00, $ed, $8a
@song4ref23:
...
@song4ref238:
	...
	.byte $44, $00
@song4ch1:
	.byte $79, $a6, $1d, $85, $45, $85, $1b, $8d, $45, $8d, $20, $8d, $45, $8d, $00, $dd, $8a
@song4ref320:
	...
	.byte $41, $14
	.word @song4ref23
	.byte $34, $85, $00, $fd, $ff, $ff, $ff, $78, $4f, $01, $be, $24, $9d, $22, $9d, $25, $9d, $24, $9d, $24, $9d, $22, $9d, $25
...
@song4ref503:
	.byte $19, $85, $00, $81, $19, $85, $00, $81, $1b, $85, $00, $81, $1b, $85, $00, $81, $a4, $1b, $85, $1b, $85, $8e, $14, $85
...
@song5ch4:
	.byte $ff, $ff
@song5ref851:
	.byte $20, $18, $87, $20, $18, $87, $20, $18, $8b, $20, $18, $83, $0f, $81, $18, $81, $20, $18, $83, $20, $18, $87, $20, $18
	.byte $87, $20, $18, $8b, $20, $13, $83, $1c, $81, $19, $81, $20, $19, $83, $20, $16, $87, $20, $16, $87, $20, $16, $8b, $20
	.byte $16, $83, $1e, $81, $16, $81, $20, $16, $83, $20, $17, $87, $20, $17, $87, $20, $17, $8b, $20, $17, $83, $1b, $81, $17
	.byte $81, $20, $1b, $83
	.byte $41, $46
	.word @song5ref851
	.byte $8d
@song5ref931:
	.byte $20, $18, $87, $20, $18, $87, $20, $18, $83, $35, $18, $83, $20, $18, $83, $0f, $81, $18, $81, $20, $18, $83, $20, $18
	.byte $87, $20, $18, $87, $20, $18, $83, $35, $18, $83, $20, $13, $83, $1c, $81, $19, $81, $20, $19, $83, $20, $16, $87, $20
	.byte $16, $87, $20, $16, $83, $35, $16, $83, $20, $16, $83, $1e, $81, $16, $81, $20, $16, $83, $20, $17, $87, $20, $17, $87
	.byte $20, $17, $83, $35, $17, $83, $20, $17, $83, $1b, $81, $17, $81, $20, $1b, $83
	.byte $41, $58
	.word @song5ref931
	.byte $41, $58
	.word @song5ref931
	...
	.byte $44, $00
@song6ch0:
	.byte $46, $06, $74, $4b, .lobyte(@env35), .hibyte(@env35), $8e, $20, $9d, $4b, .lobyte(@env9), .hibyte(@env9), $24, $9d
	.byte $4b, .lobyte(@env11), .hibyte(@env11), $21, $9d, $4b, .lobyte(@env35), .hibyte(@env35), $20, $9d, $4d, $20, $9d, $4b
	.byte .lobyte(@env9), .hibyte(@env9), $24, $9d, $4b, .lobyte(@env11), .hibyte(@env11), $21, $9d, $4b, .lobyte(@env35), .hibyte(@env35)
	.byte $20, $9d
@song6ref43:
	.byte $76, $4b, .lobyte(@env40), .hibyte(@env40), $4f, $00, $0d, $83, $00, $4d, $0d, $83, $00, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $a0, $14, $79, $19, $00, $1c, $00, $14, $19, $1c, $75, $8e, $50, $2e, $19, $14, $81, $00, $50, $2e, $19, $14, $81
...
@song6ch1:
@song6ref174:
	.byte $4b, .lobyte(@env40), .hibyte(@env40), $80, $20, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c, $8a, $20, $00
	.byte $7f, $4b, .lobyte(@env40), .hibyte(@env40), $80, $20, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c, $8a, $20
	.byte $00, $7f, $4b, .lobyte(@env40), .hibyte(@env40), $80, $25, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c, $8a
	.byte $25, $00, $7f, $4b, .lobyte(@env40), .hibyte(@env40), $80, $24, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c
	.byte $8a, $24, $00, $7f, $4b, .lobyte(@env40), .hibyte(@env40), $80, $20, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $8a, $20, $00, $7f, $4b, .lobyte(@env40), .hibyte(@env40), $80, $20, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $8a, $20, $00, $7f, $4b, .lobyte(@env40), .hibyte(@env40), $80, $24, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $8a, $24, $00, $7f, $4b, .lobyte(@env40), .hibyte(@env40), $80, $21, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $8a, $21, $00, $7f
	.byte $41, $10
	.word @song6ref174
@song6ref297:
	.byte $7f, $4b, .lobyte(@env40), .hibyte(@env40), $80, $27, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c, $8a, $27
	.byte $00, $7f, $4b, .lobyte(@env40), .hibyte(@env40), $80, $25, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c, $8a
	.byte $25, $00, $7f, $4b, .lobyte(@env40), .hibyte(@env40), $80, $24, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c
	.byte $8a, $24, $00, $7f, $4b, .lobyte(@env40), .hibyte(@env40), $80, $21, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $8a, $21, $00, $7f
	.byte $41, $20
	.word @song6ref174
	.byte $7f
...
@song6ref538:
	...
	.byte $00, $85, $44, $00
@song6ch2:
	.byte $8e, $14, $9d, $18, $9d, $15, $9d, $14, $9d, $14, $9d, $18, $9d, $15, $9d, $14, $9d, $c0
@song6ref702:
...
@song6ch3:
	.byte $94, $21, $8d, $00, $8d, $9f, $9f, $9f, $9f, $9f, $8c, $1a, $81, $1a, $81, $1a, $81, $1a, $81, $1a, $81, $1a, $81, $1a
...
@song6ref840:
	...
	.byte $19, $00, $84, $22, $22, $86, $21, $00, $84, $22, $22, $8c, $19, $00, $84, $22, $22, $86, $21, $84, $22, $94, $1f, $81
	.byte $41, $20
	.word @song6ref840
	.byte $41, $20
	.word @song6ref840
...
@song6ref968:
	...
	.word @song6ref968
@song6ref1021:
	.byte $13, $85, $15, $00, $83, $18, $85, $0f, $00, $83, $12, $85, $14, $00, $83, $1d, $85, $1f, $00, $83
	.byte $41, $14
	.word @song6ref1021
	.byte $41, $14
	.word @song6ref1021
