...
@instruments:
	...
	.word @env45,@env27,@env33,@env0 ; 12 : shift string
	.word @env19,@env27,@env31,@env0 ; 13 : DMC: drums + bass
	.word @env19,@env27,@env31,@env1 ; 14 : Extreme pitch down
	.word @env36,@env48,@env31,@env0 ; 15 : octave arp [ no duty ]
	.word @env36,@env48,@env32,@env0 ; 16 : octave arp
	.word @env23,@env27,@env31,@env0 ; 17 : Instrument 2
	.word @env26,@env27,@env31,@env0 ; 18 : blank string
	.word @env25,@env27,@env31,@env0 ; 19 : triangle pluck 3
	.word @env16,@env27,@env31,@env0 ; 1a : 02 but tri
	.word @env50,@env27,@env31,@env0 ; 1b : blank slower string
	.word @env46,@env27,@env31,@env0 ; 1c : menu acc
	.word @env18,@env27,@env20,@env0 ; 1d : polargeist bass
...
@song0ch0:
	.byte $46, $06, $49, .lobyte(@env7), .hibyte(@env7), $4f, $02, $b0, $0f, $9d, $72, $49, .lobyte(@env0), .hibyte(@env0), $4a
...
@song0ref34:
	...
	.byte $44, $00
@song0ch1:
	.byte $49, .lobyte(@env21), .hibyte(@env21), $4f, $03, $b0, $0f, $9d, $49, .lobyte(@env12), .hibyte(@env12), $4f, $01, $a4
...
@song5ch1:
	...
	.byte $83, $4e, $00, $4f, $02, $93, $ba, $23, $25, $26, $85, $28, $81, $26, $81, $25, $81, $2a, $81, $28, $81, $26, $81, $2b
