...
@instruments:
	.word @env13,@env46,@env37,@env0 ; 00 : kick
	.word @env28,@env35,@env2,@env0 ; 01 : snare
	.word @env17,@env31,@env37,@env0 ; 02 : 02 but tri
	.word @env25,@env31,@env37,@env0 ; 03 : blank
	.word @env12,@env10,@env45,@env0 ; 04 : hat
	.word @env3,@env31,@env37,@env24 ; 05 : triangle drums
	.word @env47,@env10,@env2,@env0 ; 06 : cymbal
	.word @env1,@env31,@env37,@env0 ; 07 : echo
	.word @env27,@env10,@env37,@env0 ; 08 : rel hats
	.word @env30,@env31,@env37,@env0 ; 09 : blank string
	.word @env29,@env31,@env37,@env0 ; 0a : triangle pluck 3
	.word @env43,@env5,@env37,@env0 ; 0b : tight triangle kick
	.word @env56,@env31,@env37,@env0 ; 0c : triangle pluck 2
	.word @env18,@env31,@env22,@env0 ; 0d : polargeist bass
	.word @env41,@env31,@env37,@env42 ; 0e : jaezu lead
	.word @env20,@env31,@env9,@env0 ; 0f : hex guitar 1
	.word @env20,@env31,@env38,@env0 ; 10 : blank width 2
	.word @env39,@env31,@env37,@env0 ; 11 : quiet bass
	.word @env20,@env31,@env26,@env0 ; 12 : hex guitar 2
	.word @env18,@env31,@env7,@env0 ; 13 : endgame lead
	.word @env4,@env31,@env40,@env0 ; 14 : xstep wub
	.word @env6,@env31,@env36,@env33 ; 15 : death moon bell
	.word @env43,@env31,@env37,@env0 ; 16 : triangle pluck 4
	.word @env50,@env31,@env37,@env0 ; 17 : blank slower string
...
@song0ch0:
	.byte $46, $06, $71, $4b, .lobyte(@env48), .hibyte(@env48), $86, $0f
@song0ref9:
...
@song0ref604:
	...
	.byte .hibyte(@env21), $86, $1b, $81, $73, $83, $77, $4d, $1b, $81, $4b, .lobyte(@env19), .hibyte(@env19), $1b, $81, $73
...
@song0ref717:
	.byte $9a, $03, $85, $77, $4b, .lobyte(@env21), .hibyte(@env21), $4f, $01, $86, $1b, $81, $73, $83, $7a, $4d, $1b, $81, $77
	.byte $4b, .lobyte(@env19), .hibyte(@env19), $1b, $81, $73, $81, $77, $4b, .lobyte(@env31), .hibyte(@env31), $4c, $01, $4b
	.byte .lobyte(@env19), .hibyte(@env19), $1b, $81, $73, $83, $77, $4b, .lobyte(@env52), .hibyte(@env52), $1b, $81, $73, $81
	.byte $7a, $4b, .lobyte(@env31), .hibyte(@env31), $4c, $9a, $01, $77, $4b, .lobyte(@env52), .hibyte(@env52), $86, $1b, $81
	.byte $73, $83, $77, $4b, .lobyte(@env53), .hibyte(@env53), $1b, $81, $73, $81, $7a, $4b, .lobyte(@env31), .hibyte(@env31)
	...
	.byte $87, $77, $4b, .lobyte(@env21), .hibyte(@env21), $86, $1b, $81, $73, $83, $77, $4d, $1b, $81, $73, $83, $4b, .lobyte(@env31)
	.byte .hibyte(@env31), $4c, $43, $1b, $81, $00, $81, $9a, $03, $85, $0d, $81, $00, $85, $03, $81, $0c, $81, $00, $81, $08
	.byte $81, $7f, $8e, $38, $81, $38, $77, $4b, .lobyte(@env55), .hibyte(@env55), $86, $1b, $7f, $4b, .lobyte(@env31), .hibyte(@env31)
	.byte $4c, $8e, $33, $73, $4b, .lobyte(@env55), .hibyte(@env55), $86, $1b, $7f, $4b, .lobyte(@env31), .hibyte(@env31), $4c
	.byte $8e, $33, $77, $4b, .lobyte(@env55), .hibyte(@env55), $86, $1b, $7f, $4b, .lobyte(@env31), .hibyte(@env31), $4c, $8e
	.byte $2c, $73, $4b, .lobyte(@env55), .hibyte(@env55), $86, $1b, $7f, $4b, .lobyte(@env31), .hibyte(@env31), $4c, $8e, $31
	.byte $43, $31, $32, $81, $33
@song0ref932:
...
@song0ref1412:
	...
	.byte .hibyte(@env11), $81, $81, $49, .lobyte(@env0), .hibyte(@env0), $4a, $86, $1d, $81, $20, $81, $49, .lobyte(@env49)
	.byte .hibyte(@env49), $81, $74, $81, $7a, $86, $22, $81, $75, $2e, $77, $43, $50, $47, $3a, $2b, $7a, $4f, $02, $1b, $83
	...
	.byte $81, $72, $81, $7a, $49, .lobyte(@env0), .hibyte(@env0), $4a, $86, $27, $81, $2a, $81, $79, $49, .lobyte(@env49), .hibyte(@env49)
...
@song0ref1977:
	...
	.byte $86, $1d, $81, $4d, $20, $81, $49, .lobyte(@env49), .hibyte(@env49), $81, $74, $81, $7a, $4d, $86, $22, $83, $75, $4b
...
@song0ref3355:
	...
	.byte $22, $81, $14, $85, $14, $85, $22, $81, $1b, $85, $17, $85
	.byte $41, $13
	.word @song0ref3355
@song0ref3394:
	.byte $81, $1e, $85, $13, $81, $13, $85, $14, $81, $14, $85, $20, $81, $20, $85, $15, $85, $1a, $85
@song0ref3413:
...
@song0ref3502:
	...
	.byte $41, $21
	.word @song0ref3451
	.byte $21, $81, $1a, $81, $22, $85, $14, $81, $00, $91
	.byte $41, $24
	.word @song0ref3452
	.byte $41, $0b
	.word @song0ref3502
...
@song2ref316:
	...
	.word @song2ref316
@song2ref356:
	.byte $4b, .lobyte(@env31), .hibyte(@env31), $4c, $4f, $01, $9e
@song2ref363:
...
@song2ref1019:
	...
	.byte $9c, $39, $8d, $84, $2d, $00, $28, $00, $21, $00, $28, $81
	.byte $41, $30
	.word @song2ref1019
...
@song2ref1159:
	...
	.byte $41, $40
	.word @song2ref1159
	.byte $86, $50, $f0, $18, $2c, $9d, $4e, $00, $a8
	.byte $41, $40
	.word @song2ref672
	.byte $4e, $00
	.byte $41, $40
	...
	.byte $41, $43
	.word @song2ref231
	.byte $91, $86, $21, $9d, $9f, $50, $f0, $18, $2c, $9d, $76, $9e
@song2ref1266:
