...
@instruments:
	.word @env17,@env4,@env23,@env0 ; 00 : rel hats
	.word @env6,@env4,@env34,@env0 ; 01 : hat
	.word @env7,@env35,@env23,@env0 ; 02 : kick
	.word @env18,@env22,@env1,@env0 ; 03 : snare
	.word @env13,@env8,@env23,@env0 ; 04 : stepdown
	.word @env21,@env24,@env23,@env0 ; 05 : clap
	.word @env15,@env19,@env23,@env0 ; 06 : blank
	.word @env36,@env4,@env1,@env0 ; 07 : cymbal
	.word @env13,@env19,@env23,@env0 ; 08 : DMC: drums + bass
	.word @env27,@env19,@env23,@env0 ; 09 : quiet bass
	.word @env15,@env19,@env3,@env0 ; 0a : electroman lead
	.word @env27,@env38,@env25,@env0 ; 0b : octave arp
	.word @env40,@env19,@env23,@env0 ; 0c : blank slower string
	.word @env39,@env19,@env23,@env0 ; 0d : blank instant decay
	.word @env12,@env19,@env23,@env0 ; 0e : blank instant more decay
	.word @env13,@env19,@env23,@env14 ; 0f : tom
	.word @env2,@env19,@env20,@env42 ; 10 : every end pluck lead
	.word @env9,@env19,@env10,@env0 ; 11 : shift string lite
	.word @env13,@env19,@env16,@env0 ; 12 : hex guitar 2
	.word @env28,@env5,@env23,@env0 ; 13 : tight triangle snare
	.word @env26,@env19,@env23,@env0 ; 14 : Every End Square
...
@song1ref7:
	...
	.byte $41, $40
	.word @song1ref7
	.byte $4f, $00, $50, $04, $14, $13, $9d, $0f, $8d, $76, $49, .lobyte(@env41), .hibyte(@env41), $22, $8b, $49, .lobyte(@env0)
...
@song1ref921:
	...
	.byte $4e, $00, $4f, $01, $98
@song1ref1011:
	.byte $1f, $95, $4b, .lobyte(@env32), .hibyte(@env32), $1f, $95, $4b, .lobyte(@env11), .hibyte(@env11), $1f, $8d, $4b, .lobyte(@env29)
	...
	.byte .hibyte(@env30), $1d, $9d, $4b, .lobyte(@env29), .hibyte(@env29), $1d, $9d, $4e, $00, $4b, .lobyte(@env19), .hibyte(@env19)
	.byte $4c, $4f, $01
	.byte $41, $14
	.word @song1ref1011
...
@song2ref1350:
	...
	.byte $00, $fd, $44, $00
@song3ch0:
	.byte $46, $03, $00, $81, $4b, .lobyte(@env29), .hibyte(@env29), $94
@song3ref9:
	...
	.byte $41, $15
	.word @song3ref9
	.byte $4d, $08, $45, $4d, $08, $45, $4b, .lobyte(@env19), .hibyte(@env19), $4c, $a2, $20, $bd, $9f, $45, $95, $4b, .lobyte(@env29)
	.byte .hibyte(@env29), $94
@song3ref99:
	.byte $0f
@song3ref100:
	.byte $85
...
@song3ch1:
	.byte $bf, $bf, $bf, $bf, $bf, $bf, $bf, $b7, $7a, $4e, $fe, $4b, .lobyte(@env29), .hibyte(@env29), $96
	.byte $41, $8b
	.word @song3ref99
	.byte $4d
	.byte $41, $1a
	...
	.byte $41, $18
	.word @song3ref101
	.byte $75, $4e, $00, $4b, .lobyte(@env19), .hibyte(@env19), $4c, $a4, $23, $85, $00, $81, $23, $83, $77, $00, $23, $83, $00
	.byte $23, $83, $00, $23, $83, $00, $81, $7a, $81, $23, $83, $00, $23, $83, $00, $7f, $24, $85, $00, $81, $24, $85, $00, $81
	.byte $24, $85, $00, $81, $23, $85, $00, $81, $23, $83, $00, $20, $85, $4b, .lobyte(@env29), .hibyte(@env29), $96
	.byte $41, $18
	.word @song3ref102
	.byte $41, $18
	.word @song3ref329
