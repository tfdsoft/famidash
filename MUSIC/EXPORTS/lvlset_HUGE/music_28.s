...
@instruments:
	...
	.word @env18,@env23,@env30,@env0 ; 0a : loud menu acc
	.word @env48,@env23,@env33,@env0 ; 0b : shift string
	.word @env51,@env23,@env30,@env0 ; 0c : blank slower string
	.word @env49,@env23,@env30,@env0 ; 0d : blank slower string loud
	.word @env41,@env23,@env32,@env0 ; 0e : piano_legacy
	.word @env1,@env23,@env30,@env0 ; 0f : echo
	.word @env14,@env23,@env30,@env0 ; 10 : DMC: drums + bass
	.word @env25,@env23,@env28,@env15 ; 11 : Kap lead piano
	.word @env14,@env23,@env20,@env0 ; 12 : hex guitar 2
	.word @env24,@env23,@env30,@env0 ; 13 : infernoplex_piano
	.word @env14,@env10,@env30,@env0 ; 14 : stepdown
	.word @env17,@env23,@env54,@env53 ; 15 : eve pluck lead
	.word @env14,@env23,@env32,@env0 ; 16 : Duty 2
	.word @env47,@env23,@env6,@env0 ; 17 : shift piano
	.word @env35,@env23,@env30,@env0 ; 18 : loud_infernoplex_piano
	.word @env19,@env23,@env4,@env0 ; 19 : electroman lead
...
@song0ref508:
	...
	.byte $8c, $05, $72, $81, $76, $81, $75, $81, $74, $81, $78, $b2, $05, $83, $77, $81, $79, $4f, $02, $92
@song0ref582:
	.byte $29, $76, $81, $79
@song0ref586:
...
@song0ref670:
	...
	.byte .lobyte(@env34), .hibyte(@env34), $27, $81, $96, $20, $81, $1d, $25, $81, $7d, $49, .lobyte(@env0), .hibyte(@env0)
...
@song2ref210:
	...
	.byte $94, $1c, $81, $9f, $00, $9d, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $a4
@song2ref302:
	...
	.byte $4b, .lobyte(@env23), .hibyte(@env23), $4c, $94, $1b, $85, $1b, $81, $1c, $81, $83, $14, $91, $7c, $4b, .lobyte(@env46)
	.byte .hibyte(@env46), $98, $25, $85, $4b, .lobyte(@env12), .hibyte(@env12), $23, $8d, $7f, $4b, .lobyte(@env23), .hibyte(@env23)
	.byte $4c, $94, $20, $85, $20, $81, $21, $81, $83, $1c, $91, $7c, $4b, .lobyte(@env44), .hibyte(@env44), $98, $25, $85, $4d
	.byte $23, $8d, $4b, .lobyte(@env37), .hibyte(@env37), $20, $8d, $4b, .lobyte(@env43), .hibyte(@env43), $21, $85, $7f, $4b
	.byte .lobyte(@env23), .hibyte(@env23), $4c, $94
	.byte $41, $09
	.word @song2ref79
	.byte $1e
	.byte $41, $0c
...
@song2ref633:
	...
	.byte $41, $0c
	.word @song2ref633
	.byte $4d, $27, $00, $7f, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $4f, $00, $94, $1e, $99
	.byte $41, $14
	.word @song2ref581
@song2ref678:
...
@song2ref926:
	...
	.byte $41, $11
	.word @song2ref926
	.byte $4d, $17, $81, $00, $99, $9f, $7f, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $9e
@song2ref989:
...
@song2ref1053:
	...
	.byte .hibyte(@env38), $1e, $8d, $77, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $9e
	.byte $41, $0c
	.word @song2ref1021
	.byte $7c, $4b, .lobyte(@env46), .hibyte(@env46), $98, $25, $85, $4b, .lobyte(@env12), .hibyte(@env12), $23, $8d, $4b, .lobyte(@env43)
	.byte .hibyte(@env43), $20, $8d, $77, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $9e
	.byte $41, $0c
	.word @song2ref1053
	.byte $7c, $4b, .lobyte(@env44), .hibyte(@env44), $98, $25, $85, $4d, $23, $8d, $4d, $20, $8d, $4b, .lobyte(@env12), .hibyte(@env12)
	.byte $21, $9d, $4d, $23, $9d, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $b0, $10, $81, $7b, $83, $7a, $83, $79, $83, $78
...
@song2ref1794:
	...
	.byte $41, $10
	.word @song2ref1791
	.byte $81, $23, $00, $1b, $81, $23, $00, $83, $23, $00, $83, $38, $38, $38, $38
	.byte $41, $4f
	.word @song2ref1728
	.byte $41, $0f
	.word @song2ref1731
	...
	.byte $41, $10
	.word @song2ref1791
	.byte $81, $38, $00, $1b, $81, $38, $00, $1b, $81, $38, $38, $38, $38, $38, $38, $38, $38
	.byte $41, $12
	.word @song2ref1760
	.byte $41, $10
	.word @song2ref1746
...
@song3ref319:
	...
	.byte $7a, $4e, $ff, $4f, $02, $94, $25, $89, $24, $89, $22, $89, $20, $89, $85, $25, $83, $24, $89, $22, $89, $20, $89, $a2
	.byte $41, $10
	.word @song3ref5
	.byte $41, $0f
	.word @song3ref260
