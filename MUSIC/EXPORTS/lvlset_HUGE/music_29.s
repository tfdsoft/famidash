...
@instruments:
	.word @env15,@env13,@env54,@env1 ; 00 : hat
	.word @env33,@env21,@env45,@env1 ; 01 : (G2) aggressive noise hat
	.word @env71,@env36,@env45,@env1 ; 02 : triangle pluck 2
	.word @env17,@env55,@env45,@env1 ; 03 : kick
	.word @env26,@env36,@env9,@env1 ; 04 : Piano
	.word @env3,@env36,@env45,@env1 ; 05 : echo
	.word @env16,@env35,@env5,@env1 ; 06 : snare 2
	.word @env70,@env36,@env45,@env38 ; 07 : every triangle
	.word @env31,@env43,@env5,@env1 ; 08 : snare
	.word @env10,@env65,@env45,@env1 ; 09 : (G2) aggressive noise snare
	.word @env49,@env32,@env45,@env1 ; 0a : (G2) aggressive noise kick
	.word @env28,@env36,@env45,@env1 ; 0b : blank
	.word @env51,@env36,@env45,@env1 ; 0c : triangle pluck 4
	.word @env40,@env36,@env45,@env1 ; 0d : triangle pluck
	.word @env30,@env13,@env45,@env1 ; 0e : rel hats
	.word @env57,@env13,@env5,@env1 ; 0f : cymbal
	.word @env23,@env36,@env29,@env11 ; 10 : growl Dubstep
	.word @env25,@env36,@env8,@env1 ; 11 : endgame lead
	.word @env42,@env36,@env45,@env1 ; 12 : triangle pluck mar
	.word @env7,@env36,@env8,@env1 ; 13 : growl inst decay
	.word @env27,@env36,@env45,@env1 ; 14 : DMC: drums + bass
	.word @env28,@env36,@env4,@env1 ; 15 : electroman lead 1
	.word @env23,@env41,@env50,@env72 ; 16 : growl Dubstep 1
	.word @env27,@env36,@env45,@env2 ; 17 : triangle drum
	.word @env67,@env36,@env45,@env1 ; 18 : blank slower string
	.word @env22,@env24,@env14,@env1 ; 19 : Instrument 3
	.word @env56,@env66,@env45,@env1 ; 1a : (G2) aggressive noise kick + crash
	.word @env37,@env36,@env45,@env1 ; 1b : infernoplex_piano
	.word @env47,@env36,@env45,@env1 ; 1c : quiet bass
	.word @env62,@env36,@env45,@env1 ; 1d : blank slower string loud
	.word @env63,@env36,@env64,@env1 ; 1e : piano duty
	.word @env48,@env36,@env45,@env1 ; 1f : loud_infernoplex_piano
	.word @env39,@env36,@env8,@env1 ; 20 : endgame lead string
	.word @env60,@env13,@env5,@env1 ; 21 : crash reverse
	.word @env6,@env36,@env46,@env1 ; 22 : sample
...
@song0ch0:
	.byte $46, $06
@song0ref3:
	.byte $4f, $02, $8a, $24, $81, $27, $81, $2e, $81, $2b, $81, $74, $24, $43, $2b, $78, $27, $81, $2e, $81, $2b, $81, $7c, $4f
...
@song0ref55:
	...
	.byte $7f, $4f, $02, $8a, $24, $81, $27, $81, $29, $81, $2b, $81, $74, $24, $43, $2b, $78, $27, $81, $29, $81, $2b, $81, $7c
...
@song0ref241:
	...
	.byte $41, $0e
	.word @song0ref241
	.byte $78, $9e, $1b, $81, $1a, $81, $16, $81, $74
@song0ref458:
...
@song0ch1:
	.byte $78, $4b, .lobyte(@env58), .hibyte(@env58), $4f, $01, $ba
@song0ref511:
	.byte $0f, $77, $83, $76, $85, $75, $87, $74, $87, $73, $83
@song0ref522:
	.byte $78, $4b, .lobyte(@env44), .hibyte(@env44), $0e, $77, $83, $76, $85, $75, $87, $74, $87, $73, $83, $78, $4b, .lobyte(@env53)
	.byte .hibyte(@env53), $0c
@song0ref542:
	.byte $77, $83, $76, $85, $75, $87, $74, $87, $73, $83, $87, $72, $8b, $71, $8b, $78, $4b, .lobyte(@env58), .hibyte(@env58)
	.byte $4f, $01, $0f, $77, $83, $76, $85, $75, $87, $74, $87, $73, $83, $78, $4b, .lobyte(@env53), .hibyte(@env53), $13, $77
	.byte $83, $76, $85, $75, $87, $74, $87, $73, $83, $78, $4b, .lobyte(@env12), .hibyte(@env12), $16
	.byte $41, $0e
	.word @song0ref542
	.byte $41, $1c
	.word @song0ref522
	...
	.word @song0ref542
@song0ref603:
	.byte $7f, $4b, .lobyte(@env58), .hibyte(@env58), $4f, $01, $0f
@song0ref610:
	.byte $7e, $81, $7d, $81, $7c, $81, $7b, $81, $7a, $83, $79, $83, $78, $85, $77, $85, $76, $81, $7f, $4b, .lobyte(@env44)
	.byte .hibyte(@env44), $0e
	.byte $41, $09
	.word @song0ref610
	.byte $7f, $4b, .lobyte(@env53), .hibyte(@env53), $0c
	.byte $41, $09
	.word @song0ref610
	.byte $87, $75, $89, $74, $89, $73, $83
	.byte $41, $0a
	.word @song0ref603
	.byte $7f, $4b, .lobyte(@env53), .hibyte(@env53), $13
	.byte $41, $09
	.word @song0ref610
	.byte $7f, $4b, .lobyte(@env12), .hibyte(@env12), $16
	.byte $41, $09
	.word @song0ref610
	.byte $87, $75, $89, $74, $89, $73, $83, $78, $4b, .lobyte(@env58), .hibyte(@env58), $4f, $01
	.byte $41, $22
	.word @song0ref511
	.byte $41, $0e
	.word @song0ref542
	...
	.byte $41, $08
	.word @song0ref542
	.byte $78, $4b, .lobyte(@env58), .hibyte(@env58), $1b, $9d, $77, $8f, $76, $8f, $75, $8f, $74, $8f, $73, $8b, $72, $8d, $71
	.byte $85, $00, $9d
@song0ref723:
...
@song0ch3:
	.byte $41, $0c
	.word @song0ref723
	.byte $74, $51, $01, $f0, $c4, $22, $9d, $9f, $9f, $97, $7c, $51, $03, $f0, $8c, $23, $23, $23, $23
@song0ref847:
	.byte $4f, $00
@song0ref849:
	.byte $86, $25, $81, $80, $1f, $1e, $8c, $21, $81, $80, $1f, $00, $83, $1f, $24, $8c, $21, $81, $80, $1f, $1e
	.byte $41, $0f
	.word @song0ref847
	.byte $41, $0f
	.word @song0ref847
...
@song0ref950:
	.byte $7f
@song0ref951:
	.byte $4f, $00, $86, $25, $81, $80, $21, $21, $21, $00, $86, $25, $81, $8c, $21, $81, $80, $21, $00, $21, $00, $21, $00, $86
	.byte $25, $81, $80, $20, $22, $86, $23, $81, $80, $22, $21, $8c, $20, $81, $80, $20, $00, $21, $00, $22, $00
	.byte $41, $20
	.word @song0ref951
	.byte $41, $20
	.word @song0ref951
	...
	.byte $41, $1c
	.word @song0ref951
	.byte $8c, $21, $78, $81, $7f, $4f, $01, $20, $7e, $21, $9e, $21, $85, $70, $51, $01, $40, $86, $25, $81
@song0ref1047:
	.byte $00
@song0ref1048:
	.byte $81, $25
@song0ref1050:
	...
	.byte $41, $0d
	.word @song0ref1047
	.byte $81, $25, $81, $00, $81, $c2, $50, $01, $37, $3c, $8d, $9f, $9e, $30, $85, $7c, $87, $78, $87, $76, $87, $74, $87, $73
...
@song0ref1267:
	...
	.byte $14, $14, $81, $27, $14, $27, $14, $19, $81, $27, $19, $83, $27, $19, $27, $19, $83, $27, $19, $27, $19, $20, $81, $27
	.byte $20, $81, $20, $27, $00, $27, $20, $20, $81, $27, $20, $27, $20, $1a, $81, $00, $1a, $81, $1a, $27, $21, $27, $00, $21
	.byte $81, $27, $21, $27, $15, $83, $27, $15, $81, $00, $27, $15, $27, $1b, $83, $27, $1b, $27, $1b, $00, $16, $27, $16, $27
	.byte $1c, $27, $1c, $27, $22, $27, $22, $27, $1d, $27, $1d, $27, $23, $27, $23, $27, $27, $27, $27, $27, $27, $27, $27, $27
...
@song2ch1:
	.byte $78, $b6, $2a, $45, $81, $2b, $45, $8d, $28, $45, $8d, $28, $45, $8d, $00, $8f
@song2ref497:
	.byte $7f
@song2ref498:
...
@song2ref1374:
	...
	.byte $41, $0c
	.word @song2ref1374
	.byte $96, $40, $4f, $83, $40, $4e, $83, $40, $4d, $83, $40, $4c, $83, $3f, $83, $9e, $3f, $95, $00, $89, $90, $33, $83, $00
...
@song2ch4:
	.byte $cd, $ff, $8f, $1a, $83, $1a, $83, $1a, $a1, $00, $dd, $ff, $8f, $3c, $83, $00, $83
@song2ref1699:
	.byte $10
@song2ref1700:
	.byte $83, $1d, $83, $00, $83, $1d, $83, $23, $83, $00, $83, $23, $83, $1d, $83, $00, $83, $1d, $83, $1b
@song2ref1720:
	.byte $83, $00, $83, $1b, $83, $1a, $83, $00, $83, $1a, $83, $1a, $83, $00, $83, $1a, $83, $1a, $83, $00, $83, $1a, $83, $3c
	.byte $83, $00, $83, $1c
	.byte $41, $13
	.word @song2ref1700
	.byte $3c
	...
	.byte $27
@song2ref1770:
	.byte $83, $00, $83, $1a, $83, $27
@song2ref1776:
	.byte $83, $00, $83, $1a
@song2ref1780:
	.byte $83, $27, $83, $00, $83, $10
@song2ref1786:
	.byte $83, $3c, $83, $00, $83, $1d, $83, $27, $83, $00, $83, $23
	.byte $41, $0b
	.word @song2ref1786
	.byte $1b, $83, $3c
	.byte $41, $0b
	.word @song2ref1770
@song2ref1807:
	.byte $3c, $83, $00, $83, $1a, $83, $27, $83, $00, $83, $1c
	.byte $41, $0c
	.word @song2ref1786
	.byte $41, $0b
	.word @song2ref1786
...
@song2ref1866:
	.byte $10
@song2ref1867:
	.byte $83, $27, $83, $00, $83, $24, $83, $3c, $83, $00, $83, $24
	.byte $41, $0b
	.word @song2ref1780
@song2ref1882:
	.byte $10, $83, $27, $83, $00, $83, $25, $83, $3c, $83, $00, $83, $25
	.byte $41, $0c
	.word @song2ref1867
	.byte $41, $0b
	.word @song2ref1780
	.byte $10, $83, $27, $83, $00, $83, $1d
	.byte $41, $0b
	.word @song2ref1786
...
@song2ref1942:
	.byte $3c
@song2ref1943:
	.byte $83, $1d, $83, $10, $83, $1a, $83, $1d, $83, $10, $83, $1a
	.byte $41, $0b
	.word @song2ref1943
	.byte $41, $0d
	.word @song2ref1942
	...
	.byte $41, $0b
	.word @song2ref1943
	.byte $3c, $83, $1d, $83, $10, $83, $1d, $83, $1e, $83, $0f, $83, $11, $83, $0f, $83, $10, $83, $1a, $83, $1c, $83, $25
@song2ref1993:
...
@song2ref2062:
	...
	.byte $83, $00, $c5, $44, $00
@song3ch0:
	.byte $46, $06, $77, $4b, .lobyte(@env52), .hibyte(@env52), $b8, $1f, $78, $81, $79, $81, $7a, $81, $7b, $81, $7c, $81, $7d
	.byte $81, $7e, $81, $7f, $4b, .lobyte(@env68), .hibyte(@env68), $26, $9d, $9f, $4b, .lobyte(@env69), .hibyte(@env69), $26
	.byte $9d, $9f, $4b, .lobyte(@env61), .hibyte(@env61), $2b, $9d, $9f, $4b, .lobyte(@env52), .hibyte(@env52), $2b, $9d, $4d
	.byte $1f, $9d, $4b, .lobyte(@env61), .hibyte(@env61), $be, $1f, $85, $4d, $1f, $81, $4d, $1f, $89, $4b, .lobyte(@env19)
	.byte .hibyte(@env19), $22, $85, $4b, .lobyte(@env59), .hibyte(@env59), $1f, $81, $4b, .lobyte(@env61), .hibyte(@env61), $1f
	.byte $89, $4b, .lobyte(@env19), .hibyte(@env19), $22, $85, $00, $81, $4b, .lobyte(@env61), .hibyte(@env61), $1f, $81, $87
	.byte $4d, $1f, $89, $4b, .lobyte(@env19), .hibyte(@env19), $22, $89, $4b, .lobyte(@env61), .hibyte(@env61), $1f, $89, $4b
	.byte .lobyte(@env19), .hibyte(@env19), $22, $89, $4b, .lobyte(@env61), .hibyte(@env61), $1f, $85, $4b, .lobyte(@env20), .hibyte(@env20)
...
@song3ref233:
	...
	.byte $83, $7a, $51, $06, $f0, $4b, .lobyte(@env52), .hibyte(@env52), $96, $26, $81, $4d, $50, $1a, $32, $20, $89, $7a, $51
...
@song3ref828:
	...
	.byte $15, $13, $81, $07, $85, $4b, .lobyte(@env52), .hibyte(@env52), $b0, $50, $30, $22, $17, $85, $00, $81, $4b, .lobyte(@env36)
...
@song3ref1223:
	...
	.byte $96, $50, $12, $37, $1a, $9d, $00, $9d, $9f, $9f, $ae, $25, $85, $00, $95, $a4, $26, $47, $01, $27, $81, $28, $29, $47
...
@song3ref1388:
	.byte $49, .lobyte(@env18), .hibyte(@env18), $96, $2e, $83, $00, $98, $2e, $00, $84, $2e, $9a, $2e, $96, $32, $83, $00, $98
	.byte $32, $00, $84, $32, $9a, $32, $96, $30, $83, $00, $98, $30, $00, $84, $30, $9a, $30, $96, $2d, $83, $00, $98, $2d, $00
	.byte $84, $2d, $9a, $2d, $96, $2e, $83, $00, $98, $2e, $00, $84, $2e, $9a, $2e, $96, $2b, $81, $00, $81, $98, $2b, $00, $84
	.byte $2b, $9a, $2b
@song3ref1458:
...
@song3ref1498:
	...
	.byte $23, $1f, $13, $00, $83, $49, .lobyte(@env18), .hibyte(@env18), $96, $22, $83, $00, $98, $22, $00, $84, $22, $9a, $22
	.byte $96, $26, $83, $00, $98, $26, $00, $84, $26, $9a, $26, $96, $24, $83, $00, $98, $24, $00, $84, $24, $9a, $24, $96, $21
	.byte $83, $00, $98, $21, $00, $84, $21, $9a, $21, $96, $1f, $81, $00, $81, $98, $1f, $00, $84, $1f, $9a, $1f, $00, $8d
	.byte $41, $20
	.word @song3ref1458
	.byte $41, $10
	.word @song3ref1479
	...
	.byte $30, $00, $96, $30, $81, $98, $2e, $00, $96, $32, $81, $98, $30, $00, $96, $2b, $81, $98, $2b, $81, $84, $2b, $81, $96
...
@song3ref1699:
	...
	.byte $41, $11
	.word @song3ref1695
	.byte $51, $01, $e0, $9e, $2a, $81, $9c, $30, $81, $90, $31, $81, $9c, $30
@song3ref1759:
	.byte $81, $86, $25, $81, $9c, $2f, $81, $90, $31, $81, $9c, $2f, $81, $86, $25, $81, $9c, $2f, $81, $90, $31, $81, $9c, $2f
	.byte $41, $10
	.word @song3ref1759
	.byte $41, $10
	.word @song3ref1759
	.byte $41, $09
	.word @song3ref1759
	.byte $75, $4b, .lobyte(@env59), .hibyte(@env59), $a8, $24, $85, $7e, $4b, .lobyte(@env36), .hibyte(@env36), $4c, $90, $31
	.byte $75, $4b, .lobyte(@env59), .hibyte(@env59), $a8, $24, $83, $7e, $4b, .lobyte(@env36), .hibyte(@env36), $4c, $86, $25
	.byte $75, $4b, .lobyte(@env59), .hibyte(@env59), $a8, $24, $83, $7e, $4b, .lobyte(@env36), .hibyte(@env36), $4c, $90, $31
	.byte $75, $4b, .lobyte(@env59), .hibyte(@env59), $a8, $24, $83, $51, $02, $c0, $4b, .lobyte(@env36), .hibyte(@env36), $4c
	.byte $96
	.byte $41, $10
	.word @song3ref1699
	.byte $7f, $9e, $2b, $9d, $9f
...
@song3ref1858:
	...
	.byte $82, $14, $85, $44, $00
@song3ch4:
	.byte $8f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $1b, $9d, $00, $9d, $1b, $9d, $00, $9d, $1b, $8d, $1b, $8d, $1b, $8d, $1b
	.byte $8d, $00, $9d, $9f, $27, $85, $1b, $85, $3c, $85, $1b
@song3ref2022:
	.byte $85, $27, $85
@song3ref2025:
	.byte $1b, $85, $3c, $85, $1b
@song3ref2030:
	.byte $85, $27, $85, $22, $85, $3c, $85, $22, $85, $27, $85, $1c, $85, $3c, $85, $1c
	.byte $41, $0b
	.word @song3ref2022
@song3ref2049:
	.byte $1b, $85, $3c, $85, $1b, $85, $27, $85, $24, $85, $3c, $85, $24, $85, $27, $85, $23, $85, $3c, $85, $23
	.byte $41, $0b
	.word @song3ref2022
	.byte $41, $15
	.word @song3ref2025
