...
@instruments:
	.word @env52,@env29,@env32,@env0 ; 00 : blank instant decay
	.word @env45,@env29,@env32,@env0 ; 01 : blank quiet
	.word @env14,@env11,@env40,@env0 ; 02 : hat
	.word @env26,@env31,@env3,@env0 ; 03 : snare
	.word @env25,@env11,@env32,@env0 ; 04 : rel hats
	.word @env2,@env29,@env32,@env0 ; 05 : echo
	.word @env15,@env41,@env32,@env0 ; 06 : kick
	.word @env19,@env29,@env32,@env0 ; 07 : blank instant more decay
	.word @env24,@env29,@env32,@env0 ; 08 : blank
	.word @env42,@env11,@env3,@env0 ; 09 : cymbal
	.word @env9,@env50,@env32,@env0 ; 0a : (G2) aggressive noise snare
	.word @env4,@env29,@env33,@env0 ; 0b : sample
	.word @env24,@env29,@env6,@env0 ; 0c : electroman lead
	.word @env43,@env29,@env32,@env0 ; 0d : piano
	.word @env36,@env29,@env32,@env0 ; 0e : Instrument 1
	.word @env20,@env29,@env7,@env0 ; 0f : endgame lead
	.word @env30,@env29,@env44,@env0 ; 10 : endorphin lead 2 but looped duty
	.word @env28,@env29,@env32,@env0 ; 11 : blank string
	.word @env46,@env29,@env34,@env0 ; 12 : shift string
	.word @env47,@env29,@env48,@env0 ; 13 : piano duty
	.word @env21,@env29,@env32,@env0 ; 14 : DMC: drums + bass
	.word @env25,@env29,@env32,@env0 ; 15 : Instrument 2
	.word @env21,@env29,@env32,@env1 ; 16 : Extreme pitch down
	.word @env37,@env51,@env32,@env0 ; 17 : octave arp [ no duty ]
	.word @env37,@env51,@env33,@env0 ; 18 : octave arp
	.word @env18,@env29,@env32,@env0 ; 19 : 02 but tri
	.word @env16,@env39,@env32,@env0 ; 1a : octave arp [ full volume]
	.word @env38,@env5,@env32,@env0 ; 1b : tight triangle kick
	.word @env20,@env29,@env22,@env0 ; 1c : polargeist bass
	.word @env27,@env29,@env32,@env0 ; 1d : triangle pluck 3
	.word @env49,@env29,@env32,@env0 ; 1e : menu acc
...
@song0ch1:
	.byte $7a, $49, .lobyte(@env13), .hibyte(@env13), $4f, $01, $a4
@song0ref249:
	.byte $0d, $97, $45, $83, $a4, $14, $97, $45, $83, $12, $97, $45, $83, $10, $8b, $45, $0f, $8b, $45, $49, .lobyte(@env13)
	...
	.byte $41, $12
	.word @song0ref249
	.byte $49, .lobyte(@env13), .hibyte(@env13), $4f, $01, $0d, $99, $45, $81, $a4, $14, $99, $45, $81, $10, $99, $45, $81, $49
	.byte .lobyte(@env23), .hibyte(@env23), $4f, $03, $a2, $0f, $99, $45, $81, $44, $00
@song0ch2:
	.byte $ba
@song0ref316:
...
@song3ch1:
	...
	.byte $41, $15
	.word @song3ref72
	.byte $9d, $bf, $bf, $bf, $bf, $4e, $00, $90, $28, $81, $2a, $81, $49, .lobyte(@env17), .hibyte(@env17), $8f, $49, .lobyte(@env0)
	.byte .hibyte(@env0), $4a, $90, $25, $81, $26, $49, .lobyte(@env17), .hibyte(@env17), $8d, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $90, $28, $81, $25, $49, .lobyte(@env17), .hibyte(@env17), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $90
	.byte $21, $81, $20, $81, $1e, $85, $49, .lobyte(@env17), .hibyte(@env17), $97, $45, $8d, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $00, $8d, $90, $28, $81, $2a, $49, .lobyte(@env17), .hibyte(@env17), $91, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $90, $2c, $81, $2d, $49, .lobyte(@env17), .hibyte(@env17), $8d, $49, .lobyte(@env0), .hibyte(@env0), $4a, $90
	.byte $2f, $81, $2c, $49, .lobyte(@env17), .hibyte(@env17), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $90, $2d, $81
...
@song5ref931:
	...
	.byte $44, $00
@song6ch0:
	.byte $46, $06, $74, $4b, .lobyte(@env35), .hibyte(@env35), $90, $20, $9d, $4b, .lobyte(@env10), .hibyte(@env10), $24, $9d
	.byte $4b, .lobyte(@env12), .hibyte(@env12), $21, $9d, $4b, .lobyte(@env35), .hibyte(@env35), $20, $9d, $4d, $20, $9d, $4b
	.byte .lobyte(@env10), .hibyte(@env10), $24, $9d, $4b, .lobyte(@env12), .hibyte(@env12), $21, $9d, $4b, .lobyte(@env35), .hibyte(@env35)
	.byte $20, $9d
@song6ref43:
	.byte $76, $4b, .lobyte(@env39), .hibyte(@env39), $4f, $00, $0d, $83, $00, $4d, $0d, $83, $00, $4b, .lobyte(@env29), .hibyte(@env29)
...
@song6ref94:
	...
	.byte .lobyte(@env10), .hibyte(@env10), $90, $19, $8b, $00, $4d, $18, $8b, $00
	.byte $41, $16
	.word @song6ref43
	.byte $7b, $50, $06, $38, $31
	.byte $41, $18
...
@song6ch1:
@song6ref174:
	.byte $4b, .lobyte(@env39), .hibyte(@env39), $80, $20, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29), $4c, $8a, $20, $00
	.byte $7f, $4b, .lobyte(@env39), .hibyte(@env39), $80, $20, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29), $4c, $8a, $20
	.byte $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $80, $25, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29), $4c, $8a
	.byte $25, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $80, $24, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29), $4c
	.byte $8a, $24, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $80, $20, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29)
	.byte $4c, $8a, $20, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $80, $20, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29)
	.byte $4c, $8a, $20, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $80, $24, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29)
	.byte $4c, $8a, $24, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $80, $21, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29)
	.byte $4c, $8a, $21, $00, $7f
	.byte $41, $10
	.word @song6ref174
@song6ref297:
	.byte $7f, $4b, .lobyte(@env39), .hibyte(@env39), $80, $27, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29), $4c, $8a, $27
	.byte $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $80, $25, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29), $4c, $8a
	.byte $25, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $80, $24, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29), $4c
	.byte $8a, $24, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $80, $21, $81, $7c, $4b, .lobyte(@env29), .hibyte(@env29)
	.byte $4c, $8a, $21, $00, $7f
	.byte $41, $20
	.word @song6ref174
	.byte $7f
	...
	.byte $41, $10
	.word @song6ref297
	.byte $4e, $00, $4b, .lobyte(@env12), .hibyte(@env12), $4f, $00, $90
@song6ref376:
...
@song6ref433:
	...
	.byte $90, $09, $8d, $08, $8d, $7c, $4e, $00, $4b, .lobyte(@env12), .hibyte(@env12), $4f, $00
	.byte $41, $18
	.word @song6ref376
...
@song6ref840:
	...
	.byte $19, $00, $84, $22, $22, $86, $21, $00, $84, $22, $22, $8c, $19, $00, $84, $22, $22, $86, $21, $84, $22, $92, $1f, $81
	.byte $41, $20
	.word @song6ref840
	.byte $41, $20
	.word @song6ref840
