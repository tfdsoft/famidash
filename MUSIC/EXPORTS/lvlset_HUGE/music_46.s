...
@instruments:
	...
	.word @env22,@env8,@env32,@env0 ; 02 : rel hats
	.word @env12,@env41,@env32,@env0 ; 03 : kick
	.word @env55,@env26,@env32,@env0 ; 04 : blank instant decay
	.word @env10,@env8,@env40,@env0 ; 05 : hat
	.word @env22,@env26,@env32,@env0 ; 06 : Instrument 2
	.word @env43,@env8,@env2,@env0 ; 07 : cymbal
	.word @env18,@env26,@env32,@env0 ; 08 : blank
	.word @env29,@env33,@env32,@env0 ; 09 : clap
	.word @env16,@env26,@env20,@env0 ; 0a : hex guitar 2
	.word @env3,@env26,@env34,@env0 ; 0b : sample
	.word @env18,@env26,@env5,@env0 ; 0c : electroman lead
	.word @env25,@env26,@env32,@env0 ; 0d : blank string
	.word @env15,@env26,@env6,@env0 ; 0e : endgame lead
	.word @env45,@env26,@env32,@env0 ; 0f : piano
	.word @env51,@env26,@env36,@env0 ; 10 : Instrument 4
	.word @env37,@env26,@env32,@env0 ; 11 : Instrument 5
	.word @env19,@env26,@env31,@env17 ; 12 : Kap lead
	.word @env16,@env26,@env32,@env0 ; 13 : DMC: drums + bass
	.word @env27,@env26,@env32,@env0 ; 14 : infernoplex_piano
	.word @env52,@env26,@env53,@env0 ; 15 : piano duty
	.word @env24,@env26,@env32,@env0 ; 16 : loud blank string
	.word @env11,@env26,@env32,@env0 ; 17 : clutterfunk sax
	.word @env14,@env39,@env32,@env0 ; 18 : octave arp [ full volume]
	.word @env38,@env4,@env32,@env0 ; 19 : tight triangle kick
...
@song0ref904:
	...
	.byte $1d, $85, $14, $89, $00, $91
@song0ref946:
	.byte $15, $89, $00, $89, $14, $85, $15, $89, $00, $89, $14, $85, $1b, $85, $21, $00, $83, $36, $85, $16, $85, $15, $85, $21
...
@song2ref628:
	...
	.word @song2ref628
@song2ref684:
	.byte $21, $81, $86, $1e, $81, $80, $23, $81, $21, $81, $92, $30, $81, $80, $21, $81, $21, $81, $23, $81, $78, $96, $16, $9d
	.byte $7c
	.byte $41, $20
	.word @song2ref627
	.byte $41, $20
...
@song4ref194:
	...
	.byte .hibyte(@env26), $4c, $8c, $2e, $81, $82, $2e
@song4ref242:
	.byte $81, $8c, $2e, $81, $82, $2e, $81, $8c, $2e, $81, $82, $2e, $81, $8c, $2e, $81, $82, $2e, $81, $8c, $2e, $81, $82, $2e
	.byte $81, $8c, $2e, $81, $82, $2e, $81, $8c, $2e, $81, $82, $2e, $81
@song4ref279:
	.byte $8c, $2e, $81, $82, $2e, $81, $8c, $2c, $81, $82, $2c, $81, $8c, $2c, $81, $82, $2c, $81, $8c, $2c, $81, $00, $81, $2c
	.byte $81, $82, $2c, $81, $8c, $2a, $81, $82, $2a, $81, $8c, $2a, $81, $82, $2a, $81, $8c, $29, $81, $82, $29, $81, $8c, $25
	.byte $81, $82, $25
	.byte $41, $1d
	.word @song4ref242
	.byte $41, $23
...
@song4ch1:
	...
	.byte $41, $18
	.word @song4ref88
	.byte $81, $4e, $00, $49, .lobyte(@env54), .hibyte(@env54), $4b, .lobyte(@env26), .hibyte(@env26), $4c, $90, $33, $bd, $9f
...
@song4ref506:
	.byte $4e, $00, $00, $85, $94, $27, $25, $27, $7f, $82, $25, $27, $7b, $25, $27, $77, $25, $27, $00, $8b, $94, $27, $25, $27
	.byte $7f, $82, $25, $27, $7a, $25, $27, $25, $77, $27, $00, $83
	.byte $41, $18
	.word @song4ref506
	.byte $41, $18
	.word @song4ref506
...
@song4ch4:
	.byte $bf, $bf, $bf, $bf
@song4ref853:
	.byte $21, $81, $1f, $81, $36, $81, $1f, $81, $21, $81, $1f, $81, $36, $81, $1f, $81, $21, $81, $1a, $81, $36, $81, $1a, $81
	...
	.word @song4ref853
@song4ref906:
	.byte $1d, $81, $1f, $81, $36, $81, $1f, $81, $1d, $81, $1f, $81, $36, $81, $1f, $81, $18, $81, $1a, $81, $36, $81, $1a, $81
	.byte $18, $81, $15, $81, $36, $81, $15, $81
	.byte $41, $20
	.word @song4ref906
	.byte $41, $20
	.word @song4ref906
...
@song6ch1:
@song6ref174:
	.byte $4b, .lobyte(@env39), .hibyte(@env39), $88, $20, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $82, $20, $00
	.byte $7f, $4b, .lobyte(@env39), .hibyte(@env39), $88, $20, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $82, $20
	.byte $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $88, $25, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $82
	.byte $25, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $88, $24, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c
	.byte $82, $24, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $88, $20, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26)
	.byte $4c, $82, $20, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $88, $20, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26)
	.byte $4c, $82, $20, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $88, $24, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26)
	.byte $4c, $82, $24, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $88, $21, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26)
	.byte $4c, $82, $21, $00, $7f
	.byte $41, $10
	.word @song6ref174
@song6ref297:
	.byte $7f, $4b, .lobyte(@env39), .hibyte(@env39), $88, $27, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $82, $27
	.byte $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $88, $25, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $82
	.byte $25, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $88, $24, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c
	.byte $82, $24, $00, $7f, $4b, .lobyte(@env39), .hibyte(@env39), $88, $21, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26)
	.byte $4c, $82, $21, $00, $7f
	.byte $41, $20
	.word @song6ref174
	.byte $7f
