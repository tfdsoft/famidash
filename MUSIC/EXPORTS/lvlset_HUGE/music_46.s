...
@instruments:
	.word @env47,@env22,@env26,@env0 ; 00 : blank instant decay
	.word @env41,@env22,@env26,@env0 ; 01 : blank quiet
	.word @env11,@env9,@env36,@env0 ; 02 : hat
	.word @env21,@env25,@env2,@env0 ; 03 : snare
	.word @env1,@env22,@env26,@env0 ; 04 : echo
	.word @env20,@env9,@env26,@env0 ; 05 : rel hats
	.word @env19,@env22,@env26,@env0 ; 06 : blank
	.word @env15,@env22,@env26,@env0 ; 07 : blank instant more decay
	.word @env12,@env37,@env26,@env0 ; 08 : kick
	.word @env38,@env9,@env2,@env0 ; 09 : cymbal
	.word @env7,@env45,@env26,@env0 ; 0a : (G2) aggressive noise snare
	.word @env3,@env22,@env27,@env0 ; 0b : sample
	.word @env19,@env22,@env5,@env0 ; 0c : electroman lead
	...
	.word @env39,@env22,@env26,@env0 ; 10 : piano
	.word @env24,@env22,@env40,@env0 ; 11 : endorphin lead 2 but looped duty
	.word @env20,@env22,@env26,@env0 ; 12 : Instrument 2
	.word @env17,@env22,@env26,@env0 ; 13 : DMC: drums + bass
	.word @env31,@env46,@env27,@env0 ; 14 : octave arp
	.word @env43,@env22,@env44,@env0 ; 15 : piano duty
	.word @env13,@env35,@env26,@env0 ; 16 : octave arp [ full volume]
	.word @env34,@env4,@env26,@env0 ; 17 : tight triangle kick
	.word @env16,@env22,@env6,@env0 ; 18 : endgame lead
	.word @env42,@env22,@env28,@env0 ; 19 : shift string
	.word @env16,@env22,@env18,@env0 ; 1a : polargeist bass
	.word @env14,@env22,@env26,@env0 ; 1b : 02 but tri
	.word @env48,@env22,@env26,@env0 ; 1c : blank slower string
...
@song5ch1:
@song5ref174:
	.byte $4b, .lobyte(@env35), .hibyte(@env35), $80, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $88, $20, $00
	.byte $7f, $4b, .lobyte(@env35), .hibyte(@env35), $80, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $88, $20
	.byte $00, $7f, $4b, .lobyte(@env35), .hibyte(@env35), $80, $25, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $88
	.byte $25, $00, $7f, $4b, .lobyte(@env35), .hibyte(@env35), $80, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c
	.byte $88, $24, $00, $7f, $4b, .lobyte(@env35), .hibyte(@env35), $80, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $88, $20, $00, $7f, $4b, .lobyte(@env35), .hibyte(@env35), $80, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $88, $20, $00, $7f, $4b, .lobyte(@env35), .hibyte(@env35), $80, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $88, $24, $00, $7f, $4b, .lobyte(@env35), .hibyte(@env35), $80, $21, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $88, $21, $00, $7f
	.byte $41, $10
	.word @song5ref174
@song5ref297:
	.byte $7f, $4b, .lobyte(@env35), .hibyte(@env35), $80, $27, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $88, $27
	.byte $00, $7f, $4b, .lobyte(@env35), .hibyte(@env35), $80, $25, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $88
	.byte $25, $00, $7f, $4b, .lobyte(@env35), .hibyte(@env35), $80, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c
	.byte $88, $24, $00, $7f, $4b, .lobyte(@env35), .hibyte(@env35), $80, $21, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $88, $21, $00, $7f
	.byte $41, $20
	.word @song5ref174
	.byte $7f
