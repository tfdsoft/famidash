...
@instruments:
	.word @env51,@env26,@env33,@env0 ; 00 : blank instant decay
	.word @env47,@env26,@env33,@env0 ; 01 : blank quiet
	.word @env23,@env9,@env33,@env0 ; 02 : rel hats
	.word @env12,@env9,@env42,@env0 ; 03 : hat
	.word @env25,@env32,@env3,@env0 ; 04 : snare
	.word @env14,@env43,@env33,@env0 ; 05 : kick
	.word @env2,@env26,@env33,@env0 ; 06 : echo
	.word @env7,@env49,@env33,@env0 ; 07 : (G2) aggressive noise snare
	.word @env40,@env10,@env33,@env0 ; 08 : tight triangle snare
	.word @env4,@env26,@env33,@env21 ; 09 : triangle drums
	.word @env17,@env26,@env33,@env0 ; 0a : blank instant more decay
	.word @env22,@env26,@env33,@env0 ; 0b : blank
	.word @env30,@env34,@env33,@env0 ; 0c : clap
	.word @env44,@env9,@env3,@env0 ; 0d : cymbal
	.word @env4,@env26,@env35,@env0 ; 0e : sample
	...
	.word @env31,@env26,@env46,@env0 ; 12 : endorphin lead 2 but looped duty
	.word @env19,@env26,@env33,@env1 ; 13 : Extreme pitch down
	.word @env23,@env26,@env33,@env0 ; 14 : Instrument 2
	.word @env27,@env26,@env33,@env0 ; 15 : infernoplex_piano
	.word @env19,@env26,@env33,@env0 ; 16 : DMC: drums + bass
	.word @env39,@env50,@env35,@env0 ; 17 : octave arp
	.word @env39,@env50,@env33,@env0 ; 18 : octave arp [ no duty ]
	.word @env13,@env26,@env29,@env0 ; 19 : TClead
	.word @env48,@env26,@env36,@env0 ; 1a : shift string
	.word @env16,@env26,@env33,@env0 ; 1b : 02 but tri
	.word @env18,@env26,@env20,@env0 ; 1c : polargeist bass
	.word @env45,@env26,@env24,@env28 ; 1d : TClead 1
...
@song0ref777:
	.byte $88, $14, $81, $86, $22, $22, $81, $22, $88, $14, $81, $86, $22, $84, $22, $81, $86, $22, $88, $14, $81, $86, $22, $22
	.byte $81, $22, $88, $14, $81, $86, $22, $84, $22, $81, $86, $22
	.byte $41, $18
	.word @song0ref777
	.byte $41, $18
	.word @song0ref777
	...
	.byte $81, $22, $88, $14, $83, $7c, $9c, $1f, $7a, $83, $74, $81, $71, $81, $70, $85, $44, $00
@song0ch4:
...
@song1ref352:
	.byte $98, $11
@song1ref354:
	.byte $85, $00, $85, $92, $25, $85, $90, $01, $85, $00, $85, $92, $25, $85, $00, $85, $90, $01, $85, $98, $0d
	.byte $41, $0f
	.word @song1ref354
	.byte $98, $0f
	.byte $41, $0f
	...
	.byte $41, $0f
	.word @song1ref354
	.byte $98, $18, $85, $00, $85, $92, $25, $85, $90, $01, $85, $00, $85, $44, $00
@song1ch3:
@song1ref495:
	.byte $8a, $14, $85, $84, $20, $85, $88, $14, $85, $84, $20, $85, $20, $85, $8a, $14, $85, $88, $14, $85, $84, $20, $85
	.byte $41, $10
	.word @song1ref495
	.byte $41, $10
	.word @song1ref495
	...
	.word @song1ref495
@song1ref539:
	.byte $8a, $14, $85, $84, $20, $85, $8e, $14, $85, $84, $20, $85, $20, $85, $8a, $14, $85, $8e, $14, $85, $84, $20, $85
	.byte $41, $10
	.word @song1ref539
	.byte $41, $10
	.word @song1ref539
...
@song1ref610:
	...
	.word @song1ref610
@song1ref635:
	.byte $28, $15, $83, $00, $85, $3d, $85, $15, $85, $00, $85, $28, $85, $3d, $8d, $28, $14, $83, $00, $85, $3d, $85, $14, $85
	.byte $00, $85, $28, $85, $3d, $8d, $28, $24, $83, $00, $85, $3d, $85, $24, $85, $00, $85, $28, $85, $3d, $8d, $28, $23, $83
	.byte $00, $85, $3d, $85, $23, $85, $00, $85, $28, $85, $3d, $8d
	.byte $41, $3c
	.word @song1ref635
	.byte $41, $3c
	.word @song1ref635
...
@song3ref627:
	...
	.byte $41, $14
	.word @song3ref625
	.byte $7f, $9a, $22, $85, $77, $88, $22, $81, $23, $81, $22, $81, $23, $81, $22, $81, $79
	.byte $41, $12
	.word @song3ref627
	.byte $7c
	.byte $41, $11
...
@song3ref724:
	.byte $20, $85
@song3ref726:
	.byte $88, $23, $81, $84, $20, $81, $8a, $16, $81, $84, $20, $20, $88, $23, $81, $84, $20, $81, $8a, $16, $81, $84, $20, $81
	.byte $88, $23, $81, $84, $20, $81, $8a, $16, $81, $84, $20, $20, $88, $23, $81, $84, $20, $81
	.byte $41, $1e
	.word @song3ref723
	...
	.word @song3ref726
@song3ref780:
	.byte $8a, $16, $81, $84, $20, $81, $88, $23, $81, $84, $20, $81, $8a, $16, $81, $84, $20, $81, $88, $23, $81, $84, $20, $81
	...
	.byte $41, $1e
	.word @song3ref723
	.byte $8a, $16, $81, $84, $20, $20, $88, $23, $81, $84, $20, $81, $8a, $16, $81, $84, $20, $20, $88, $23, $81, $84, $20, $81
...
@song4ref765:
	.byte $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $8e, $14, $85, $86, $20, $00, $20, $00
...
@song4ch4:
	.byte $ff, $ff
@song4ref851:
	.byte $28, $1b, $87, $28, $1b, $87, $28, $1b, $8b, $28, $1b, $83, $0f, $81, $1b, $81, $28, $1b, $83, $28, $1b, $87, $28, $1b
	.byte $87, $28, $1b, $8b, $28, $14, $83, $1f, $81, $1c, $81, $28, $1c, $83, $28, $19, $87, $28, $19, $87, $28, $19, $8b, $28
	.byte $19, $83, $25, $81, $19, $81, $28, $19, $83, $28, $1a, $87, $28, $1a, $87, $28, $1a, $8b, $28, $1a, $83, $1e, $81, $1a
	.byte $81, $28, $1e, $83
	.byte $41, $46
	.word @song4ref851
	.byte $8d
@song4ref931:
	.byte $28, $1b, $87, $28, $1b, $87, $28, $1b, $83, $3d, $1b, $83, $28, $1b, $83, $0f, $81, $1b, $81, $28, $1b, $83, $28, $1b
	.byte $87, $28, $1b, $87, $28, $1b, $83, $3d, $1b, $83, $28, $14, $83, $1f, $81, $1c, $81, $28, $1c, $83, $28, $19, $87, $28
	.byte $19, $87, $28, $19, $83, $3d, $19, $83, $28, $19, $83, $25, $81, $19, $81, $28, $19, $83, $28, $1a, $87, $28, $1a, $87
	.byte $28, $1a, $83, $3d, $1a, $83, $28, $1a, $83, $1e, $81, $1a, $81, $28, $1e, $83
	.byte $41, $58
	.word @song4ref931
	.byte $41, $58
	.word @song4ref931
...
@song5ch0:
	...
	.byte .lobyte(@env8), .hibyte(@env8), $24, $9d, $4b, .lobyte(@env11), .hibyte(@env11), $21, $9d, $4b, .lobyte(@env37), .hibyte(@env37)
	.byte $20, $9d
@song5ref43:
...
@song5ch1:
@song5ref174:
	.byte $4b, .lobyte(@env41), .hibyte(@env41), $80, $20, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $8c, $20, $00
	.byte $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $20, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $8c, $20
	.byte $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $25, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $8c
	.byte $25, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $24, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c
	.byte $8c, $24, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $20, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26)
	.byte $4c, $8c, $20, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $20, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26)
	.byte $4c, $8c, $20, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $24, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26)
	.byte $4c, $8c, $24, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $21, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26)
	.byte $4c, $8c, $21, $00, $7f
	.byte $41, $10
	.word @song5ref174
@song5ref297:
	.byte $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $27, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $8c, $27
	.byte $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $25, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c, $8c
	.byte $25, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $24, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26), $4c
	.byte $8c, $24, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $21, $81, $7c, $4b, .lobyte(@env26), .hibyte(@env26)
	.byte $4c, $8c, $21, $00, $7f
	.byte $41, $20
	.word @song5ref174
	.byte $7f
...
@song5ref840:
	.byte $1d, $81, $86, $22, $22, $88, $21, $00, $86, $22, $22, $8a, $19, $00, $86, $22, $22, $88, $21, $86, $22, $22, $22, $8a
	.byte $19, $00, $86, $22, $22, $88, $21, $00, $86, $22, $22, $8a, $19, $00, $86, $22, $22, $88, $21, $86, $22, $9a, $1f, $81
	.byte $41, $20
	.word @song5ref840
	.byte $41, $20
	.word @song5ref840
