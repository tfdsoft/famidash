...
@instruments:
	...
	.word @env22,@env11,@env13,@env0 ; 08 : menu acc
	.word @env10,@env11,@env13,@env0 ; 09 : triangle pluck 3
	.word @env6,@env4,@env19,@env0 ; 0a : hat
	.word @env20,@env11,@env1,@env0 ; 0b : cymbal no pitch
...
@song0ch0:
	.byte $46, $06, $79, $49, .lobyte(@env0), .hibyte(@env0), $4a, $4f, $02, $90, $0d, $0d, $19, $81, $20, $81, $25, $81, $28
	.byte $85
@song0ref21:
