...
@instruments:
	.word @env21,@env28,@env3,@env0 ; 00 : snare
	.word @env14,@env39,@env29,@env0 ; 01 : kick
	.word @env12,@env9,@env38,@env0 ; 02 : hat
	.word @env20,@env9,@env29,@env0 ; 03 : rel hats
	.word @env46,@env25,@env29,@env0 ; 04 : blank instant decay
	.word @env2,@env25,@env29,@env0 ; 05 : echo
	.word @env27,@env30,@env29,@env0 ; 06 : clap
	.word @env40,@env9,@env3,@env0 ; 07 : cymbal
	.word @env42,@env25,@env35,@env0 ; 08 : Instrument 4
	.word @env47,@env25,@env29,@env0 ; 09 : triangle pluck 2
	.word @env20,@env25,@env29,@env0 ; 0a : Instrument 2
	.word @env19,@env25,@env29,@env0 ; 0b : blank
	.word @env19,@env25,@env5,@env0 ; 0c : electroman lead
	.word @env4,@env25,@env31,@env0 ; 0d : sample
	.word @env13,@env25,@env29,@env0 ; 0e : clutterfunk sax
	...
	.word @env36,@env45,@env29,@env0 ; 13 : octave arp [ no duty ]
	...
	.word @env23,@env25,@env29,@env0 ; 18 : loud blank string
...
@song0ch4:
	.byte $ff, $ff
@song0ref635:
	.byte $24, $81, $15, $81, $38, $81, $15, $81, $24, $81, $15, $81, $38, $81, $16, $81, $24, $81, $22, $81, $38, $81, $22, $81
	.byte $24, $81, $22, $81, $38, $81, $22, $81, $24, $81, $14, $81, $38, $81, $14, $81, $24, $81, $14, $81, $38, $81, $14, $81
...
@song2ch1:
	...
	.byte $41, $15
	.word @song2ref72
	.byte $9d, $bf, $bf, $bf, $bf, $4e, $00, $96, $28, $81, $2a, $81, $49, .lobyte(@env15), .hibyte(@env15), $8f, $49, .lobyte(@env0)
	.byte .hibyte(@env0), $4a, $96, $25, $81, $26, $49, .lobyte(@env15), .hibyte(@env15), $8d, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $96, $28, $81, $25, $49, .lobyte(@env15), .hibyte(@env15), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $96
	.byte $21, $81, $20, $81, $1e, $85, $49, .lobyte(@env15), .hibyte(@env15), $97, $45, $8d, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $00, $8d, $96, $28, $81, $2a, $49, .lobyte(@env15), .hibyte(@env15), $91, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $96, $2c, $81, $2d, $49, .lobyte(@env15), .hibyte(@env15), $8d, $49, .lobyte(@env0), .hibyte(@env0), $4a, $96
	.byte $2f, $81, $2c, $49, .lobyte(@env15), .hibyte(@env15), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $96, $2d, $81
...
@song5ref70:
	...
	.byte $41, $10
	.word @song5ref53
	.byte $49, .lobyte(@env34), .hibyte(@env34), $22, $45, $9c, $25, $81, $45, $81, $20, $45, $22, $81, $45, $81, $50, $e9, $2e
...
@song5ref608:
	.byte $40, $01, $81, $94, $40, $0a, $81, $82, $40, $01, $81, $8e, $40, $0a, $83, $45, $94, $40, $0a, $81, $82, $40, $01, $81
...
@song5ref714:
	...
	.byte $41, $15
	.word @song5ref704
	.byte $40, $0a, $83, $45, $00, $85, $80, $03, $81, $00, $89, $8e, $40, $0a, $85, $94, $01, $81, $82, $40, $01, $81, $7b, $94
...
@song6ch0:
	.byte $46, $06, $74, $4b, .lobyte(@env33), .hibyte(@env33), $96, $20, $9d, $4b, .lobyte(@env8), .hibyte(@env8), $24, $9d
...
@song6ch1:
@song6ref174:
	.byte $4b, .lobyte(@env37), .hibyte(@env37), $88, $20, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25), $4c, $8a, $20, $00
	.byte $7f, $4b, .lobyte(@env37), .hibyte(@env37), $88, $20, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25), $4c, $8a, $20
	.byte $00, $7f, $4b, .lobyte(@env37), .hibyte(@env37), $88, $25, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25), $4c, $8a
	.byte $25, $00, $7f, $4b, .lobyte(@env37), .hibyte(@env37), $88, $24, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25), $4c
	.byte $8a, $24, $00, $7f, $4b, .lobyte(@env37), .hibyte(@env37), $88, $20, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25)
	.byte $4c, $8a, $20, $00, $7f, $4b, .lobyte(@env37), .hibyte(@env37), $88, $20, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25)
	.byte $4c, $8a, $20, $00, $7f, $4b, .lobyte(@env37), .hibyte(@env37), $88, $24, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25)
	.byte $4c, $8a, $24, $00, $7f, $4b, .lobyte(@env37), .hibyte(@env37), $88, $21, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25)
	.byte $4c, $8a, $21, $00, $7f
	.byte $41, $10
	.word @song6ref174
@song6ref297:
	.byte $7f, $4b, .lobyte(@env37), .hibyte(@env37), $88, $27, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25), $4c, $8a, $27
	.byte $00, $7f, $4b, .lobyte(@env37), .hibyte(@env37), $88, $25, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25), $4c, $8a
	.byte $25, $00, $7f, $4b, .lobyte(@env37), .hibyte(@env37), $88, $24, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25), $4c
	.byte $8a, $24, $00, $7f, $4b, .lobyte(@env37), .hibyte(@env37), $88, $21, $81, $7c, $4b, .lobyte(@env25), .hibyte(@env25)
	.byte $4c, $8a, $21, $00, $7f
	.byte $41, $20
	.word @song6ref174
	.byte $7f
...
@song6ref968:
	...
	.word @song6ref968
@song6ref1021:
	.byte $14, $85, $17, $00, $83, $1a, $85, $0f, $00, $83, $13, $85, $16, $00, $83, $21, $85, $23, $00, $83
	.byte $41, $14
	.word @song6ref1021
	.byte $41, $14
	.word @song6ref1021
...
@song7ch0:
	.byte $46, $06, $49, .lobyte(@env7), .hibyte(@env7), $4f, $02, $a0, $0f, $9d, $72, $49, .lobyte(@env0), .hibyte(@env0), $4a
...
@song7ref34:
	...
	.byte $44, $00
@song7ch1:
	.byte $49, .lobyte(@env18), .hibyte(@env18), $4f, $03, $a0, $0f, $9d, $49, .lobyte(@env11), .hibyte(@env11), $4f, $01, $ac
...
@song7ref363:
	.byte $24, $81, $38, $85, $24, $81, $24, $24, $83, $38, $81, $24, $85, $38, $38, $38, $38, $24, $81, $24, $38, $81, $24, $38
	.byte $81, $24, $81
	.byte $41, $1b
	.word @song7ref363
	.byte $41, $1b
