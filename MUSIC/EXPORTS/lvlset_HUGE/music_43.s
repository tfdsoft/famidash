...
@instruments:
	.word @env51,@env27,@env32,@env0 ; 00 : blank instant decay
	.word @env46,@env27,@env32,@env0 ; 01 : blank quiet
	.word @env24,@env31,@env3,@env0 ; 02 : snare
	.word @env15,@env43,@env32,@env0 ; 03 : kick
	.word @env13,@env9,@env42,@env0 ; 04 : hat
	.word @env23,@env9,@env32,@env0 ; 05 : rel hats
	.word @env2,@env27,@env32,@env0 ; 06 : echo
	.word @env44,@env9,@env3,@env0 ; 07 : cymbal
	.word @env28,@env27,@env32,@env0 ; 08 : infernoplex_piano
	.word @env22,@env27,@env32,@env0 ; 09 : blank
	.word @env17,@env27,@env32,@env0 ; 0a : blank instant more decay
	.word @env29,@env33,@env32,@env0 ; 0b : clap
	.word @env7,@env49,@env32,@env0 ; 0c : (G2) aggressive noise snare
	.word @env22,@env27,@env5,@env0 ; 0d : electroman lead
	.word @env29,@env27,@env32,@env0 ; 0e : clap no app
	.word @env38,@env27,@env32,@env39 ; 0f : jaezu lead
	.word @env4,@env27,@env34,@env0 ; 10 : sample
	.word @env18,@env27,@env6,@env0 ; 11 : endgame lead
	.word @env30,@env27,@env45,@env0 ; 12 : endorphin lead 2 but looped duty
	.word @env19,@env27,@env32,@env1 ; 13 : Extreme pitch down
	.word @env37,@env50,@env32,@env0 ; 14 : octave arp [ no duty ]
	.word @env18,@env27,@env21,@env0 ; 15 : polargeist bass
	.word @env48,@env27,@env32,@env0 ; 16 : menu acc
	.word @env14,@env27,@env32,@env0 ; 17 : clutterfunk sax
	.word @env26,@env27,@env32,@env0 ; 18 : loud blank string
	.word @env40,@env10,@env32,@env0 ; 19 : tight triangle snare
	.word @env25,@env27,@env32,@env0 ; 1a : triangle pluck 3
	.word @env47,@env27,@env35,@env0 ; 1b : shift string
	.word @env52,@env27,@env32,@env0 ; 1c : blank slower string
	.word @env19,@env27,@env32,@env0 ; 1d : DMC: drums + bass
...
@song0ref145:
	...
	.byte $44, $00
@song0ch1:
	.byte $7a, $49, .lobyte(@env12), .hibyte(@env12), $4f, $01, $b6
@song0ref208:
	.byte $10, $97, $45, $83, $b6, $15, $97, $45, $83, $10, $97, $45, $83, $13, $8b, $45, $15, $8b, $45, $49, .lobyte(@env12)
...
@song0ref383:
	...
	.byte $7c
@song0ref452:
	.byte $20, $21, $90, $22, $81, $7a, $84, $1f, $7c, $88, $21, $7a, $90, $22, $81, $88, $21, $7c, $21, $90, $22, $7a, $88, $1f
	.byte $7c, $84, $1f, $00, $78, $90, $23, $7a, $22, $88, $23, $81, $7c, $90, $22, $81, $7a, $84, $1f, $7c, $88, $21, $7a, $90
	.byte $22, $88, $1e, $81, $7c, $1d, $90, $22, $7a, $81, $84, $1f, $90, $22, $7c, $84, $1f, $1f, $88, $20, $21, $90, $22, $81
	.byte $7a, $84, $1f, $7c, $88, $21, $7a, $90, $22, $88, $21, $81, $7c, $21, $90, $22, $7a, $88, $1f, $7c, $84, $1f, $81, $78
	.byte $90, $23, $7a, $22, $88, $23, $81, $7c, $90, $22, $81, $7a, $84, $1f, $7c, $90, $22, $7a, $88, $1c, $84, $1f, $90, $22
	.byte $7c, $84, $1f, $00, $7a, $90, $22, $84, $1f, $1f, $7c, $1f, $78, $1f, $7c, $88
	.byte $41, $40
	.word @song0ref452
	.byte $44, $00
@song0ch4:
...
@song2ch1:
	...
	.byte $41, $15
	.word @song2ref72
	.byte $9d, $bf, $bf, $bf, $bf, $4e, $00, $92, $28, $81, $2a, $81, $49, .lobyte(@env16), .hibyte(@env16), $8f, $49, .lobyte(@env0)
	.byte .hibyte(@env0), $4a, $92, $25, $81, $26, $49, .lobyte(@env16), .hibyte(@env16), $8d, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $92, $28, $81, $25, $49, .lobyte(@env16), .hibyte(@env16), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $92
	.byte $21, $81, $20, $81, $1e, $85, $49, .lobyte(@env16), .hibyte(@env16), $97, $45, $8d, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $00, $8d, $92, $28, $81, $2a, $49, .lobyte(@env16), .hibyte(@env16), $91, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $92, $2c, $81, $2d, $49, .lobyte(@env16), .hibyte(@env16), $8d, $49, .lobyte(@env0), .hibyte(@env0), $4a, $92
	.byte $2f, $81, $2c, $49, .lobyte(@env16), .hibyte(@env16), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $92, $2d, $81
	.byte $2c, $81, $2a, $49, .lobyte(@env16), .hibyte(@env16), $9d, $45, $8d, $00, $8d, $97, $a2
@song2ref409:
...
@song2ref724:
	.byte $20, $85
@song2ref726:
	.byte $84, $23, $81, $8a, $20, $81, $86, $16, $81, $8a, $20, $20, $84, $23, $81, $8a, $20, $81, $86, $16, $81, $8a, $20, $81
	.byte $84, $23, $81, $8a, $20, $81, $86, $16, $81, $8a, $20, $20, $84, $23, $81, $8a, $20, $81
	.byte $41, $1e
	.word @song2ref723
	.byte $86, $16, $81, $8a, $20, $81
	.byte $41, $1c
	.word @song2ref726
@song2ref780:
	.byte $86, $16, $81, $8a, $20, $81, $84, $23, $81, $8a, $20, $81, $86, $16, $81, $8a, $20, $81, $84, $23, $81, $8a, $20, $81
	...
	.byte $41, $1e
	.word @song2ref723
	.byte $86, $16, $81, $8a, $20, $20, $84, $23, $81, $8a, $20, $81, $86, $16, $81, $8a, $20, $20, $84, $23, $81, $8a, $20, $81
...
@song3ref627:
	.byte $84
@song3ref628:
	.byte $21, $81, $79, $86, $1e, $81, $7c, $84, $23, $81, $21, $81, $7f, $96, $30, $81, $7c, $84, $21, $81, $23, $81, $21, $81
	.byte $79, $86, $1e, $81, $7c, $84, $21, $81, $23, $81, $21, $81, $7f, $96, $30, $81, $79, $86, $1e, $81, $7c, $84, $23, $81
	.byte $21, $81
	.byte $41, $20
	.word @song3ref628
	.byte $41, $20
	.word @song3ref628
@song3ref684:
	.byte $21, $81, $86, $1e, $81, $84, $23, $81, $21, $81, $96, $30, $81, $84, $21, $81, $21, $81, $23, $81, $78, $a0, $16, $9d
	.byte $7c
	.byte $41, $20
	.word @song3ref627
	.byte $41, $20
...
@song4ref503:
	.byte $19, $85, $00, $81, $19, $85, $00, $81, $1b, $85, $00, $81, $1b, $85, $00, $81, $9c, $1b, $85, $1b, $85, $92, $14, $85
...
@song5ch1:
	...
	.byte $83, $4e, $00, $4f, $02, $93, $aa, $23, $25, $26, $85, $28, $81, $26, $81, $25, $81, $2a, $81, $28, $81, $26, $81, $2b
...
@song5ref765:
	.byte $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $20, $00, $98, $14, $85, $88, $20, $00, $20, $00
...
@song5ref931:
	...
	.byte $44, $00
@song6ch0:
	.byte $46, $06, $74, $4b, .lobyte(@env36), .hibyte(@env36), $92, $20, $9d, $4b, .lobyte(@env8), .hibyte(@env8), $24, $9d
	.byte $4b, .lobyte(@env11), .hibyte(@env11), $21, $9d, $4b, .lobyte(@env36), .hibyte(@env36), $20, $9d, $4d, $20, $9d, $4b
	.byte .lobyte(@env8), .hibyte(@env8), $24, $9d, $4b, .lobyte(@env11), .hibyte(@env11), $21, $9d, $4b, .lobyte(@env36), .hibyte(@env36)
	.byte $20, $9d
@song6ref43:
...
@song6ch1:
@song6ref174:
	.byte $4b, .lobyte(@env41), .hibyte(@env41), $80, $20, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c, $8c, $20, $00
	.byte $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $20, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c, $8c, $20
	.byte $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $25, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c, $8c
	.byte $25, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $24, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c
	.byte $8c, $24, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $20, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $8c, $20, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $20, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $8c, $20, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $24, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $8c, $24, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $21, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $8c, $21, $00, $7f
	.byte $41, $10
	.word @song6ref174
@song6ref297:
	.byte $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $27, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c, $8c, $27
	.byte $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $25, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c, $8c
	.byte $25, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $24, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27), $4c
	.byte $8c, $24, $00, $7f, $4b, .lobyte(@env41), .hibyte(@env41), $80, $21, $81, $7c, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $8c, $21, $00, $7f
	.byte $41, $20
	.word @song6ref174
	.byte $7f
...
@song6ref538:
	.byte $80, $19, $7c, $4d, $8c, $19, $7f, $4d, $80, $18, $7c, $4d, $8c, $18, $7f, $4d, $80, $1c, $7c, $4d, $8c, $1c, $7f, $4d
	.byte $80, $18, $7c, $4d, $8c, $18, $7f, $4d, $80, $1b, $7c, $4d, $8c, $1b, $7f, $4d, $80, $19, $7c, $4d, $8c, $19, $7f, $4d
	.byte $80, $15, $7c, $4d, $8c, $15, $7f, $4d, $80, $14, $7c, $4d, $8c, $14, $7f, $4d, $80, $18, $7c, $4d, $8c, $18, $7f, $4d
	.byte $80, $14, $7c, $4d, $8c, $14, $7f, $4d, $80, $19, $7c, $4d, $8c, $19, $7f, $4d, $80, $14, $7c, $4d, $8c, $14, $7f, $4d
	.byte $80, $1b, $7c, $4d, $8c, $1b, $7f, $4d, $80, $14, $7c, $4d, $8c, $14, $7f, $4d, $80, $1c, $7c, $4d, $8c, $1c, $7f, $4d
	.byte $80, $18, $7c, $4d, $8c, $18, $7f, $4d
	.byte $41, $20
	.word @song6ref538
	.byte $7f, $4d
	.byte $41, $20
...
@song6ref840:
	.byte $1d, $81, $88, $22, $22, $84, $21, $00, $88, $22, $22, $86, $19, $00, $88, $22, $22, $84, $21, $88, $22, $22, $22, $86
	.byte $19, $00, $88, $22, $22, $84, $21, $00, $88, $22, $22, $86, $19, $00, $88, $22, $22, $84, $21, $88, $22, $8e, $1f, $81
	.byte $41, $20
	.word @song6ref840
	.byte $41, $20
	.word @song6ref840
