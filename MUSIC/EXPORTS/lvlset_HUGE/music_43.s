...
@instruments:
	...
	.word @env15,@env35,@env17,@env0 ; 14 : shift string lite
	.word @env43,@env35,@env39,@env0 ; 15 : Instrument 1
	.word @env31,@env9,@env39,@env0 ; 16 : rel hats
	.word @env58,@env35,@env39,@env0 ; 17 : menu acc
	.word @env3,@env35,@env39,@env27 ; 18 : triangle drums
	.word @env29,@env35,@env38,@env24 ; 19 : Kap lead
	.word @env26,@env35,@env42,@env0 ; 1a : shift string loud
	.word @env33,@env35,@env39,@env0 ; 1b : triangle pluck 3
	.word @env5,@env35,@env46,@env0 ; 1c : xstep wub
...
@song0ref11:
	...
	.byte $41, $30
	.word @song0ref11
	.byte $49, .lobyte(@env8), .hibyte(@env8), $4f, $02, $92, $09, $8b, $43, $0b, $8b, $45, $81, $44, $00
@song0ch1:
	.byte $7a, $49, .lobyte(@env11), .hibyte(@env11), $4f, $01, $a0
@song0ref143:
	.byte $0d, $97, $45, $83, $a0, $0b, $97, $45, $83, $0a, $97, $45, $83, $09, $8b, $45, $0b, $8b, $45, $49, .lobyte(@env11)
	...
	.byte $41, $12
	.word @song0ref143
	.byte $49, .lobyte(@env11), .hibyte(@env11), $4f, $01, $0d, $99, $45, $81, $a0, $0b, $99, $45, $81, $0a, $99, $45, $81, $49
	.byte .lobyte(@env25), .hibyte(@env25), $4f, $03, $92, $09, $8b, $43, $0b, $8b, $45, $81, $44, $00
@song0ch2:
	.byte $b6
@song0ref213:
...
@song5ch0:
	.byte $46, $03, $71, $4f, $01, $a0, $1b, $95, $7f, $4b, .lobyte(@env21), .hibyte(@env21), $ae
@song5ref14:
	...
	.byte $41, $18
	.word @song5ref14
	.byte $89, $4b, .lobyte(@env35), .hibyte(@env35), $4c, $4f, $01, $b4
@song5ref121:
