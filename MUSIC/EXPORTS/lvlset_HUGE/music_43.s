...
@instruments:
	.word @env12,@env8,@env53,@env0 ; 00 : hat
	.word @env13,@env54,@env41,@env0 ; 01 : kick
	.word @env56,@env8,@env2,@env0 ; 02 : cymbal
	.word @env33,@env40,@env2,@env0 ; 03 : snare
	.word @env32,@env35,@env41,@env0 ; 04 : blank
	.word @env38,@env42,@env41,@env0 ; 05 : clap
	.word @env57,@env35,@env41,@env0 ; 06 : tight noise kick layer
	.word @env1,@env35,@env41,@env0 ; 07 : echo
	.word @env37,@env35,@env41,@env0 ; 08 : triangle pluck
	.word @env34,@env35,@env41,@env0 ; 09 : triangle pluck 3
	.word @env65,@env35,@env41,@env0 ; 0a : blank slower string
	.word @env21,@env35,@env41,@env0 ; 0b : cut string
	.word @env4,@env42,@env41,@env0 ; 0c : clap fast decay
	.word @env18,@env23,@env10,@env0 ; 0d : Instrument 3
	.word @env52,@env6,@env41,@env0 ; 0e : tight triangle kick
	.word @env47,@env63,@env43,@env0 ; 0f : octave arp
	.word @env52,@env9,@env41,@env0 ; 10 : tight triangle snare
	.word @env60,@env35,@env44,@env0 ; 11 : shift string
	.word @env50,@env35,@env41,@env51 ; 12 : jaezu lead
	.word @env24,@env35,@env7,@env0 ; 13 : Piano
	.word @env64,@env35,@env41,@env0 ; 14 : blank instant decay
	.word @env26,@env35,@env41,@env0 ; 15 : DMC: drums + bass
	.word @env16,@env35,@env19,@env0 ; 16 : shift string lite
	.word @env3,@env35,@env41,@env31 ; 17 : triangle drums
	.word @env45,@env35,@env41,@env0 ; 18 : Instrument 1
	.word @env62,@env35,@env41,@env0 ; 19 : menu acc
	.word @env5,@env35,@env48,@env0 ; 1a : xstep wub
	.word @env68,@env35,@env46,@env0 ; 1b : death moon lead
	.word @env36,@env35,@env41,@env0 ; 1c : infernoplex_piano
	.word @env29,@env35,@env44,@env0 ; 1d : shift string loud
...
@song1ch1:
	...
	.byte $1e, $72, $88, $25, $76, $8e, $25, $72, $88, $1e, $7a, $4b, .lobyte(@env14), .hibyte(@env14), $a2, $19, $9d, $4d, $14
	.byte $9d, $4b, .lobyte(@env61), .hibyte(@env61), $16, $9d, $4b, .lobyte(@env14), .hibyte(@env14), $12, $9d, $4d, $19, $9d
	.byte $4d, $14, $9d, $4b, .lobyte(@env61), .hibyte(@env61), $16, $9d, $4b, .lobyte(@env14), .hibyte(@env14), $12, $9d, $45
	.byte $9d, $7c, $4b, .lobyte(@env35), .hibyte(@env35), $4c, $4f, $03, $a8
@song1ref717:
...
@song2ref700:
	...
	.byte $41, $0a
	.word @song2ref700
	.byte $1d, $85, $1d, $85, $1f, $85, $1b, $85, $9c, $01, $88, $16, $83, $a0, $01, $88, $12, $83, $9c, $01, $88, $11, $83, $a0
	.byte $01, $88, $11, $00, $81, $9c, $01, $88, $12, $83, $a0, $01, $88, $12, $83, $9c, $01, $88, $16, $83, $a0, $01, $88, $16
	.byte $00, $81, $9c, $01, $88, $16, $83, $a0, $01, $88, $12, $83, $9c, $01, $88, $11, $00, $81, $a0, $01, $88, $11, $00, $81
	.byte $9c, $01, $88, $16, $83, $a0, $01, $88, $16, $83, $18, $85, $14, $85, $00, $8d, $44, $00
@song2ch3:
...
@song4ch1:
	.byte $ff, $ff, $bf, $4b, .lobyte(@env14), .hibyte(@env14), $b8
@song4ref203:
	.byte $1c, $83, $00, $83, $4d, $1c, $83, $00, $8b, $4b, .lobyte(@env66), .hibyte(@env66), $19, $83, $00, $4d, $19, $81, $4b
	.byte .lobyte(@env67), .hibyte(@env67), $19, $83, $00, $8b, $bf, $4b, .lobyte(@env14), .hibyte(@env14)
	.byte $41, $0b
	.word @song4ref203
...
@song4ref344:
	...
	.byte $85, $2f, $85, $31, $8d, $33, $85, $36, $83, $00, $9a, $36, $88, $38, $83, $49, .lobyte(@env15), .hibyte(@env15), $83
	.byte $49, .lobyte(@env49), .hibyte(@env49), $83, $49, .lobyte(@env39), .hibyte(@env39), $83, $49, .lobyte(@env28), .hibyte(@env28)
...
@song5ch0:
	.byte $46, $03, $71, $4f, $01, $a2, $1b, $95, $7f, $4b, .lobyte(@env25), .hibyte(@env25), $b2
@song5ref14:
	.byte $1b, $89, $00, $81, $4d, $1b, $89, $00, $81, $4d, $1b, $89, $00, $81, $4b, .lobyte(@env22), .hibyte(@env22), $1b, $89
	.byte $00, $81, $8f, $4b, .lobyte(@env25), .hibyte(@env25), $1b, $89, $00, $81, $4b, .lobyte(@env22), .hibyte(@env22), $1b
	.byte $89, $4d, $1b, $8d, $00, $81, $4b, .lobyte(@env25), .hibyte(@env25)
	.byte $41, $15
	.word @song5ref14
	.byte $4b, .lobyte(@env27), .hibyte(@env27), $1b, $89, $4b, .lobyte(@env22), .hibyte(@env22), $1b, $8d, $00, $81, $4b, .lobyte(@env25)
	...
	.byte $41, $18
	.word @song5ref14
	.byte $89, $4b, .lobyte(@env35), .hibyte(@env35), $4c, $4f, $01, $ba
@song5ref121:
	...
	.byte $41, $18
	.word @song5ref121
	.byte $78, $4e, $00, $87, $4b, .lobyte(@env70), .hibyte(@env70), $a8, $2a, $85, $4d, $2a, $89, $4d, $29, $85, $4d, $29, $89
	.byte $4d, $25, $85, $00, $85, $7d, $4b, .lobyte(@env35), .hibyte(@env35), $4c, $a4
@song5ref217:
...
@song5ref299:
	...
	.byte $00, $72, $4d, $0b, $81, $00, $81, $75, $4d, $0b, $83, $00, $72, $4d, $0b, $81, $00, $81, $75, $4b, .lobyte(@env17)
	.byte .hibyte(@env17), $0d, $83, $00, $72, $4d, $0d, $81, $00, $81, $75, $4d, $0d, $83, $00, $72, $4d, $0d, $81, $00, $81
