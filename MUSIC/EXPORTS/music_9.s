...
@instruments:
	...
	.word @env38,@env22,@env28,@env0 ; 03 : Instrument 4
	.word @env41,@env22,@env24,@env0 ; 04 : triangle pluck 2
	.word @env17,@env22,@env24,@env0 ; 05 : Instrument 2
	.word @env32,@env6,@env2,@env0 ; 06 : cymbal
	.word @env1,@env22,@env24,@env0 ; 07 : echo
	.word @env21,@env22,@env24,@env0 ; 08 : blank string
	.word @env9,@env22,@env24,@env0 ; 09 : clutterfunk sax
	.word @env3,@env22,@env25,@env0 ; 0a : sample
	.word @env20,@env22,@env24,@env0 ; 0b : loud blank string
	.word @env15,@env22,@env24,@env0 ; 0c : blank
	.word @env29,@env22,@env24,@env0 ; 0d : quiet bass
	.word @env19,@env22,@env24,@env0 ; 0e : triangle pluck 3
	.word @env12,@env22,@env4,@env0 ; 0f : endgame lead
	.word @env40,@env22,@env24,@env0 ; 10 : menu acc
	.word @env36,@env22,@env26,@env0 ; 11 : shift string
	.word @env13,@env22,@env24,@env0 ; 12 : DMC: drums + bass
	.word @env17,@env6,@env24,@env0 ; 13 : rel hats
...
@song0ref71:
	...
	.byte $41, $10
	.word @song0ref54
	.byte $49, .lobyte(@env27), .hibyte(@env27), $22, $45, $92, $25, $81, $45, $81, $20, $45, $22, $81, $45, $81, $50, $e9, $2e
	.byte $3a, $81, $49, .lobyte(@env0), .hibyte(@env0), $4a, $00, $81
@song0ref153:
	.byte $49, .lobyte(@env39), .hibyte(@env39), $1d, $81, $92, $29, $81, $00, $81, $22, $81, $22, $81, $25, $81, $29, $81, $00
	.byte $81, $20
	.byte $41, $0f
	.word @song0ref36
	.byte $41, $10
	...
	.byte $41, $10
	.word @song0ref71
	.byte $9e, $22, $00, $29, $81, $00, $81, $25, $00, $22, $00, $25, $00, $29, $81, $00, $81, $92, $20
	.byte $41, $0f
	.word @song0ref36
	.byte $41, $10
	.word @song0ref54
...
@song2ref111:
	...
	.byte $41, $1e
	.word @song2ref109
	.byte $7f, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $90
	.byte $41, $0c
	.word @song2ref111
...
@song3ref141:
	...
	.byte .hibyte(@env5), $4f, $02, $90, $0f, $99, $45, $81, $42
	.word @song3ch0loop
@song3ch1:
@song3ch1loop:
...
@song3ref251:
	...
	.byte .lobyte(@env14), .hibyte(@env14), $4f, $03, $90, $0f, $99, $45, $81, $42
	.word @song3ch1loop
@song3ch2:
@song3ch2loop:
	.byte $9c
...
@song4ch4:
@song4ch4loop:
	.byte $14, $11, $10, $0b, $0a, $02, $01, $15, $12, $16, $13, $00, $42
	.word @song4ch4loop
