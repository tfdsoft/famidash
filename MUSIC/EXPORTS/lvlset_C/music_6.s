...
@instruments:
	...
	.word @env15,@env26,@env5,@env0 ; 05 : endgame lead
	...
	.word @env44,@env26,@env32,@env0 ; 09 : Instrument 4
	.word @env16,@env26,@env30,@env1 ; 0a : Extreme pitch down
	.word @env27,@env26,@env30,@env0 ; 0b : infernoplex_piano
	.word @env33,@env45,@env30,@env0 ; 0c : octave arp [ no duty ]
	.word @env24,@env26,@env30,@env0 ; 0d : loud blank string
	.word @env2,@env26,@env30,@env0 ; 0e : echo
	.word @env49,@env26,@env32,@env0 ; 0f : death moon lead
	.word @env4,@env26,@env30,@env19 ; 10 : triangle drums
	.word @env7,@env6,@env34,@env0 ; 11 : hat
...
@song0ref101:
	...
	.byte $8e, $36, $78, $81, $76, $81, $74, $81, $7a, $4d, $36, $78, $81, $76, $81, $74, $81, $7a, $4b, .lobyte(@env40), .hibyte(@env40)
...
@song0ch1:
@song0ch1loop:
	.byte $4c, $76, $4f, $03, $87, $4b, .lobyte(@env9), .hibyte(@env9), $9a
@song0ref404:
...
@song2ch1:
	...
	.byte $2c, $81, $2a, $49, .lobyte(@env13), .hibyte(@env13), $9d, $45, $8d, $00, $8d, $97, $8a
@song2ref409:
...
@song2ref967:
	...
	.byte $b5, $44, $00
@song3ch0:
	.byte $ff, $cb, $92, $25, $9d, $24, $9d, $20, $9d, $1d, $9d, $25, $9d, $24, $9d, $20, $9d, $1d, $9d, $8a, $50, $fe, $34, $35
...
@song4ch1:
	.byte $ff, $ff, $bf, $4b, .lobyte(@env11), .hibyte(@env11), $96, $1c, $83, $00, $83, $4d, $1c, $83, $00, $8b, $4b, .lobyte(@env47)
...
@song4ref586:
	...
	.byte $41, $0c
	.word @song4ref586
	.byte $86, $1e, $9b, $00, $20, $9b, $00, $9f, $a2, $16, $00, $16, $16, $16, $00, $16, $00, $86, $1d, $8d, $45, $81, $00, $f9
	.byte $44, $00
@song4ch4:
	.byte $ff
@song4ref696:
