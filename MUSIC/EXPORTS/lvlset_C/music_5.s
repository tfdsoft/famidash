...
@instruments:
	...
	.word @env38,@env6,@env3,@env0 ; 02 : cymbal
	.word @env4,@env27,@env32,@env0 ; 03 : sample
	.word @env8,@env36,@env31,@env0 ; 04 : kick
	.word @env26,@env27,@env31,@env0 ; 05 : blank string
	.word @env28,@env27,@env31,@env0 ; 06 : infernoplex_piano
	.word @env48,@env27,@env31,@env0 ; 07 : blank instant decay
	.word @env21,@env27,@env31,@env0 ; 08 : blank
	.word @env16,@env27,@env5,@env0 ; 09 : endgame lead
	.word @env17,@env27,@env31,@env14 ; 0a : I don't know what to name this
	.word @env45,@env27,@env33,@env0 ; 0b : Instrument 4
	.word @env2,@env27,@env31,@env0 ; 0c : echo
	.word @env17,@env27,@env31,@env1 ; 0d : Extreme pitch down
	.word @env52,@env27,@env33,@env0 ; 0e : death moon lead
	.word @env46,@env27,@env31,@env0 ; 0f : menu acc
	.word @env34,@env47,@env31,@env0 ; 10 : octave arp [ no duty ]
	.word @env49,@env27,@env31,@env0 ; 11 : blank slower string
	.word @env25,@env27,@env31,@env0 ; 12 : loud blank string
	.word @env4,@env27,@env31,@env20 ; 13 : triangle drums
	.word @env7,@env6,@env35,@env0 ; 14 : hat
...
@song0ref101:
	...
	.byte $86, $36, $78, $81, $76, $81, $74, $81, $7a, $4d, $36, $78, $81, $76, $81, $74, $81, $7a, $4b, .lobyte(@env41), .hibyte(@env41)
	.byte $36, $78, $81, $76, $81, $74, $81, $7a, $4b, .lobyte(@env44), .hibyte(@env44), $36, $78, $81, $76, $81, $74, $81, $72
	.byte $81, $71, $85, $7f, $4b, .lobyte(@env27), .hibyte(@env27), $4c, $8a
	.byte $41, $0c
	.word @song0ref101
@song0ref173:
...
@song0ref236:
	...
	.word @song0ref99
@song0ref289:
	.byte $7a, $4b, .lobyte(@env44), .hibyte(@env44), $4f, $01, $86, $1e, $78, $81, $76, $81, $74, $81, $7a, $4d, $1e, $78, $81
	.byte $76, $81, $74, $81, $7a, $4b, .lobyte(@env41), .hibyte(@env41), $1e, $78, $81, $76, $81, $74, $81, $7a, $4b, .lobyte(@env44)
	.byte .hibyte(@env44), $1e, $78, $81, $76, $81, $74, $81, $72, $81, $71, $85, $7f, $4b, .lobyte(@env27), .hibyte(@env27)
	.byte $4c, $4f, $02, $8a
	.byte $41, $0c
	.word @song0ref101
	.byte $41, $0a
...
@song0ref500:
	...
	.word @song0ref500
@song0ref533:
	.byte $4d, $12, $45, $83, $4d, $12, $45, $83, $4b, .lobyte(@env22), .hibyte(@env22), $12, $45, $8b, $4b, .lobyte(@env39)
...
@song0ref592:
	...
	.byte .hibyte(@env29), $0b, $45, $83, $4b, .lobyte(@env43), .hibyte(@env43), $0c, $45, $83, $4b, .lobyte(@env29), .hibyte(@env29)
...
@song2ref84:
	...
	.byte $41, $20
	.word @song2ref84
	.byte $8a, $22, $85, $7a, $94, $50, $0b, $29, $23, $85, $7f, $8c, $0f, $81, $03, $81, $0f, $81, $8a, $20, $81, $20, $81, $22
	.byte $81, $8e
@song2ref154:
	.byte $1b, $81, $1b, $81, $1b, $81, $1b, $81, $1b, $81, $1b, $81, $8a, $22, $85, $00, $90, $40, $0a, $01, $03, $00, $06, $08
	.byte $0a, $06, $03, $8a, $20, $81, $20, $81, $22, $81, $8c, $1b, $19, $14, $20, $81, $22, $25, $27, $21, $20, $1e, $20, $83
	...
	.byte $08, $83, $0a, $83, $0e, $83, $11, $81, $8e, $27, $27, $27, $90, $27, $81, $1b, $81, $0f, $92, $50, $b3, $16, $5b, $85
	.byte $8a, $22, $85, $7a, $94, $50, $0b, $29, $23, $85, $7f, $8c, $0b, $81, $40, $0b, $81, $0b, $81, $8a, $20, $81, $20, $81
	.byte $22, $81, $8e
@song2ref301:
...
@song2ch1:
	...
	.byte $85, $7f, $8c, $0f, $81, $03, $81, $0f, $81, $00, $81, $87, $9e
	.byte $41, $0c
	.word @song2ref154
	.byte $00, $99, $90, $01, $81, $00, $9d, $9b, $8c, $1d, $81, $83, $1e, $81, $7a, $94, $50, $1d, $2d, $1e, $85, $50, $d1, $1a
	.byte $33, $85, $50, $1d, $2d, $1e, $85, $7f, $98, $0a, $83, $0e, $83, $11, $83, $14, $83, $16, $83, $1a, $83, $1d, $81, $27
	.byte $27, $27, $8c, $27, $81, $1b, $81, $0f, $92, $50, $b3, $16, $5b, $85, $00, $85, $7a, $94, $50, $0b, $29, $23, $85, $7f
	.byte $8c, $17, $81, $0b, $81, $17, $81, $00, $81, $87, $9e
	.byte $41, $0c
	.word @song2ref301
	.byte $98
	.byte $41, $10
...
@song3ch1:
	...
	.byte $2c, $81, $2a, $49, .lobyte(@env13), .hibyte(@env13), $9d, $45, $8d, $00, $8d, $97, $92
@song3ref409:
...
@song5ch1:
	.byte $ff, $ff, $bf, $4b, .lobyte(@env11), .hibyte(@env11), $8c, $1c, $83, $00, $83, $4d, $1c, $83, $00, $8b, $4b, .lobyte(@env50)
...
@song5ref229:
	...
	.byte $19, $83, $00, $4b, .lobyte(@env53), .hibyte(@env53), $19, $81, $4b, .lobyte(@env40), .hibyte(@env40)
	.byte $41, $10
	.word @song5ref225
	.byte $41, $14
	.word @song5ref219
	.byte $4b, .lobyte(@env40), .hibyte(@env40), $19, $83, $00, $8b, $e7, $4b, .lobyte(@env40), .hibyte(@env40), $1b, $85, $4b
	.byte .lobyte(@env37), .hibyte(@env37), $1b, $81, $4b, .lobyte(@env40), .hibyte(@env40), $1b, $85, $00, $81, $df, $4b, .lobyte(@env19)
...
@song5ref586:
	...
	.byte $41, $0c
	.word @song5ref586
	.byte $84, $1e, $9b, $00, $20, $9b, $00, $9f, $a8, $16, $00, $16, $16, $16, $00, $16, $00, $84, $1d, $8d, $45, $81, $00, $f9
	.byte $44, $00
@song5ch4:
	.byte $ff
@song5ref696:
