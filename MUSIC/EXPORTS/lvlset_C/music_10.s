...
@instruments:
	...
	.word @env9,@env17,@env2,@env0 ; 02 : snare 2
	.word @env10,@env25,@env21,@env0 ; 03 : kick
	.word @env14,@env18,@env21,@env0 ; 04 : blank
	.word @env8,@env6,@env24,@env0 ; 05 : hat
	.word @env22,@env16,@env21,@env0 ; 06 : (G2) aggressive noise kick
	.word @env31,@env18,@env21,@env0 ; 07 : blank instant decay
	.word @env14,@env18,@env3,@env0 ; 08 : electroman lead
	.word @env20,@env18,@env21,@env0 ; 09 : infernoplex_piano
	.word @env5,@env29,@env21,@env0 ; 0a : (G2) aggressive noise snare
	.word @env26,@env30,@env21,@env0 ; 0b : (G2) aggressive noise kick + crash
	.word @env20,@env18,@env4,@env0 ; 0c : infernogame_lead_piano
	.word @env12,@env18,@env21,@env0 ; 0d : blank instant more decay
	.word @env28,@env18,@env21,@env0 ; 0e : blank slower string loud
	.word @env19,@env6,@env2,@env0 ; 0f : crash mini
	.word @env1,@env18,@env21,@env0 ; 10 : echo
...
@song0ch0:
	.byte $46, $06, $4e, $fe, $4f, $01, $af, $7b, $92, $38, $85, $3a, $85, $75, $4e, $00, $4f, $02, $88
@song0ref20:
...
@song0ref47:
	...
	.byte $44, $00
@song0ch1:
	.byte $bf, $7d, $49, .lobyte(@env11), .hibyte(@env11), $4f, $01, $9c
@song0ref80:
...
@song0ref139:
	...
	.byte $ad, $98, $12, $85, $13, $85, $15, $8d, $13, $85, $13, $81, $12, $81, $12, $9d, $00, $85, $13, $85, $12, $85, $12, $85
...
@song0ref577:
	...
	.byte $41, $0c
	.word @song0ref577
	.byte $7f, $9e, $21, $8d, $84, $23, $85, $77, $80, $22, $81, $47, $01, $7c, $82, $1e, $81
	.byte $41, $0c
	.word @song0ref531
	.byte $41, $0c
	.word @song0ref531
...
@song1ch0:
	.byte $46, $03, $bf, $bf, $bf, $b5, $4b, .lobyte(@env23), .hibyte(@env23), $90, $18, $81, $47, $01, $4d, $18, $83, $75, $4d
	.byte $88, $50, $f7, $0c, $0d, $8d, $4d, $50, $a6, $0d, $60, $95, $4d, $50, $ff, $1f, $22, $95, $bf, $51, $ff, $00, $af, $7f
	.byte $00, $8d, $bf, $8f, $73, $4e, $fe, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $9a
@song1ref56:
...
@song1ch1:
	...
	.byte $41, $40
	.word @song1ref56
	.byte $4b, .lobyte(@env23), .hibyte(@env23), $90, $0c, $81, $47, $01, $4d, $0c, $83, $00, $8d, $4b, .lobyte(@env18), .hibyte(@env18)
	.byte $4c, $8e
	.byte $41, $3c
	.word @song1ref56
	.byte $99, $00, $8d
...
@song1ref319:
	...
	.byte $00, $95, $44, $00
@song1ch3:
	.byte $80, $19, $8d, $00, $ad, $bf, $bf, $af, $94, $14, $8d, $00, $bd, $bf, $72, $51, $02, $f0, $88, $20, $bd, $9f, $94, $14
	.byte $81, $47, $01, $14, $83, $47, $01, $14, $83, $14, $81, $47, $01, $14, $83, $47, $01, $14, $83, $96, $14, $8d, $8c
@song1ref440:
	...
	.byte $7d, $81, $7e, $81, $96, $14, $8d, $45, $85, $44, $00
@song1ch4:
@song1ref551:
