...
@instruments:
	...
	.word @env26,@env36,@env24,@env0 ; 12 : octave arp [ no duty ]
	.word @env14,@env19,@env3,@env0 ; 13 : electroman lead
	.word @env12,@env19,@env15,@env0 ; 14 : hex guitar 2
...
@samples:
	...
	.byte $7e+.lobyte(FAMISTUDIO_DPCM_PTR),$78,$0f,$40,$02 ; 1c hi (Pitch:15)
...
@song1ref1251:
	...
	.byte $41, $18
	.word @song1ref988
	.byte $76, $4e, $01, $4b, .lobyte(@env19), .hibyte(@env19), $4c, $a8
@song1ref1382:
