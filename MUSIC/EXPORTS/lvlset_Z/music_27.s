...
@instruments:
	...
	.word @env56,@env30,@env34,@env0 ; 02 : blank instant decay
	.word @env12,@env46,@env34,@env0 ; 03 : kick
	...
	.word @env40,@env55,@env36,@env0 ; 11 : octave arp
	.word @env18,@env30,@env7,@env0 ; 12 : hex guitar 1
	.word @env18,@env30,@env24,@env0 ; 13 : hex guitar 2
	.word @env17,@env30,@env5,@env0 ; 14 : endgame lead
	.word @env23,@env30,@env33,@env19 ; 15 : Kap lead
	.word @env54,@env30,@env34,@env0 ; 16 : menu acc
	.word @env22,@env30,@env4,@env0 ; 17 : electroman lead
	.word @env57,@env30,@env34,@env0 ; 18 : blank slower string
	.word @env27,@env30,@env34,@env0 ; 19 : triangle pluck 3
...
@song2ref270:
	...
	.byte $81, $9c, $38, $85, $36, $85, $33, $85, $9e, $2a, $81, $31, $81, $33, $81, $34, $85, $33, $85, $76, $4f, $02, $aa, $25
	.byte $89, $7a
@song2ref416:
...
@song2ref872:
	...
	.byte $00
@song2ch2:
	.byte $bf, $bf, $a2, $0d, $9d, $12, $9d, $11, $9d, $09, $9d, $00, $b5, $90, $20, $25, $27, $2a
@song2ref938:
...
@song4ch0:
	.byte $46, $06
@song4ch0loop:
	.byte $49, .lobyte(@env6), .hibyte(@env6), $4f, $02, $9e, $0f, $9d, $72, $49, .lobyte(@env0), .hibyte(@env0), $4a, $00, $ac
...
@song4ch1:
@song4ch1loop:
	.byte $49, .lobyte(@env20), .hibyte(@env20), $4f, $03, $9e, $0f, $9d, $49, .lobyte(@env10), .hibyte(@env10), $4f, $01, $9a
	.byte $10, $97, $45, $83, $49, .lobyte(@env10), .hibyte(@env10), $14, $97, $45, $83, $49, .lobyte(@env10), .hibyte(@env10)
	.byte $0d, $97, $45, $83, $7a
@song4ref158:
	.byte $49, .lobyte(@env10), .hibyte(@env10), $4f, $01, $0f, $8b, $45, $9a, $10, $8b, $45, $49, .lobyte(@env10), .hibyte(@env10)
