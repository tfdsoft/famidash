...
@instruments:
	...
	.word @env20,@env28,@env7,@env0 ; 0e : hex guitar 1
	...
	.word @env23,@env28,@env34,@env0 ; 13 : blank
	.word @env49,@env28,@env34,@env0 ; 14 : blank slower string
	.word @env20,@env28,@env34,@env0 ; 15 : Duty 0
	.word @env27,@env28,@env34,@env0 ; 16 : blank string
	.word @env24,@env28,@env34,@env0 ; 17 : Instrument 2
	.word @env39,@env28,@env34,@env0 ; 18 : quiet bass
...
@song1ref394:
	...
	.byte $78
@song1ref421:
	.byte $49, .lobyte(@env17), .hibyte(@env17), $83, $a6, $50, $f2, $2a, $2c, $81, $20, $00, $8f, $50, $f2, $2a, $2c, $81, $20
...
@song1ch2:
	.byte $aa, $50, $fb, $11, $2e, $dd, $df, $df, $df, $9e, $50, $01, $2e, $2c, $dd, $df, $df, $00, $dd
@song1ref817:
	.byte $00, $89
@song1ref819:
	.byte $94
