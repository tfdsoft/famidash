...
@instruments:
	.word @env7,@env33,@env25,@env0 ; 00 : kick
	.word @env19,@env5,@env25,@env0 ; 01 : rel hats
	.word @env35,@env5,@env2,@env0 ; 02 : cymbal
	...
	.word @env40,@env21,@env25,@env0 ; 0a : blank instant decay
	.word @env3,@env21,@env25,@env17 ; 0b : triangle drums
	.word @env22,@env21,@env25,@env0 ; 0c : infernoplex_piano
	.word @env13,@env21,@env25,@env15 ; 0d : tom
	.word @env13,@env21,@env25,@env0 ; 0e : DMC: drums + bass
	.word @env43,@env21,@env29,@env0 ; 0f : death moon lead
	.word @env38,@env21,@env28,@env0 ; 10 : shift string
	.word @env30,@env21,@env25,@env0 ; 11 : triangle pluck 4
...
@song1ref951:
	...
	.byte $41, $10
	.word @song1ref951
	.byte $00, $9d, $4b, .lobyte(@env39), .hibyte(@env39), $a0, $15, $bd, $4b, .lobyte(@env37), .hibyte(@env37), $43, $15, $bd
...
@song3ch1:
	.byte $ff, $ff, $bf, $4b, .lobyte(@env9), .hibyte(@env9), $98, $1c, $83, $00, $83, $4d, $1c, $83, $00, $8b, $4b, .lobyte(@env41)
...
@song3ref225:
	.byte $19, $83, $00, $8b
@song3ref229:
	.byte $bf, $4b, .lobyte(@env9), .hibyte(@env9), $1c, $83, $00, $83, $4d, $1c, $83, $00, $8b, $4b, .lobyte(@env41), .hibyte(@env41)
	...
	.byte .lobyte(@env34), .hibyte(@env34), $1b, $81, $4b, .lobyte(@env36), .hibyte(@env36), $1b, $85, $00, $81, $df, $4b, .lobyte(@env16)
	.byte .hibyte(@env16), $19, $85, $4d, $19, $85, $4b, .lobyte(@env14), .hibyte(@env14), $19, $85, $00, $85
	.byte $41, $0c
	.word @song3ref229
	.byte $41, $14
	.word @song3ref219
	.byte $4b, .lobyte(@env36), .hibyte(@env36), $19, $83, $00, $8b, $ef, $4b, .lobyte(@env14), .hibyte(@env14), $20, $83, $45
...
@song3ref586:
	...
	.byte $41, $0c
	.word @song3ref586
	.byte $84, $1e, $9b, $00, $20, $9b, $00, $9f, $8e, $16, $00, $16, $16, $16, $00, $16, $00, $84, $1d, $8d, $45, $81, $00, $f9
	.byte $44, $00
@song3ch4:
	.byte $ff
@song3ref696:
