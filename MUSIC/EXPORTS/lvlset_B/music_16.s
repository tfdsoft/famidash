...
@instruments:
	...
	.word @env45,@env22,@env25,@env0 ; 02 : blank instant decay
	.word @env1,@env22,@env25,@env0 ; 03 : echo
	.word @env11,@env35,@env25,@env0 ; 04 : kick
	.word @env16,@env22,@env25,@env0 ; 05 : blank
	.word @env18,@env7,@env25,@env0 ; 06 : rel hats
	.word @env23,@env22,@env25,@env0 ; 07 : infernoplex_piano
	.word @env23,@env46,@env25,@env0 ; 08 : pluck1
	.word @env42,@env22,@env31,@env0 ; 09 : Instrument 4
	.word @env47,@env22,@env25,@env0 ; 0a : triangle pluck 2
	.word @env18,@env22,@env25,@env0 ; 0b : Instrument 2
	.word @env36,@env7,@env2,@env0 ; 0c : cymbal
	.word @env3,@env22,@env26,@env0 ; 0d : sample
	.word @env16,@env22,@env4,@env0 ; 0e : electroman lead
	.word @env10,@env22,@env25,@env0 ; 0f : clutterfunk sax
	...
	.word @env32,@env44,@env26,@env0 ; 14 : octave arp
	.word @env20,@env22,@env25,@env0 ; 15 : loud blank string
	.word @env13,@env22,@env25,@env0 ; 16 : 02 but tri
	.word @env40,@env22,@env27,@env0 ; 17 : shift string
	.word @env32,@env22,@env25,@env0 ; 18 : quiet bass
...
@song0ref71:
	...
	.byte $41, $10
	.word @song0ref54
	.byte $49, .lobyte(@env30), .hibyte(@env30), $22, $45, $9e, $25, $81, $45, $81, $20, $45, $22, $81, $45, $81, $50, $e9, $2e
...
@song0ref153:
	...
	.byte $41, $10
	.word @song0ref71
	.byte $a6, $22, $00, $29, $81, $00, $81, $25, $00, $22, $00, $25, $00, $29, $81, $00, $81, $9e, $20
	.byte $41, $0f
	.word @song0ref36
	.byte $41, $10
	.word @song0ref54
...
@song3ref111:
	...
	.byte $81, $71, $85, $7f, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $a2
	.byte $41, $0c
	.word @song3ref111
...
; The DPCM aligner used to be here
@song5ch0:
	.byte $46, $06, $74, $4b, .lobyte(@env28), .hibyte(@env28), $8a, $20, $9d, $4b, .lobyte(@env6), .hibyte(@env6), $24, $9d
...
@song5ch1:
@song5ref174:
	.byte $4b, .lobyte(@env33), .hibyte(@env33), $84, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $86, $20, $00
	.byte $7f, $4b, .lobyte(@env33), .hibyte(@env33), $84, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $86, $20
	.byte $00, $7f, $4b, .lobyte(@env33), .hibyte(@env33), $84, $25, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $86
	.byte $25, $00, $7f, $4b, .lobyte(@env33), .hibyte(@env33), $84, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c
	.byte $86, $24, $00, $7f, $4b, .lobyte(@env33), .hibyte(@env33), $84, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $86, $20, $00, $7f, $4b, .lobyte(@env33), .hibyte(@env33), $84, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $86, $20, $00, $7f, $4b, .lobyte(@env33), .hibyte(@env33), $84, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $86, $24, $00, $7f, $4b, .lobyte(@env33), .hibyte(@env33), $84, $21, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $86, $21, $00, $7f
	.byte $41, $10
	.word @song5ref174
@song5ref297:
	.byte $7f, $4b, .lobyte(@env33), .hibyte(@env33), $84, $27, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $86, $27
	.byte $00, $7f, $4b, .lobyte(@env33), .hibyte(@env33), $84, $25, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $86
	.byte $25, $00, $7f, $4b, .lobyte(@env33), .hibyte(@env33), $84, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c
	.byte $86, $24, $00, $7f, $4b, .lobyte(@env33), .hibyte(@env33), $84, $21, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $86, $21, $00, $7f
	.byte $41, $20
	.word @song5ref174
	.byte $7f
