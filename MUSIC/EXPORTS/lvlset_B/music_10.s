...
@instruments:
	...
	.word @env12,@env36,@env25,@env0 ; 01 : kick
	.word @env41,@env22,@env25,@env0 ; 02 : blank instant decay
	.word @env2,@env22,@env25,@env0 ; 03 : echo
	.word @env19,@env24,@env3,@env0 ; 04 : snare
	.word @env11,@env8,@env35,@env0 ; 05 : hat
	.word @env23,@env22,@env25,@env0 ; 06 : clap no app
	.word @env17,@env22,@env25,@env0 ; 07 : blank
	.word @env23,@env26,@env25,@env0 ; 08 : clap
	.word @env37,@env8,@env3,@env0 ; 09 : cymbal
	.word @env33,@env22,@env25,@env0 ; 0a : triangle pluck 4
	.word @env17,@env22,@env4,@env0 ; 0b : electroman lead
	.word @env39,@env22,@env25,@env0 ; 0c : menu acc
	.word @env31,@env22,@env25,@env32 ; 0d : jaezu lead
	.word @env14,@env22,@env5,@env0 ; 0e : endgame lead
	.word @env15,@env22,@env25,@env1 ; 0f : Extreme pitch down
	.word @env21,@env22,@env25,@env0 ; 10 : blank string
	.word @env30,@env40,@env25,@env0 ; 11 : octave arp [ no duty ]
	.word @env30,@env40,@env27,@env0 ; 12 : octave arp
	.word @env42,@env22,@env25,@env0 ; 13 : blank slower string
	.word @env38,@env22,@env28,@env0 ; 14 : shift string
	.word @env20,@env22,@env25,@env0 ; 15 : triangle pluck 3
	.word @env15,@env22,@env25,@env0 ; 16 : DMC: drums + bass
...
@song0ch0:
	.byte $46, $03, $9a, $2b, $85, $2c, $85, $2e, $85, $45, $85, $27, $85, $45, $85, $2c, $85, $45, $85, $00, $ed, $86
@song0ref23:
...
@song0ref236:
	...
	.byte $44, $00
@song0ch1:
	.byte $79, $9a, $1d, $85, $45, $85, $1b, $8d, $45, $8d, $20, $8d, $45, $8d, $00, $dd, $86
@song0ref318:
...
@song0ref501:
	.byte $0d, $85, $00, $81, $0d, $85, $00, $81, $0f, $85, $00, $81, $0f, $85, $00, $81, $8c, $0f, $85, $0f, $85, $8e, $14, $85
...
@song2ch1:
@song2ref174:
	.byte $4b, .lobyte(@env34), .hibyte(@env34), $84, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $86, $20, $00
	.byte $7f, $4b, .lobyte(@env34), .hibyte(@env34), $84, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $86, $20
	.byte $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $84, $25, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $86
	.byte $25, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $84, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c
	.byte $86, $24, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $84, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $86, $20, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $84, $20, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $86, $20, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $84, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $86, $24, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $84, $21, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $86, $21, $00, $7f
	.byte $41, $10
	.word @song2ref174
@song2ref297:
	.byte $7f, $4b, .lobyte(@env34), .hibyte(@env34), $84, $27, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $86, $27
	.byte $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $84, $25, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c, $86
	.byte $25, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $84, $24, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22), $4c
	.byte $86, $24, $00, $7f, $4b, .lobyte(@env34), .hibyte(@env34), $84, $21, $81, $7c, $4b, .lobyte(@env22), .hibyte(@env22)
	.byte $4c, $86, $21, $00, $7f
	.byte $41, $20
	.word @song2ref174
	.byte $7f
...
@song2ref840:
	.byte $1d, $81, $8a, $22, $22, $88, $21, $00, $8a, $22, $22, $82, $19, $00, $8a, $22, $22, $88, $21, $8a, $22, $22, $22, $82
	.byte $19, $00, $8a, $22, $22, $88, $21, $00, $8a, $22, $22, $82, $19, $00, $8a, $22, $22, $88, $21, $8a, $22, $92, $1f, $81
	.byte $41, $20
	.word @song2ref840
	.byte $41, $20
	.word @song2ref840
...
@song2ref968:
	.byte $12, $81, $06, $81, $13, $81, $06, $81, $12, $81, $06, $81, $13, $81, $06, $81, $12, $81, $05, $81, $13, $81, $05, $81
	.byte $12, $81, $05, $81, $13, $81, $05, $81
	.byte $41, $20
	.word @song2ref968
	.byte $41, $20
	.word @song2ref968
	...
	.word @song2ref968
@song2ref1021:
	.byte $06, $85, $08, $00, $83, $0c, $85, $01, $00, $83, $05, $85, $07, $00, $83, $10, $85, $11, $00, $83
	.byte $41, $14
	.word @song2ref1021
	.byte $41, $14
	.word @song2ref1021
	.byte $06, $8d, $0c, $8d, $05, $8d, $10, $8d, $00, $85, $44, $00
@song3ch0:
	.byte $46, $06
@song3ref3:
	.byte $a2
...
@song3ref627:
	...
	.byte $41, $14
	.word @song3ref625
	.byte $7f, $92, $22, $85, $77, $88, $22, $81, $23, $81, $22, $81, $23, $81, $22, $81, $79
	.byte $41, $12
	.word @song3ref627
	.byte $7c
	.byte $41, $11
...
@song3ch4:
	...
	.byte $41, $13
	.word @song3ref533
	.byte $06, $81, $00, $81, $06, $81, $00, $81, $0e, $81, $00, $81, $0e
	.byte $41, $13
	.word @song3ref533
	.byte $06, $81, $00, $81, $06, $81, $00, $81, $0e, $81, $00, $81, $0e
	.byte $41, $13
	.word @song3ref533
	.byte $06, $81, $00, $81, $06, $81, $00, $81, $0e, $81, $00, $81, $0e, $81, $00, $81, $0e, $81, $00, $81, $0e, $81, $00, $81
@song3ref961:
	.byte $0d, $81, $00, $85, $06, $81, $00, $85, $0b, $81, $00, $81, $04, $81, $00, $85, $0a, $81, $00, $81, $04, $81, $00, $85
	.byte $41, $13
	.word @song3ref961
@song3ref988:
	.byte $85, $04, $81, $00, $81, $0e, $81, $00, $85, $0d, $81, $00, $85, $06, $81, $00, $81, $04, $81, $00, $85, $0a, $81, $00
	.byte $81, $04, $81, $00, $85
	.byte $41, $13
	.word @song3ref961
	.byte $41, $1d
	...
	.byte $41, $17
	.word @song3ref961
	.byte $81, $12, $81, $00, $13, $81, $00, $12, $81, $00, $13, $81, $00, $12, $81, $12, $81, $13, $85, $00, $b5, $44, $00
@song4ch0:
...
@song5ch0:
	.byte $46, $06
@song5ch0loop:
	.byte $79, $49, .lobyte(@env0), .hibyte(@env0), $4a, $4f, $02, $98
@song5ref12:
...
@song5ref145:
	...
	.byte .lobyte(@env16), .hibyte(@env16), $4f, $03, $a0, $09, $8b, $43, $0b, $8b, $45, $81, $42
	.word @song5ch1loop
@song5ch2:
@song5ch2loop:
	.byte $aa
...
@song6ref578:
	.byte $94, $0d, $0d, $19, $00, $0d, $00, $19, $00, $84, $3d, $94, $0d, $19, $00, $84, $3d, $00, $3b, $00, $94, $10, $10, $1c
	.byte $00, $10, $00, $1c, $00, $84, $3b, $94, $10, $1c, $00, $84, $3b, $00, $38, $00, $94, $09, $09, $15, $00, $09, $00, $15
	.byte $00, $84, $3d, $94, $09, $15, $00, $84, $3d, $00, $3b, $00, $94, $0b, $0b, $17, $00, $0b, $00, $17, $00, $84, $3b, $94
	.byte $0b, $17, $00, $84, $3b, $00, $3d, $00
	.byte $41, $40
	.word @song6ref578
	.byte $41, $40
	.word @song6ref578
...
@song6ref765:
	.byte $92, $21, $7d, $81, $7b, $81, $79, $81, $7a
@song6ref774:
...
@song6ref814:
	...
	.byte $41, $0c
	.word @song6ref774
	.byte $7f, $92, $21, $7d, $81, $7b, $81, $79, $81, $77, $81, $75, $81, $73, $81, $71, $81, $44, $00
@song6ch4:
	.byte $41, $0a
	.word @song6ref568
	.byte $83, $03
...
@song6ref993:
	.byte $03, $00, $83, $0a, $00, $83, $0a, $00, $83, $0a, $00, $83, $0a, $00, $85, $00, $85, $00, $85, $00, $85, $00, $83, $09
