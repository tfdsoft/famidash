...
@instruments:
	...
	.word @env27,@env28,@env35,@env0 ; 09 : blank string
	.word @env41,@env8,@env35,@env0 ; 0a : tight triangle snare
	.word @env3,@env28,@env37,@env0 ; 0b : sample
	.word @env26,@env28,@env35,@env0 ; 0c : loud blank string
	.word @env18,@env28,@env35,@env0 ; 0d : DMC: drums + bass
	.word @env18,@env28,@env35,@env21 ; 0e : tom
	.word @env29,@env28,@env35,@env0 ; 0f : infernoplex_piano
	.word @env39,@env28,@env35,@env40 ; 10 : jaezu lead
	.word @env17,@env28,@env5,@env0 ; 11 : endgame lead
	.word @env24,@env28,@env35,@env0 ; 12 : Instrument 2
	.word @env41,@env28,@env35,@env0 ; 13 : triangle pluck 4
...
@song2ref101:
	...
	.byte $81, $71, $85, $7f, $4b, .lobyte(@env28), .hibyte(@env28), $4c, $92
	.byte $41, $0c
	.word @song2ref101
@song2ref173:
...
@song2ch1:
@song2ch1loop:
	.byte $4c, $76, $4f, $03, $87, $4b, .lobyte(@env13), .hibyte(@env13), $98
@song2ref404:
...
@song4ref7:
	...
	.byte $41, $14
	.word @song4ref7
	.byte $4f, $03, $85, $4b, .lobyte(@env42), .hibyte(@env42), $9e
@song4ref46:
...
@song4ref122:
	.byte $23, $85, $49, .lobyte(@env32), .hibyte(@env32), $9f, $49, .lobyte(@env0), .hibyte(@env0), $4a, $98, $26, $81, $28
	.byte $81, $2a, $85, $21, $85, $23, $85, $49, .lobyte(@env32), .hibyte(@env32), $9f, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $98, $26, $81, $28, $81, $2a, $85, $21, $85
	.byte $41, $0d
	.word @song4ref122
	.byte $49, .lobyte(@env32), .hibyte(@env32), $97, $49, .lobyte(@env0), .hibyte(@env0), $4a, $4f, $02, $a0, $09, $85, $49
	.byte .lobyte(@env10), .hibyte(@env10), $87, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a0, $06, $85, $49, .lobyte(@env10)
	.byte .hibyte(@env10), $87, $4f, $03, $98
@song4ref194:
	.byte $17, $85, $49, .lobyte(@env32), .hibyte(@env32), $9f, $49, .lobyte(@env0), .hibyte(@env0), $4a, $98, $1a, $81, $1c
	.byte $81, $1e, $85, $15, $85, $17, $85, $49, .lobyte(@env32), .hibyte(@env32), $9f, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $98, $1a, $81, $1c, $81, $1e, $85, $15, $85
	.byte $41, $0d
	.word @song4ref194
	.byte $49, .lobyte(@env32), .hibyte(@env32), $97, $49, .lobyte(@env0), .hibyte(@env0), $4a, $4f, $02, $a0, $15, $85, $49
	.byte .lobyte(@env10), .hibyte(@env10), $87, $49, .lobyte(@env0), .hibyte(@env0), $4a, $a0, $12, $85, $49, .lobyte(@env10)
	.byte .hibyte(@env10), $87, $44, $00
@song4ch1:
	.byte $7a, $4b, .lobyte(@env14), .hibyte(@env14), $a2
@song4ref271:
...
@song4ref984:
	.byte $8e, $12, $81, $00, $81, $82, $40, $4e, $81, $40, $4c, $81, $3e, $85, $3b, $85, $8e, $12, $81, $00, $89, $94, $06, $81
	.byte $00, $89
	.byte $41, $14
	.word @song4ref984
	.byte $41, $14
