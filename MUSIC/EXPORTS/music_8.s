...
@instruments:
	...
	.word @env31,@env20,@env26,@env32 ; 0f : jaezu lead
	...
	.word @env30,@env40,@env26,@env0 ; 14 : octave arp [ no duty ]
	.word @env15,@env20,@env4,@env0 ; 15 : electroman lead
	.word @env12,@env20,@env16,@env0 ; 16 : hex guitar 2
	.word @env41,@env20,@env26,@env0 ; 17 : blank instant decay
	.word @env42,@env20,@env29,@env0 ; 18 : death moon lead
	.word @env22,@env20,@env26,@env0 ; 19 : infernoplex_piano
...
@song1ref1251:
	...
	.byte $41, $18
	.word @song1ref988
	.byte $76, $4e, $01, $4b, .lobyte(@env20), .hibyte(@env20), $4c, $ac
@song1ref1382:
...
@song2ref1117:
	...
	.word @song2ref1117
@song2ref1146:
	.byte $1e, $85, $13, $85, $1e, $85, $13, $85, $1e, $85, $15, $85, $1e, $85, $15, $85, $1e, $85, $0f, $85, $1e, $85, $0f, $85
...
@song2ref1226:
	...
	.byte $00, $bd
@song2ref1269:
	.byte $1e, $85, $13, $85, $23, $85, $13, $85, $1e, $85, $0f, $85, $23, $85, $0f, $85, $1e, $85, $17, $85, $23, $85, $17, $85
