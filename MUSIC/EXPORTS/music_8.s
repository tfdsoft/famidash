...
@instruments:
	...
	.word @env42,@env25,@env30,@env0 ; 0d : menu acc
	.word @env3,@env25,@env30,@env20 ; 0e : triangle drums
	.word @env28,@env31,@env30,@env0 ; 0f : clap
	.word @env9,@env12,@env6,@env0 ; 10 : Instrument 3
	.word @env41,@env25,@env33,@env0 ; 11 : shift string
	.word @env16,@env25,@env30,@env19 ; 12 : tom
	.word @env44,@env25,@env30,@env0 ; 13 : blank slower string
	.word @env26,@env25,@env30,@env0 ; 14 : infernoplex_piano
	.word @env22,@env5,@env30,@env0 ; 15 : rel hats
	.word @env3,@env25,@env32,@env0 ; 16 : sample
...
@song0ref5:
	...
	.byte $1a, $1e, $1a, $1e, $21, $26, $17, $1c, $20, $23, $1c, $20, $23, $28, $70, $51, $01, $40, $a0
@song0ref459:
	.byte $06, $06, $12, $10
@song0ref463:
...
@song0ref543:
	...
	.byte $41, $0b
	.word @song0ref543
	.byte $91, $4f, $01, $a4, $21, $00, $1e, $1c, $00, $27, $4f, $00, $00, $87
@song0ref625:
...
@song0ref1353:
	...
	.byte $8d, $00, $95, $9c, $31, $2f, $2d, $2c, $aa, $34, $00, $34, $00, $34, $00, $34, $36, $00, $8d, $9f, $93, $39, $36, $34
...
@song3ref283:
	...
	.byte $28, $9d, $44, $00
@song3ch1:
	.byte $9f, $9f, $9f, $9f, $9f, $9f, $9f, $9f, $76, $a8
@song3ref357:
	.byte $1c
@song3ref358:
