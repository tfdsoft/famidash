...
@instruments:
	...
	.word @env16,@env6,@env21,@env0 ; 02 : rel hats
	...
	.word @env34,@env18,@env24,@env0 ; 0c : shift string
	.word @env29,@env5,@env21,@env0 ; 0d : tight triangle kick
	.word @env29,@env7,@env21,@env0 ; 0e : tight triangle snare
	.word @env13,@env18,@env21,@env0 ; 0f : 02 but tri
	.word @env14,@env18,@env21,@env0 ; 10 : DMC: drums + bass
	.word @env16,@env18,@env21,@env0 ; 11 : Instrument 2
	.word @env37,@env18,@env21,@env0 ; 12 : blank instant decay
	.word @env11,@env18,@env12,@env0 ; 13 : shift string lite
	.word @env38,@env18,@env26,@env0 ; 14 : death moon lead
	.word @env4,@env18,@env28,@env0 ; 15 : xstep wub
...
@song0ch1:
	...
	.byte $1e, $72, $88, $25, $76, $8a, $25, $72, $88, $1e, $7a, $4b, .lobyte(@env10), .hibyte(@env10), $98, $19, $9d, $4d, $14
	...
	.byte $9d, $7c, $4b, .lobyte(@env18), .hibyte(@env18), $4c, $4f, $03, $a4
@song0ref717:
...
@song0ref963:
	...
	.byte $87, $44, $00
@song0ch3:
	.byte $ff, $ef, $71, $88, $1f, $72, $81, $73, $81, $74, $81, $75, $81, $76, $81, $77, $81, $78, $81, $79, $94, $1f, $81, $a4
	.byte $21, $81, $7f
@song0ref1070:
...
@song1ref9:
	...
	.byte $41, $1e
	.word @song1ref9
	.byte $34, $36, $81, $37, $36, $81, $32, $34, $81, $32, $34, $81, $36, $74, $88, $32, $81, $45, $7f, $92
@song1ref77:
...
@song3ref58:
	...
	.byte $41, $14
	.word @song3ref58
	.byte $70, $87, $7f, $8a, $26, $2d, $85, $0e, $1a, $26, $1a, $2d, $32, $9e, $2d, $81, $29, $4e, $fe, $90, $26, $81, $4f, $00
	.byte $81, $4e, $00, $8a
@song3ref148:
...
@song3ref428:
	...
	.word @song3ref421
@song3ref484:
	.byte $7f, $4f, $02, $8a, $26, $32, $81, $32, $39, $85, $1a, $26, $32, $26, $39, $3e, $9e, $2d, $81, $29, $90, $26, $83
	.byte $41, $17
	.word @song3ref421
	.byte $41, $11
	.word @song3ref484
