...
def generate_space_defines(filteredOfficialMetadata, filteredCommunityMetadata, include_path):
...
def main():
	...
	print_around_function("\t- Level defines... ", "Done\n", generate_space_defines, (filteredOfficialMetadata, filteredCommunityMetadata, include_path))
