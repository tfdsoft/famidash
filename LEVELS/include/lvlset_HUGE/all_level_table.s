...
_level_chunk_list_lo:
	...
	.byte .lobyte(level_data_somewhereinaforest_1)
...
_level_chunk_list_hi:
	...
	.byte .hibyte(level_data_somewhereinaforest_1)
	.byte .hibyte(level_data_ajollyretrochristmas_2)
	.byte .hibyte(level_data_cryogenic_3)
	.byte .hibyte(level_data_thesteamworks_4)
	.byte .hibyte(level_data_astronomicalexpedition_5)
	.byte .hibyte(level_data_astronomicalexpedition_6)
	.byte .hibyte(level_data_astronomicalexpedition_7)
	.byte .hibyte(level_data_carefreevictory_8)
	.byte .hibyte(level_data_rainbowtylenol_9)
	.byte .hibyte(level_data_subtleoddities_10)
	.byte .hibyte(level_data_newdashcity_11)
	.byte .hibyte(level_data_birdbrain_12)
	.byte .hibyte(level_data_tetrix_13)
	.byte .hibyte(level_data_highlife_14)
	.byte .hibyte(level_data_extraordinaryexcitement_15)
	.byte .hibyte(level_data_deathmoon_16)
	.byte .hibyte(level_data_motion_17)
	.byte .hibyte(level_data_respitev2_18)
	.byte .hibyte(level_data_skeletalshenanigans_19)
	.byte .hibyte(level_data_trythisgd_20)
	.byte .hibyte(level_data_demonpyrophoric_21)
	.byte .hibyte(level_data_demoncryogenic_22)
	.byte .hibyte(level_data_futurefunkfix_23)
	.byte .hibyte(level_data_futurefunkfix_24)
	.byte .hibyte(level_data_eon_25)
	.byte .hibyte(level_data_windylandscape_26)
	.byte .hibyte(level_data_sonicwave_27)
	.byte .hibyte(level_data_aftercatabath_28)
	.byte .hibyte(level_data_aftercatabath_29)
	.byte .hibyte(level_data_everyend_30)
	.byte .hibyte(level_data_everyend_31)
	.byte .hibyte(level_data_heliopolis_32)

_level_chunk_list_bank:
	.byte .lobyte(.bank(level_data_dash_0))
	.byte .lobyte(.bank(level_data_somewhereinaforest_1))
	...
	.byte .lobyte(.bank(level_data_astronomicalexpedition_5))
	.byte .lobyte(.bank(level_data_astronomicalexpedition_6))
	.byte .lobyte(.bank(level_data_astronomicalexpedition_7))
	.byte .lobyte(.bank(level_data_carefreevictory_8))
	.byte .lobyte(.bank(level_data_rainbowtylenol_9))
	.byte .lobyte(.bank(level_data_subtleoddities_10))
	.byte .lobyte(.bank(level_data_newdashcity_11))
	.byte .lobyte(.bank(level_data_birdbrain_12))
	.byte .lobyte(.bank(level_data_tetrix_13))
	.byte .lobyte(.bank(level_data_highlife_14))
	.byte .lobyte(.bank(level_data_extraordinaryexcitement_15))
	.byte .lobyte(.bank(level_data_deathmoon_16))
	.byte .lobyte(.bank(level_data_motion_17))
	.byte .lobyte(.bank(level_data_respitev2_18))
	.byte .lobyte(.bank(level_data_skeletalshenanigans_19))
	.byte .lobyte(.bank(level_data_trythisgd_20))
	.byte .lobyte(.bank(level_data_demonpyrophoric_21))
	.byte .lobyte(.bank(level_data_demoncryogenic_22))
	.byte .lobyte(.bank(level_data_futurefunkfix_23))
	.byte .lobyte(.bank(level_data_futurefunkfix_24))
	.byte .lobyte(.bank(level_data_eon_25))
	.byte .lobyte(.bank(level_data_windylandscape_26))
	.byte .lobyte(.bank(level_data_sonicwave_27))
	.byte .lobyte(.bank(level_data_aftercatabath_28))
	.byte .lobyte(.bank(level_data_aftercatabath_29))
	.byte .lobyte(.bank(level_data_everyend_30))
	.byte .lobyte(.bank(level_data_everyend_31))
	.byte .lobyte(.bank(level_data_heliopolis_32))
