...
.repeat 12, I
	.out .sprintf(".segment MUS_BANK_%02X", I)
	.segment .sprintf("MUS_BANK_%02X", I)
		.out .sprintf(".include MUSIC/EXPORTS/music_%d.s", I+1)
        .include .sprintf("MUSIC/EXPORTS/music_%d.s", I+1)
.endrepeat
