...
extern const unsigned char metatiles2_top1[];
extern const unsigned char metatiles2_top2[];
extern const unsigned char metatiles2_bot1[];
extern const unsigned char metatiles2_bot2[];
extern const unsigned char metatiles2_attr[];
//yextern const unsigned char is_solid[];
