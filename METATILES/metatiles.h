#define COL_BOTTOM_SPIKES 0x2e
#define COL_BOTTOM_RIGHT_SPIKE 0x2d
#define COL_BOTTOM_LEFT_SPIKE 0x2c
#define COL_RIGHT_SPIKE_BLOCK 0x2b
#define COL_LEFT_SPIKE_BLOCK 0x2a
