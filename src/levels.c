...
banked(level_data_bank_0) const u8 lvl_electrodynamix_tiles[] = {
    #embed "./levels/electrodynamix.lvl"
};
banked(level_data_bank_0) const u8 lvl_test_sprites[] = {
    0,
};

banked(level_header_bank) const struct Level lvl_electrodynamix_header = {
    ...
    .tile_data = (u8*)lvl_electrodynamix_tiles,
