...
$(TMPDIR)/crt0.o: LIB/crt0.s GRAPHICS/*.chr LIB/*.s LEVELS/*.s METATILES/*.s METATILES/*.inc MUSIC/EXPORTS/*.s MUSIC/EXPORTS/music.dmc
	$(CA65) LIB/crt0.s --cpu 6502X -g $(call ca65IncDir,.) $(call ca65IncDir,MUSIC/EXPORTS) -o $(TMPDIR)/crt0.o
