...
$(TMPDIR)/BUILD_FLAGS.s: BUILD_FLAGS.h defines_to_asm.py SAUCE/defines/space_defines.h SAUCE/defines/physics_defines.h
	$(PYTHON) defines_to_asm.py $(TMPDIR)/BUILD_FLAGS.s BUILD_FLAGS.h SAUCE/defines/space_defines.h SAUCE/defines/physics_defines.h
